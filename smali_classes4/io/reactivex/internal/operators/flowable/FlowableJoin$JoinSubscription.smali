...
.method public constructor <init>(Lbp/c;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Lbp/c;
...
.method public drain()V
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Lbp/c;
    ...
    invoke-virtual {v1, v3}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lbp/c;)V
    ...
    invoke-interface {v3}, Lbp/c;->onComplete()V
    ...
    invoke-interface {v7, v8}, Lbp/b;->subscribe(Lbp/c;)V
    ...
    invoke-interface {v3, v0}, Lbp/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->fail(Ljava/lang/Throwable;Lbp/c;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    ...
    invoke-interface {v3, v8}, Lbp/c;->onNext(Ljava/lang/Object;)V
...
.method public errorAll(Lbp/c;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public fail(Ljava/lang/Throwable;Lbp/c;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lbp/c;)V
