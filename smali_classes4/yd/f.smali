...
# direct methods
.method public varargs constructor <init>(Ljava/lang/String;Lyd/a;Lyd/g;Z[Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-boolean p4, p0, Lyd/f;->g:Z

    iput-object p5, p0, Lyd/f;->f:[Ljava/lang/String;

    new-instance p1, Lxd/l;

    invoke-direct {p1, p3}, Lxd/l;-><init>(Lyd/g;)V

    iput-object p1, p0, Lyd/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
...
.method public c()Lyd/b;
    ...
    invoke-virtual {v0, v1}, Lxd/a$c;->b(Ljava/lang/String;)Lxd/a$b;

    move-result-object v0

    iget-object v1, v0, Lxd/a$b;->e:Lcom/android/camera2/a;
    ...
    iget-object v1, v0, Lxd/a$b;->d:Lcom/android/camera2/f;

    invoke-static {v1}, Lcom/android/camera2/g;->K7(Lcom/android/camera2/f;)Z
    ...
    iget-boolean v3, p0, Lyd/f;->g:Z

    invoke-virtual {v1, v3}, Lcom/android/camera2/a;->d(Z)V

    :cond_0
    iget-object p0, p0, Lyd/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    iget-boolean v5, v1, Lxd/a$b;->a:Z
    ...
    iget-object v1, v1, Lxd/a$b;->g:Ljava/lang/String;
    ...
    iget-object v0, p0, Lyd/f;->f:[Ljava/lang/String;

    invoke-static {v0}, Lxd/e;->e([Ljava/lang/String;)V

    invoke-static {p0}, Lxd/e;->c(Lyd/d;)V
    ...
    :cond_4
    iget-boolean v5, v1, Lxd/a$b;->b:Z
    ...
    iget-object v5, p0, Lyd/d;->c:Ljava/lang/String;
    ...
    iget-object v1, v1, Lxd/a$c;->a:Landroid/hardware/camera2/CameraManager;

    invoke-static {}, Lxd/e;->i()Landroid/os/Handler;

    move-result-object v5

    iget-object v6, p0, Lyd/d;->a:Ljava/lang/String;
    ...
    iget-object v8, p0, Lyd/d;->c:Ljava/lang/String;
    ...
    iget-object v7, p0, Lyd/f;->e:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    invoke-virtual {v1, v5}, Lxd/a$c;->b(Ljava/lang/String;)Lxd/a$b;
    ...
    invoke-direct {v1, v2}, Lyd/b;-><init>(Ljava/lang/Exception;)V
    :try_end_0
    ...
    iget-object v5, p0, Lyd/d;->a:Ljava/lang/String;
    ...
    iget-object v7, p0, Lyd/d;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lyd/b;-><init>(Ljava/lang/Exception;)V
