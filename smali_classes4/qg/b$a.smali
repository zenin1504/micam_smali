...
.field public final synthetic m:Lqg/b;


# direct methods
.method public constructor <init>(Lqg/b;Landroid/content/Context;Landroid/view/View$OnClickListener;Landroid/widget/RelativeLayout;)V
    .locals 5

    iput-object p1, p0, Lqg/b$a;->m:Lqg/b;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/16 p1, 0x68

    iput p1, p0, Lqg/b$a;->a:I

    const/4 p1, 0x3

    new-array v0, p1, [I

    iput-object v0, p0, Lqg/b$a;->b:[I

    const/4 v0, 0x0

    iput-boolean v0, p0, Lqg/b$a;->l:Z

    iput-object p2, p0, Lqg/b$a;->k:Landroid/content/Context;

    iput-object p4, p0, Lqg/b$a;->d:Landroid/widget/RelativeLayout;

    new-instance p2, Landroid/widget/ImageView;

    iget-object p4, p0, Lqg/b$a;->k:Landroid/content/Context;

    invoke-direct {p2, p4}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lqg/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Lqg/b$a;->h:Landroid/widget/ImageView;

    invoke-static {}, Lp0/e;->d()Lp0/e;

    move-result-object v1

    invoke-virtual {v1, p4}, Lp0/e;->b(I)I
    ...
    iget-object v2, p0, Lqg/b$a;->k:Landroid/content/Context;
    ...
    iput-object p2, p0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Lqg/b$a;->i:Landroid/widget/ImageView;

    invoke-static {}, Lp0/e;->d()Lp0/e;

    move-result-object v2

    invoke-virtual {v2, p4}, Lp0/e;->b(I)I
    ...
    iput-object p2, p0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object p2, p0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object p4, p0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object p1, p0, Lqg/b$a;->k:Landroid/content/Context;
    ...
    iget-object p3, p0, Lqg/b$a;->k:Landroid/content/Context;
    ...
    iput-object p3, p0, Lqg/b$a;->e:Landroid/view/ViewGroup$MarginLayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lqg/b$a;->f:Landroid/view/ViewGroup$MarginLayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lqg/b$a;->g:Landroid/view/ViewGroup$MarginLayoutParams;

    return-void
.end method

.method public static synthetic a(Lqg/b$a;)Landroid/view/ViewGroup$MarginLayoutParams;
    .locals 0

    iget-object p0, p0, Lqg/b$a;->e:Landroid/view/ViewGroup$MarginLayoutParams;

    return-object p0
.end method

.method public static synthetic b(Lqg/b$a;)Landroid/view/ViewGroup$MarginLayoutParams;
    .locals 0

    iget-object p0, p0, Lqg/b$a;->f:Landroid/view/ViewGroup$MarginLayoutParams;

    return-object p0
.end method

.method public static synthetic c(Lqg/b$a;)Landroid/view/ViewGroup$MarginLayoutParams;
    .locals 0

    iget-object p0, p0, Lqg/b$a;->g:Landroid/view/ViewGroup$MarginLayoutParams;
...
.method public e()V
    ...
    iget-object v1, v0, Lqg/b$a;->h:Landroid/widget/ImageView;

    if-eqz v1, :cond_3

    iget-object v1, v0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v2, v0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v4, v0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v5, v0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v9, v0, Lqg/b$a;->m:Lqg/b;

    invoke-static {v9}, Lqg/b;->h(Lqg/b;)Z
    ...
    invoke-static {v9}, Lqg/b;->j(Lqg/b;)D
    ...
    invoke-static {v9}, Lqg/b;->i(Lqg/b;)D
    ...
    iget-object v6, v0, Lqg/b$a;->i:Landroid/widget/ImageView;

    new-array v11, v3, [F

    aput v8, v11, v7

    iget-object v12, v0, Lqg/b$a;->m:Lqg/b;

    invoke-static {v12}, Lqg/b;->f(Lqg/b;)I
    ...
    new-instance v6, Lqg/b$a$d;

    invoke-direct {v6, v0}, Lqg/b$a$d;-><init>(Lqg/b$a;)V
    ...
    iget-object v14, v0, Lqg/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object v5, v0, Lqg/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object v1, v0, Lqg/b$a;->m:Lqg/b;

    invoke-static {v1}, Lqg/b;->h(Lqg/b;)Z
    ...
    invoke-static {v1}, Lqg/b;->i(Lqg/b;)D
    ...
    invoke-static {v1}, Lqg/b;->j(Lqg/b;)D
    ...
    iget-object v7, v0, Lqg/b$a;->h:Landroid/widget/ImageView;
    ...
    invoke-static {v9}, Lqg/b;->f(Lqg/b;)I
    ...
    new-instance v1, Lqg/b$a$e;

    invoke-direct {v1, v0}, Lqg/b$a$e;-><init>(Lqg/b$a;)V
    ...
    iget-object v2, v0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object v4, v0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object v5, v0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object v7, v0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    new-instance v2, Lqg/b$a$f;

    invoke-direct {v2, v0}, Lqg/b$a$f;-><init>(Lqg/b$a;)V
...
.method public f(III)V
    ...
    iput p3, p0, Lqg/b$a;->c:I

    iget-boolean p3, p0, Lqg/b$a;->l:Z

    if-nez p3, :cond_0

    iget-object p3, p0, Lqg/b$a;->d:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lqg/b$a;->i:Landroid/widget/ImageView;

    invoke-virtual {p3, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object p3, p0, Lqg/b$a;->d:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lqg/b$a;->h:Landroid/widget/ImageView;

    invoke-virtual {p3, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object p3, p0, Lqg/b$a;->d:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lqg/b$a;->j:Landroid/widget/ImageView;

    invoke-virtual {p3, v0}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    const/4 p3, 0x1

    iput-boolean p3, p0, Lqg/b$a;->l:Z

    :cond_0
    iget-object p3, p0, Lqg/b$a;->m:Lqg/b;

    invoke-static {p3}, Lqg/b;->a(Lqg/b;)Z
    ...
    invoke-static {p3}, Lqg/b;->c(Lqg/b;)Z
    ...
    invoke-virtual {p3, v0}, Lqg/b;->n(I)V

    invoke-virtual {p0, p1, p2}, Lqg/b$a;->h(II)V
...
.method public h(II)V
    ...
    iget-object v2, v0, Lqg/b$a;->m:Lqg/b;

    invoke-static {v2}, Lqg/b;->g(Lqg/b;)I

    move-result v2

    sub-int v2, v2, p1

    iget-object v3, v0, Lqg/b$a;->k:Landroid/content/Context;
    ...
    iget-object v3, v0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v7, v0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v9, v0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v10, v0, Lqg/b$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v13, v0, Lqg/b$a;->m:Lqg/b;

    invoke-static {v13}, Lqg/b;->h(Lqg/b;)Z
    ...
    invoke-static {v13}, Lqg/b;->i(Lqg/b;)D
    ...
    invoke-static {v13}, Lqg/b;->j(Lqg/b;)D
    ...
    iget-object v11, v0, Lqg/b$a;->i:Landroid/widget/ImageView;

    new-array v14, v8, [F

    aput v12, v14, v4

    iget-object v15, v0, Lqg/b$a;->m:Lqg/b;

    invoke-static {v15}, Lqg/b;->k(Lqg/b;)I
    ...
    new-instance v5, Lqg/b$a$a;

    invoke-direct {v5, v0, v1, v2}, Lqg/b$a$a;-><init>(Lqg/b$a;II)V
    ...
    iget-object v9, v0, Lqg/b$a;->h:Landroid/widget/ImageView;
    ...
    iget-object v10, v0, Lqg/b$a;->h:Landroid/widget/ImageView;
    ...
    invoke-static {v12}, Lqg/b;->h(Lqg/b;)Z
    ...
    invoke-static {v12}, Lqg/b;->j(Lqg/b;)D
    ...
    iget-object v4, v0, Lqg/b$a;->m:Lqg/b;

    invoke-static {v4}, Lqg/b;->i(Lqg/b;)D
    ...
    iget-object v11, v0, Lqg/b$a;->m:Lqg/b;

    invoke-static {v11}, Lqg/b;->k(Lqg/b;)I
    ...
    new-instance v4, Lqg/b$a$b;

    invoke-direct {v4, v0, v1, v2}, Lqg/b$a$b;-><init>(Lqg/b$a;II)V
    ...
    iget-object v9, v0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    iget-object v10, v0, Lqg/b$a;->j:Landroid/widget/ImageView;
    ...
    invoke-static {v12}, Lqg/b;->k(Lqg/b;)I
    ...
    new-instance v5, Lqg/b$a$c;

    invoke-direct {v5, v0, v1, v2}, Lqg/b$a$c;-><init>(Lqg/b$a;II)V
