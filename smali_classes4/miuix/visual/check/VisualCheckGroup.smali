...
.field public g:Lmiuix/visual/check/VisualCheckBox$b;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field public h:Lmiuix/visual/check/VisualCheckGroup$d;

.field public i:Lmiuix/visual/check/VisualCheckGroup$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Llo/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Lmiuix/visual/check/VisualCheckGroup;->h:Lmiuix/visual/check/VisualCheckGroup$d;
    ...
    iput-object v1, p0, Lmiuix/visual/check/VisualCheckGroup;->g:Lmiuix/visual/check/VisualCheckBox$b;

    sget-object v1, Lmo/c;->VisualCheckGroup:[I

    invoke-virtual {p1, p2, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lmo/c;->VisualCheckGroup_checkedButton:I
...
.method public static synthetic d(Lmiuix/visual/check/VisualCheckGroup;)Lmiuix/visual/check/VisualCheckBox$b;
    ...
    iget-object p0, p0, Lmiuix/visual/check/VisualCheckGroup;->g:Lmiuix/visual/check/VisualCheckBox$b;
...
.method public static synthetic e(Lmiuix/visual/check/VisualCheckGroup;)Z
    ...
    iget-boolean p0, p0, Lmiuix/visual/check/VisualCheckGroup;->f:Z
...
.method public static synthetic f(Lmiuix/visual/check/VisualCheckGroup;Z)Z
    ...
    iput-boolean p1, p0, Lmiuix/visual/check/VisualCheckGroup;->f:Z
...
.method public static synthetic g(Lmiuix/visual/check/VisualCheckGroup;)I
    ...
    iget p0, p0, Lmiuix/visual/check/VisualCheckGroup;->e:I
...
.method private setCheckedId(I)V
    ...
    iget-object v0, p0, Lmiuix/visual/check/VisualCheckGroup;->i:Lmiuix/visual/check/VisualCheckGroup$c;
...
.method public setOnCheckedChangeListener(Lmiuix/visual/check/VisualCheckGroup$c;)V
    ...
    iput-object p1, p0, Lmiuix/visual/check/VisualCheckGroup;->i:Lmiuix/visual/check/VisualCheckGroup$c;
