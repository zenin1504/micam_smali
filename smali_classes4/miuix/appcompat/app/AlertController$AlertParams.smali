...
.method public apply(Lmiuix/appcompat/app/AlertController;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->e1(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->r1(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->i1(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->h1(I)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->s1(Z)V
    ...
    invoke-virtual {p1, v0, v1}, Lmiuix/appcompat/app/AlertController;->j1(II)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->l1(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->d1(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v2, v0, v3, v1}, Lmiuix/appcompat/app/AlertController;->Y0(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->u1(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->t1(I)V
    ...
    invoke-virtual {p1, v2, v0}, Lmiuix/appcompat/app/AlertController;->c1(ZLjava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->g1(Z)V

    iget v0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mNonImmersiveDialogHeight:I

    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->m1(I)V

    iget v0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mLiteVersion:I

    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->k1(I)V

    iget-boolean v0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mPreferLandscape:Z

    invoke-virtual {p1, v0}, Lmiuix/appcompat/app/AlertController;->p1(Z)V
    ...
    invoke-virtual {p1, v1}, Lmiuix/appcompat/app/AlertController;->n1(Lmiuix/appcompat/app/AlertDialog$d;)V

    iget-boolean p0, p0, Lmiuix/appcompat/app/AlertController$AlertParams;->mEnableEnterAnim:Z

    invoke-virtual {p1, p0}, Lmiuix/appcompat/app/AlertController;->f1(Z)V
