...
.method private synthetic f(Landroid/view/View;Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-static {p1, v1}, Lll/d;->d(Landroid/view/View;Lmiuix/animation/base/AnimConfig;)V
...
.method public final d(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-static {p1}, Lll/c;->h(Lmiuix/appcompat/app/AppCompatActivity;)I
...
.method public final e(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-virtual {v0}, Lll/b;->p()Landroid/view/View;
    ...
    invoke-direct {v1, p0, v0, p1}, Lll/j;-><init>(Lmiuix/appcompat/app/floatingactivity/SingleAppFloatingLifecycleObserver;Landroid/view/View;Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final g(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-virtual {v0, v1}, Lll/b;->n(I)Ljava/util/ArrayList;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {v0, p1}, Lll/b;->m(Lmiuix/appcompat/app/AppCompatActivity;)I
...
.method public onCreate()V
    ...
    invoke-virtual {v0, v1, v2}, Lll/b;->l(Ljava/lang/String;I)Lmiuix/appcompat/app/AppCompatActivity;

    move-result-object v1

    if-eqz v1, :cond_2

    invoke-virtual {v0, v1}, Lll/b;->r(Lmiuix/appcompat/app/AppCompatActivity;)Lmiuix/appcompat/app/AppCompatActivity;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-virtual {v1}, Lmiuix/appcompat/app/AppCompatActivity;->j4()Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-virtual {v0, v1}, Lll/b;->y(Lmiuix/appcompat/app/AppCompatActivity;)Z

    move-result p0

    if-nez p0, :cond_2

    invoke-virtual {v0, v1}, Lll/b;->A(Lmiuix/appcompat/app/AppCompatActivity;)V

    invoke-static {v1}, Lll/c;->j(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-static {v1, p0}, Lll/c;->i(Lmiuix/appcompat/app/AppCompatActivity;Z)V
...
.method public onDestroy()V
    ...
    invoke-virtual {v0, v1, p0}, Lll/b;->D(Ljava/lang/String;I)V
