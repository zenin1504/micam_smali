...
.field public f:Led/a$e;

.field public final synthetic g:Led/a;


# direct methods
.method public constructor <init>(Led/a;Led/a$e;)V
    .locals 0

    iput-object p1, p0, Led/a$d;->g:Led/a;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/4 p1, 0x1

    iput-boolean p1, p0, Led/a$d;->c:Z

    const/4 p1, 0x0

    iput-boolean p1, p0, Led/a$d;->d:Z

    iput-boolean p1, p0, Led/a$d;->e:Z

    iput-object p2, p0, Led/a$d;->f:Led/a$e;
    ...
    iput-object p1, p0, Led/a$d;->a:Ljava/io/PipedInputStream;

    :try_start_0
    new-instance p1, Ljava/io/PipedOutputStream;

    iget-object p2, p0, Led/a$d;->a:Ljava/io/PipedInputStream;

    invoke-direct {p1, p2}, Ljava/io/PipedOutputStream;-><init>(Ljava/io/PipedInputStream;)V

    iput-object p1, p0, Led/a$d;->b:Ljava/io/PipedOutputStream;
    :try_end_0
...
.method public final a([BII)I
    ...
    :goto_0
    iget-boolean v2, p0, Led/a$d;->c:Z
    ...
    :try_start_0
    iget-object v2, p0, Led/a$d;->a:Ljava/io/PipedInputStream;
    ...
    iget-boolean v3, p0, Led/a$d;->c:Z
    ...
    iget-boolean p0, p0, Led/a$d;->c:Z
...
.method public b([BZ)I
    ...
    :try_start_0
    iget-object v0, p0, Led/a$d;->b:Ljava/io/PipedOutputStream;
    :try_end_0
    ...
    iput-object p2, p0, Led/a$d;->b:Ljava/io/PipedOutputStream;
    :try_end_1
    ...
    invoke-static {p2, p1}, Lod/a;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public c()V
    ...
    iput-boolean v0, p0, Led/a$d;->c:Z

    const/4 v0, 0x0

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, Led/a$d;->b([BZ)I
...
.method public final d()V
    ...
    iget-object v1, p0, Led/a$d;->g:Led/a;

    invoke-static {v1}, Led/a;->k(Led/a;)Landroid/media/MediaCodec;
    ...
    iget-object v2, p0, Led/a$d;->g:Led/a;

    invoke-static {v2}, Led/a;->k(Led/a;)Landroid/media/MediaCodec;
    ...
    invoke-static {v3, p0}, Lod/a;->k(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Led/a$d;->f:Led/a$e;

    invoke-virtual {v4, v6}, Led/a$e;->a([B)I
    ...
    invoke-static {v3, v4}, Lod/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Led/a$d;->f:Led/a$e;

    new-array v1, v5, [B

    invoke-virtual {v0, v1}, Led/a$e;->a([B)I

    iput-boolean v5, p0, Led/a$d;->c:Z

    const-string p0, "pullDecodedData: BUFFER_FLAG_END_OF_STREAM"

    invoke-static {v3, p0}, Lod/a;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final e([BZ)V
    ...
    :goto_1
    iget-boolean v0, p0, Led/a$d;->c:Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Led/a$d;->g:Led/a;

    invoke-static {v0}, Led/a;->k(Led/a;)Landroid/media/MediaCodec;
    ...
    :goto_2
    iget-object p0, p0, Led/a$d;->g:Led/a;

    invoke-static {p0}, Led/a;->k(Led/a;)Landroid/media/MediaCodec;
...
.method public run()V
    ...
    :goto_0
    iget-boolean v5, p0, Led/a$d;->c:Z

    if-eqz v5, :cond_5

    iget-boolean v5, p0, Led/a$d;->e:Z

    const/4 v6, 0x1

    if-nez v5, :cond_3

    invoke-virtual {p0, v3, v1, v2}, Led/a$d;->a([BII)I
    ...
    :goto_1
    iput-boolean v6, p0, Led/a$d;->e:Z

    goto :goto_0

    :cond_0
    invoke-virtual {v4, v3}, Led/a$b;->d([B)Z
    ...
    invoke-static {v5, v7}, Lod/a;->k(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    invoke-virtual {v4}, Led/a$b;->a()I
    ...
    invoke-virtual {p0, v7, v2, v5}, Led/a$d;->a([BII)I
    ...
    :cond_2
    invoke-virtual {p0, v7, v1}, Led/a$d;->e([BZ)V

    goto :goto_2

    :cond_3
    iget-boolean v5, p0, Led/a$d;->d:Z

    if-nez v5, :cond_4

    invoke-virtual {p0, v0, v6}, Led/a$d;->e([BZ)V

    const-string v5, "MediaPlayerImpl"

    const-string v7, "StreamDecodeTask: put end flag"

    invoke-static {v5, v7}, Lod/a;->e(Ljava/lang/String;Ljava/lang/String;)V

    iput-boolean v6, p0, Led/a$d;->d:Z

    :cond_4
    :goto_2
    invoke-virtual {p0}, Led/a$d;->d()V
    :try_end_0
    ...
    :cond_5
    :try_start_1
    iget-object v2, p0, Led/a$d;->b:Ljava/io/PipedOutputStream;
    ...
    iput-object v0, p0, Led/a$d;->b:Ljava/io/PipedOutputStream;
    ...
    iput-object v0, p0, Led/a$d;->a:Ljava/io/PipedInputStream;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-static {v0}, Led/a;->m(Led/a;)Ljava/lang/Object;
    ...
    invoke-static {v3, v0}, Lod/a;->k(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Led/a$d;->g:Led/a;

    invoke-static {p0, v1}, Led/a;->e(Led/a;Z)Z
    ...
    invoke-static {v3, v2}, Lod/a;->k(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
    ...
    invoke-static {v2, v1}, Led/a;->e(Led/a;Z)Z
    :try_end_8
    ...
    :goto_d
    :try_start_d
    iget-object v3, p0, Led/a$d;->b:Ljava/io/PipedOutputStream;
    ...
    :cond_f
    iget-object v3, p0, Led/a$d;->a:Ljava/io/PipedInputStream;
    ...
    :try_start_e
    iget-object v3, p0, Led/a$d;->g:Led/a;

    invoke-static {v3}, Led/a;->k(Led/a;)Landroid/media/MediaCodec;
    ...
    invoke-static {v4, v3}, Lod/a;->k(Ljava/lang/String;Ljava/lang/String;)V
