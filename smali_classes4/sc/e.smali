...
.method public constructor <init>(Ljava/nio/ByteBuffer;)V
    ...
    iput-object p1, p0, Lsc/e;->a:Ljava/nio/ByteBuffer;
...
.method public static A(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0}, Lsc/e;->C(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v1, v0}, Lsc/e;->h(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v2}, Lsc/e;->u(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v1, p0}, Lsc/d;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lsc/d;-><init>(Ljava/lang/String;)V
...
.method public static b(II)I
    ...
    invoke-static {p0}, Lsc/e;->r(I)I

    move-result p0

    invoke-static {p1}, Lsc/e;->r(I)I

    move-result p1

    invoke-static {p0, p1}, Lsc/e;->s(II)I
...
.method public static e(Ljava/nio/ByteBuffer;J)J
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lsc/d;
    ...
    invoke-static {p0}, Lsc/e;->j(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v0}, Lsc/e;->d(Ljava/nio/ByteBuffer;I)J
    ...
    invoke-static {p0, v2}, Lsc/e;->d(Ljava/nio/ByteBuffer;I)J
    ...
    invoke-direct {p0, p1}, Lsc/d;-><init>(Ljava/lang/String;)V
...
.method public static f(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    invoke-static {p1}, Lsc/e;->j(Ljava/nio/ByteBuffer;)V
...
.method public static g(Ljava/io/RandomAccessFile;J)Landroid/util/Pair;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static k(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v6}, Lsc/b;-><init>(Ljava/nio/channels/FileChannel;JJ)V
    ...
    invoke-direct/range {v9 .. v14}, Lsc/b;-><init>(Ljava/nio/channels/FileChannel;JJ)V
    ...
    invoke-static {v2}, Lsc/e;->j(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v3, v2}, Lsc/e;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v4, v5}, Lsc/e;->n([I[Lsc/a;)[[B
    ...
    invoke-static {v1}, Lsc/e;->x(I)Ljava/lang/String;
...
.method public static m(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lsc/e;->t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0}, Lsc/e;->y(Ljava/nio/ByteBuffer;)[B
    ...
    :try_start_0
    invoke-static {v1}, Lsc/e;->t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v10, v6}, Lsc/e;->b(II)I
    ...
    :cond_1
    invoke-static {v9}, Lsc/e;->y(Ljava/nio/ByteBuffer;)[B
    ...
    :cond_5
    invoke-static {v6}, Lsc/e;->B(I)Ljava/lang/String;

    move-result-object v1

    invoke-static {v6}, Lsc/e;->D(I)Landroid/util/Pair;
    ...
    invoke-static {v0}, Lsc/e;->t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v8}, Lsc/e;->y(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {p1}, Lsc/e;->y(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-direct {v5, v4, v2}, Lsc/f;-><init>(Ljava/security/cert/X509Certificate;[B)V
...
.method public static n([I[Lsc/a;)[[B
    .locals 25
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-interface {v9}, Lsc/a;->a()J

    move-result-wide v9

    invoke-static {v9, v10}, Lsc/e;->c(J)J
    ...
    invoke-static {v2, v8, v10}, Lsc/e;->i(I[BI)V
    ...
    invoke-static {v12}, Lsc/e;->x(I)Ljava/lang/String;
    ...
    invoke-static {v3, v2, v4}, Lsc/e;->i(I[BI)V
    ...
    :cond_3
    :try_start_1
    invoke-interface {v5, v8, v11, v12, v3}, Lsc/a;->a([Ljava/security/MessageDigest;JI)V
    :try_end_1
    ...
    invoke-static {v2}, Lsc/e;->x(I)Ljava/lang/String;
...
.method public static o(Ljava/io/RandomAccessFile;)[[Ljava/security/cert/X509Certificate;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-static {p0}, Lsc/e;->v(Ljava/io/RandomAccessFile;)Lsc/c;
    ...
    invoke-static {p0, v0}, Lsc/e;->q(Ljava/nio/channels/FileChannel;Lsc/c;)[[Ljava/security/cert/X509Certificate;
...
.method public static p(Ljava/lang/String;)[[Ljava/security/cert/X509Certificate;
    ...
    :try_start_0
    invoke-static {v0}, Lsc/e;->o(Ljava/io/RandomAccessFile;)[[Ljava/security/cert/X509Certificate;
...
.method public static q(Ljava/nio/channels/FileChannel;Lsc/c;)[[Ljava/security/cert/X509Certificate;
    .locals 10
    ...
    :try_start_1
    iget-object v2, p1, Lsc/c;->a:Ljava/nio/ByteBuffer;

    invoke-static {v2}, Lsc/e;->t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v4, v0, v1}, Lsc/e;->m(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    iget-wide v2, p1, Lsc/c;->b:J

    iget-wide v4, p1, Lsc/c;->c:J

    iget-wide v6, p1, Lsc/c;->d:J

    iget-object v8, p1, Lsc/c;->e:Ljava/nio/ByteBuffer;

    move-object v1, p0

    invoke-static/range {v0 .. v8}, Lsc/e;->k(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
...
.method public static t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v0}, Lsc/e;->u(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
...
.method public static u(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    .locals 3
...
.method public static v(Ljava/io/RandomAccessFile;)Lsc/c;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-static {p0}, Lsc/e;->w(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    ...
    invoke-static {v10, v8, v9}, Lsc/e;->e(Ljava/nio/ByteBuffer;J)J

    move-result-wide v6

    invoke-static {p0, v6, v7}, Lsc/e;->g(Ljava/io/RandomAccessFile;J)Landroid/util/Pair;
    ...
    invoke-static {v0}, Lsc/e;->A(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-direct/range {v2 .. v10}, Lsc/c;-><init>(Ljava/nio/ByteBuffer;JJJLjava/nio/ByteBuffer;)V
...
.method public static w(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, v0}, Lsc/e;->f(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
...
.method public a()J
    ...
    .line 1
    iget-object p0, p0, Lsc/e;->a:Ljava/nio/ByteBuffer;
...
.method public a([Ljava/security/MessageDigest;JI)V
    ...
    .line 2
    iget-object v0, p0, Lsc/e;->a:Ljava/nio/ByteBuffer;
    ...
    .line 4
    :try_start_0
    iget-object v1, p0, Lsc/e;->a:Ljava/nio/ByteBuffer;
    ...
    .line 5
    iget-object p3, p0, Lsc/e;->a:Ljava/nio/ByteBuffer;
