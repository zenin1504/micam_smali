...
.method public static j()I
    ...
    invoke-interface {v0, v2, v1}, Lz0/a$a;->putInt(Ljava/lang/String;I)Lz0/a$a;
    ...
    invoke-interface {v0, v2, v3}, Lz0/a$a;->putInt(Ljava/lang/String;I)Lz0/a$a;
...
.method public final d(Landroid/net/Uri;)I
    ...
    invoke-virtual {p0}, Lcom/xiaomi/camera/parallelservice/provider/ParallelProcessProvider;->g()Le1/c;
    ...
    invoke-virtual {v2, v3}, Le1/c;->r(Ljava/lang/Long;)Lc1/b;
    ...
    invoke-virtual {v0, v2}, Le1/b;->k(Ljava/lang/Object;)V

    invoke-virtual {p0}, Landroid/content/ContentProvider;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0, v2}, Lhe/a;->l(Landroid/content/Context;Lc1/b;)V
...
.method public final e(Ljava/io/File;Ljava/io/PrintWriter;)V
    ...
    invoke-static {}, Lcom/android/camera/r5;->t()Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lcom/android/camera/r5;->v(Landroid/content/Context;Landroid/content/ContentResolver;)Lcom/android/camera/r5;
    ...
    invoke-virtual {p0}, Lcom/android/camera/r5;->G()Landroid/net/Uri;
...
.method public final f(Ljava/io/File;Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v1}, Lc1/b;->q()Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v1}, Lcom/android/camera/j6;->U0(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Le6/ja;->e(Ljava/io/File;Ljava/io/File;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final declared-synchronized g()Le1/c;
    .locals 2
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/parallelservice/provider/ParallelProcessProvider;->c:Le1/c;
    ...
    iput-object v0, p0, Lcom/xiaomi/camera/parallelservice/provider/ParallelProcessProvider;->c:Le1/c;
...
.method public final n(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, v3}, Le1/c;->s(Ljava/lang/String;)Lc1/b;
    ...
    invoke-virtual {v1, v3}, Lc1/b;->K(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-virtual {v1, v6, v7}, Lc1/b;->H(J)V
    ...
    invoke-virtual {v1, v3}, Lc1/b;->C(Ljava/lang/String;)V
    ...
    :goto_2
    invoke-virtual {v1, v4, v5}, Lc1/b;->x(J)V
    ...
    :goto_3
    invoke-virtual {v1, v3}, Lc1/b;->L(I)V
    ...
    :goto_4
    invoke-virtual {v1, v2}, Lc1/b;->y(I)V
    ...
    invoke-virtual {v1, v2}, Lc1/b;->v(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2, v3}, Lc1/b;->w(J)V

    invoke-virtual {p0}, Lcom/xiaomi/camera/parallelservice/provider/ParallelProcessProvider;->g()Le1/c;

    move-result-object p2

    invoke-virtual {p2, v1}, Le1/b;->l(Ljava/lang/Object;)V
...
.method public final o(J)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual {v0, v1}, Le1/c;->r(Ljava/lang/Long;)Lc1/b;
    ...
    invoke-static {v1, v0}, Lr7/i;->c(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lr7/i;->c(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
...
.method public final q(Ljava/lang/Long;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual/range {v0 .. v7}, Le1/c;->v([Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public final s(JI)V
    ...
    invoke-virtual {v0, p1}, Le1/c;->r(Ljava/lang/Long;)Lc1/b;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1, p3}, Lc1/b;->F(I)V

    invoke-virtual {p0}, Lcom/xiaomi/camera/parallelservice/provider/ParallelProcessProvider;->g()Le1/c;

    move-result-object p0

    invoke-virtual {p0, p1}, Le1/b;->l(Ljava/lang/Object;)V
