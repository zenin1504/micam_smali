...
.method public submit(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lcom/xiaomi/camera/mivi/qcom/IReProcessor$Callback;)V
    ...
    invoke-static {v4}, Ltd/d;->e(Landroid/media/Image;)[B
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getParallelTaskData()Lwd/w;
    ...
    invoke-virtual/range {v16 .. v16}, Lwd/w;->q()Lwd/x;

    move-result-object v5

    invoke-virtual {v5}, Lwd/x;->i0()I
