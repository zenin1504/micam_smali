...
.method private doJpeg(Lwd/w;Landroid/media/Image;I)V
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Lwd/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;

    move-result-object p1

    const/4 p2, 0x0

    invoke-static {p3, p2}, Ltd/e;->d(II)V
...
.method private generateReprocessData(Lwd/w;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 16
    ...
    invoke-virtual/range {p1 .. p1}, Lwd/w;->m0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lwd/w;->n0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lwd/w;->Q()Landroid/media/Image;
    ...
    invoke-virtual/range {p1 .. p1}, Lwd/w;->L()I

    move-result v1

    invoke-virtual/range {p1 .. p1}, Lwd/w;->K()I
    ...
    invoke-virtual/range {p1 .. p1}, Lwd/w;->w()Ljava/lang/String;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, Lq6/n;->o(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lwd/w;
    ...
    :cond_1
    invoke-virtual {p2}, Lwd/w;->v()J

    move-result-wide v0

    invoke-virtual {p2}, Lwd/w;->w()Ljava/lang/String;
    ...
    invoke-static {v0}, Ltd/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v0, v1}, Lwd/w;->a([BI)V
    ...
    invoke-virtual {p2, v0}, Lwd/w;->x1(Landroid/media/Image;)V
    ...
    invoke-direct {p0, v1, p2, v0}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Lwd/w;I)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Lwd/w;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Lwd/w;Ljava/lang/String;)V
...
.method private postCvWaterMark(Landroid/media/Image;Lwd/w;I)V
    .locals 5
    ...
    invoke-static {p1}, Ltd/d;->e(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v0}, Lwd/w;->d1(Z)V
...
.method public getParallelTaskData(J)Lwd/w;
    .locals 3
...
.method public putParallelTaskData(JLwd/w;)V
    .locals 4
