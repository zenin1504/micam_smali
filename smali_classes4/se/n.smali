...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lse/n;->a:Landroid/media/MediaRecorder;

    return-void
.end method

.method public static synthetic o(Lse/n;Lse/g$b;Landroid/media/MediaRecorder;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lse/n;->r(Lse/g$b;Landroid/media/MediaRecorder;II)V

    return-void
.end method

.method public static synthetic p(Lse/n;Lse/g$a;Landroid/media/MediaRecorder;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lse/n;->q(Lse/g$a;Landroid/media/MediaRecorder;II)V

    return-void
.end method

.method private synthetic q(Lse/g$a;Landroid/media/MediaRecorder;II)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, p3, p4}, Lse/g$a;->a(Lse/g;II)V

    :cond_0
    return-void
.end method

.method private synthetic r(Lse/g$b;Landroid/media/MediaRecorder;II)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, p3, p4}, Lse/g$b;->b(Lse/g;II)V

    :cond_0
    return-void
.end method

.method public static s(Landroid/media/MediaRecorder;Ljava/lang/String;)V
    .locals 8
...
.method public static t(Landroid/media/MediaRecorder;Lse/h;)Landroid/media/MediaRecorder;
    .locals 4
    ...
    :cond_3
    invoke-virtual {p1}, Lse/h;->L()Landroid/util/Pair;
    ...
    :cond_5
    invoke-virtual {p1}, Lse/h;->R()Z

    move-result v0

    if-eqz v0, :cond_9

    invoke-virtual {p1}, Lse/h;->x()I
    ...
    :cond_d
    invoke-virtual {p1}, Lse/h;->E()Landroid/util/Pair;
    ...
    :cond_e
    invoke-virtual {p1}, Lse/h;->D()Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lse/n;->s(Landroid/media/MediaRecorder;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lse/n;->s(Landroid/media/MediaRecorder;Ljava/lang/String;)V
...
.method public a()Landroid/media/MediaRecorder;
    ...
    iget-object p0, p0, Lse/n;->a:Landroid/media/MediaRecorder;
...
.method public g(Lse/g$a;)V
    ...
    iget-object v0, p0, Lse/n;->a:Landroid/media/MediaRecorder;

    new-instance v1, Lse/l;

    invoke-direct {v1, p0, p1}, Lse/l;-><init>(Lse/n;Lse/g$a;)V
...
.method public h(Lse/h;)V
    ...
    invoke-static {p0, p1}, Lse/n;->t(Landroid/media/MediaRecorder;Lse/h;)Landroid/media/MediaRecorder;
...
.method public m(Lse/g$b;)V
    ...
    invoke-direct {v1, p0, p1}, Lse/m;-><init>(Lse/n;Lse/g$b;)V
