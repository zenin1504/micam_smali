...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lwg/d;->a:Lcom/faceunity/pta_helper/gif/GifHardEncoder;
    ...
    iget v1, p0, Lwg/d;->c:I

    invoke-direct {v0, v1}, Ljava/util/concurrent/ArrayBlockingQueue;-><init>(I)V

    iput-object v0, p0, Lwg/d;->b:Ljava/util/concurrent/ArrayBlockingQueue;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lwg/d;->d:Ljava/util/List;
    ...
    iget-object v2, p0, Lwg/d;->d:Ljava/util/List;
...
.method public a()V
    ...
    iget-object p0, p0, Lwg/d;->b:Ljava/util/concurrent/ArrayBlockingQueue;
...
.method public d()Z
    ...
    iget-object v0, p0, Lwg/d;->b:Ljava/util/concurrent/ArrayBlockingQueue;

    invoke-virtual {v0}, Ljava/util/concurrent/ArrayBlockingQueue;->size()I

    move-result v0

    iget p0, p0, Lwg/d;->c:I
...
.method public e()V
    ...
    iget-object v1, p0, Lwg/d;->d:Ljava/util/List;
    ...
    :cond_0
    iget-object v1, p0, Lwg/d;->a:Lcom/faceunity/pta_helper/gif/GifHardEncoder;
    ...
    iget-object v1, p0, Lwg/d;->b:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    iget-object p0, p0, Lwg/d;->a:Lcom/faceunity/pta_helper/gif/GifHardEncoder;
...
.method public f()V
    ...
    iget-object v0, p0, Lwg/d;->a:Lcom/faceunity/pta_helper/gif/GifHardEncoder;

    invoke-virtual {v0}, Lcom/faceunity/pta_helper/gif/GifHardEncoder;->close()V

    invoke-virtual {p0}, Lwg/d;->a()V

    iget-object p0, p0, Lwg/d;->d:Ljava/util/List;
