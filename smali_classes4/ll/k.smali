...
.method public static a(Landroid/content/Context;)V
    ...
    sget v0, Ljl/a$f;->miuix_appcompat_floating_window_background_radius:I
...
.method public static c(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Bitmap;)Landroid/view/View;
    ...
    invoke-direct {v0, p0}, Lxm/l;-><init>(Landroid/content/Context;)V
...
.method public static d(Landroid/content/Context;Lmiuix/appcompat/app/AppCompatActivity;)Landroid/view/View;
    ...
    invoke-static {p1}, Lll/k;->f(Landroid/view/View;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-static {p0, p1, v0}, Lll/k;->c(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Bitmap;)Landroid/view/View;
...
.method public static e(Landroid/view/View;Landroid/graphics/Bitmap;)Landroid/view/View;
    ...
    invoke-static {v0, p0, p1}, Lll/k;->c(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Bitmap;)Landroid/view/View;
...
.method public static f(Landroid/view/View;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lll/k;->b(Landroid/view/View;)Z
    ...
    invoke-static {v0}, Lll/k;->a(Landroid/content/Context;)V
    ...
    invoke-static {v0, v1}, Lmm/a;->a(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
