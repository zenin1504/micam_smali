...
.method public constructor <init>(Ldd/e;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Ldd/k;->f:Ljava/util/LinkedList;

    iput-object p1, p0, Ldd/k;->a:Ldd/e;
    ...
    invoke-virtual {p2, v0, v1}, Lmd/a;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ldd/k;->e:Ljava/lang/String;

    const-string v0, "asr.encoded_by_client"

    const/4 v1, 0x0

    invoke-virtual {p2, v0, v1}, Lmd/a;->c(Ljava/lang/String;Z)Z
    ...
    iget-object v0, p0, Ldd/k;->e:Ljava/lang/String;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;-><init>(Ldd/a;)V

    iput-object v0, p0, Ldd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iget-object p1, p0, Ldd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->d()V

    const/4 p1, 0x0

    iput-object p1, p0, Ldd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    :cond_2
    const-string p1, "asr.vad_type"

    invoke-virtual {p2, p1}, Lmd/a;->e(Ljava/lang/String;)I
    ...
    :cond_3
    iput-boolean v1, p0, Ldd/k;->d:Z

    if-eqz v1, :cond_5

    const-string p1, "asr.enable_new_vad"

    invoke-virtual {p2, p1}, Lmd/a;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {p2, v2}, Lmd/a;->e(Ljava/lang/String;)I

    move-result v2

    const-string v3, "asr.maxvoice"

    invoke-virtual {p2, v3}, Lmd/a;->e(Ljava/lang/String;)I
    ...
    iput-object p1, p0, Ldd/k;->c:Lid/a;
...
.method public a()V
    ...
    :try_start_0
    iget-object v0, p0, Ldd/k;->f:Ljava/util/LinkedList;
    ...
    iget-object v2, p0, Ldd/k;->f:Ljava/util/LinkedList;
...
.method public b(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Ldd/k;->a:Ldd/e;

    invoke-virtual {v0}, Ldd/e;->q()Ldd/h;
    ...
    invoke-virtual {v0, v1}, Ldd/h;->d(Lkd/d;)V
...
.method public final c([BZ)V
    ...
    :cond_2
    iget-object v1, p0, Ldd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {v1, p1, p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->a([BZ)I

    move-result p1

    iget-object p2, p0, Ldd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    invoke-virtual {p2}, Lcom/xiaomi/ai/android/codec/AudioEncoder;->c()[B

    move-result-object p2

    iget-object v1, p0, Ldd/k;->a:Ldd/e;

    invoke-virtual {v1}, Ldd/e;->n()Lmd/b;
    ...
    iget-object p0, p0, Ldd/k;->a:Ldd/e;

    invoke-virtual {p0}, Ldd/e;->l()Ldd/f;

    move-result-object p0

    invoke-virtual {p0}, Ldd/f;->f()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Ldd/j;->f(Ljava/lang/String;)V

    const/4 p0, 0x0

    invoke-virtual {v1, p2, p0, p1}, Lmd/b;->t([BII)Z
...
.method public final f()V
    ...
    iget-object v1, p0, Ldd/k;->f:Ljava/util/LinkedList;
    ...
    :cond_0
    iget-object p0, p0, Ldd/k;->f:Ljava/util/LinkedList;
...
.method public final g()V
    ...
    invoke-virtual {v0}, Lkd/j;->a()Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_1
    iget-object p1, p0, Ldd/k;->a:Ldd/e;
    ...
    invoke-virtual {p1, v0}, Ldd/e;->g(Lnd/a;)V
    ...
    invoke-virtual {p0}, Ldd/e;->o()Ldd/b;

    move-result-object p0

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Ldd/b;->w(Z)V
    ...
    iget-object v5, p0, Ldd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    invoke-virtual {p0, v2, p1}, Ldd/k;->c([BZ)V
    ...
    iget-object v4, p0, Ldd/k;->a:Ldd/e;

    invoke-virtual {v4}, Ldd/e;->l()Ldd/f;

    move-result-object v4

    invoke-virtual {v4}, Ldd/f;->f()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p1, v4}, Ldd/j;->f(Ljava/lang/String;)V

    invoke-virtual {v0, v2}, Lmd/b;->s([B)Z
    ...
    :goto_1
    iget-object p1, p0, Ldd/k;->c:Lid/a;

    if-eqz p1, :cond_c

    if-eqz v2, :cond_c

    invoke-interface {p1, v2}, Lid/a;->a([B)Z
    ...
    new-instance p1, Ljd/ub;

    invoke-direct {p1}, Ljd/ub;-><init>()V

    invoke-static {p1}, Lkd/a;->c(Lkd/i;)Lkd/g;
    ...
    invoke-virtual {v1}, Ldd/f;->f()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lkd/h;->g(Ljava/lang/String;)Lkd/h;
    ...
    invoke-virtual {v0, p1}, Ldd/j;->v(Lkd/g;)V

    iget-object v0, p0, Ldd/k;->a:Ldd/e;

    invoke-virtual {v0}, Ldd/e;->k()Ldd/d;
    ...
    iget-object p0, p0, Ldd/k;->c:Lid/a;

    invoke-interface {p0}, Lid/a;->release()V
    ...
    iget-object v2, p0, Ldd/k;->c:Lid/a;

    invoke-interface {v2}, Lid/a;->release()V

    iget-object v2, p0, Ldd/k;->c:Lid/a;

    invoke-interface {v2}, Lid/a;->init()Z

    :cond_8
    iget-object v2, p0, Ldd/k;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    const-string v4, "SpeechRecognizer.RecognizeStreamFinished"

    if-eqz v2, :cond_a

    iget-object v2, p0, Ldd/k;->e:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v3}, Ldd/k;->c([BZ)V
    ...
    invoke-virtual {v1, p1}, Ldd/j;->o(Lkd/d;)V
    ...
    invoke-virtual {p0, v1}, Lcd/c;->d(Ljava/lang/String;)V

    :cond_b
    invoke-virtual {v0, p1}, Lmd/b;->u(Lkd/d;)Z
