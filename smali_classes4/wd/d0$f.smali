...
.method public constructor <init>(Lwd/d0;)V
    ...
    iput-object p1, p0, Lwd/d0$f;->a:Lwd/d0;
...
# virtual methods
.method public final a(Lwd/w;J)V
    .locals 11
    ...
    invoke-virtual {p1, v0}, Lwd/w;->l1(I)V
    ...
    invoke-virtual {v0, p2}, Lwd/d;->C(I)V

    iget-object p0, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {p0}, Lwd/d0;->M(Lwd/d0;)Lwd/r$e;

    move-result-object p0

    invoke-virtual {v0, p0}, Lwd/d;->F(Lwd/r$e;)V

    const/4 p0, 0x1

    invoke-virtual {v0, p0}, Lwd/d;->O(Z)V

    invoke-virtual {v0, p0}, Lwd/d;->J(Z)V

    invoke-static {}, Lwd/r;->w()Lwd/r;

    move-result-object p2

    invoke-virtual {p2, v0}, Lwd/r;->G(Lwd/d;)V
    ...
    invoke-virtual {p2, p1, p0}, Lwd/r;->B(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public onEarlyMetaAvailable(Lcom/xiaomi/camera/isp/ISPResult;)V
    ...
    iget-object v0, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {v0}, Lwd/d0;->E(Lwd/d0;)Ljava/lang/ref/WeakReference;
    ...
    invoke-static {p0}, Lwd/d0;->E(Lwd/d0;)Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p0, v0, v1, p1}, Lwd/j;->a(ILjava/lang/String;Ljava/lang/Object;)V
...
.method public onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, v3}, Ltd/e;->d(II)V

    iget-object p1, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {p1, v1, v2}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object v3, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-virtual {p1}, Lwd/w;->Q()Landroid/media/Image;

    move-result-object v4

    invoke-static {v3, v4}, Lwd/d0;->x(Lwd/d0;Landroid/media/Image;)V

    invoke-virtual {p1}, Lwd/w;->v0()V

    iget-object p1, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {p1, v1, v2}, Lwd/d0;->l(Lwd/d0;J)Lwd/w;
...
.method public onJpegAvailable([BLjava/lang/String;)V
    ...
    invoke-static {v3, v1, v2}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;
    ...
    invoke-virtual {v3, p1, p2}, Lwd/w;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {v3, p2}, Lwd/w;->b0(Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object p2, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {p2}, Lwd/d0;->G(Lwd/d0;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v4, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {v4}, Lwd/d0;->H(Lwd/d0;)Ljava/util/HashMap;
    ...
    invoke-static {v4, v1, v2}, Lwd/d0;->l(Lwd/d0;J)Lwd/w;
    ...
    invoke-virtual {v3, p2}, Lwd/w;->Z0(Z)V

    invoke-virtual {v3}, Lwd/w;->k()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {p1}, Lwd/d0;->q(Lwd/d0;)Lr7/h;

    move-result-object p1

    const/4 v4, 0x0

    invoke-virtual {p1, v3, p2, v4, v4}, Lr7/h;->j(Lwd/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-virtual {v3}, Lwd/w;->Q()Landroid/media/Image;

    move-result-object v4

    invoke-static {p2, v4}, Lwd/d0;->x(Lwd/d0;Landroid/media/Image;)V

    if-eqz p1, :cond_3

    invoke-virtual {v3}, Lwd/w;->v0()V

    :cond_3
    iget-object p1, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {p1, v3}, Lwd/d0;->y(Lwd/d0;Lwd/w;)Z
    ...
    invoke-interface {p1, v3}, Lwd/d0$j;->b(Lwd/w;)V
    ...
    invoke-static {p1}, Lwd/d0;->z(Lwd/d0;)I

    move-result p2

    invoke-static {p1, v3, p2}, Lwd/d0;->C(Lwd/d0;Lwd/w;I)Z
...
.method public onJpegImageAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-static {v4, v1, v2}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;
    ...
    :cond_1
    invoke-virtual {v4, v7, p2}, Lwd/w;->a([BI)V
    ...
    invoke-virtual {v4, p1}, Lwd/w;->O0([B)V
    ...
    invoke-virtual {p2}, Lwd/x;->j0()I

    move-result v8

    invoke-static {v3, v6, v8}, Lu8/c;->i(III)Landroid/graphics/Rect;
    ...
    invoke-virtual {v4, v3}, Lwd/w;->L0(Landroid/graphics/Rect;)V

    sget-boolean p2, Lcom/android/camera/j6;->g:Z

    if-eqz p2, :cond_2

    invoke-virtual {v4}, Lwd/w;->N()Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lcom/android/camera/j6;->l4([BLjava/lang/String;)V

    :cond_2
    const-string p1, "JPEG"

    invoke-virtual {v4, p1}, Lwd/w;->b0(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, p2}, Lwd/w;->Z0(Z)V

    invoke-virtual {v4}, Lwd/w;->k()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object p3, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {p3}, Lwd/d0;->q(Lwd/d0;)Lr7/h;

    move-result-object p3

    invoke-virtual {p3, v4, p2, v6, p1}, Lr7/h;->j(Lwd/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v4, p2, v6, v6}, Lr7/h;->j(Lwd/w;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z
    ...
    invoke-virtual {v4}, Lwd/w;->Q()Landroid/media/Image;
    ...
    invoke-virtual {v4}, Lwd/w;->v0()V

    :cond_6
    iget-object p1, p0, Lwd/d0$f;->a:Lwd/d0;

    invoke-static {p1, v4}, Lwd/d0;->y(Lwd/d0;Lwd/w;)Z
    ...
    invoke-interface {p1, v4}, Lwd/d0$j;->b(Lwd/w;)V
...
.method public onTuningImageAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-static {v0, v1, v2}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;
    ...
    invoke-virtual {p0, v5, v1, v2}, Lwd/d0$f;->a(Lwd/w;J)V
    ...
    invoke-virtual {p0, p1, p2, v3, p3}, Lwd/r;->A(Landroid/media/Image;IIZ)V
    ...
    invoke-static/range {v4 .. v9}, Lwd/d0;->I(Lwd/d0;Lwd/w;Landroid/media/Image;Ljava/lang/String;IZ)V
...
.method public onYuvAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v6}, Lwd/w;->e()I

    move-result v4

    invoke-static {v4}, Ltd/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_2

    invoke-virtual {v6}, Lwd/w;->k0()Z

    move-result p2

    if-nez p2, :cond_1

    invoke-virtual {p0, v6, v1, v2}, Lwd/d0$f;->a(Lwd/w;J)V
    ...
    invoke-virtual {p0, p1, v0, v3, p3}, Lwd/r;->A(Landroid/media/Image;IIZ)V

    goto :goto_0

    :cond_2
    iget-object v5, p0, Lwd/d0$f;->a:Lwd/d0;
    ...
    invoke-static/range {v5 .. v10}, Lwd/d0;->I(Lwd/d0;Lwd/w;Landroid/media/Image;Ljava/lang/String;IZ)V
