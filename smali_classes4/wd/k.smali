...
.method public constructor <init>(Lwd/k$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object v0, p0, Lwd/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lwd/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lwd/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v2, p0, Lwd/k;->g:Ljava/lang/Object;

    new-instance v2, Landroid/os/ConditionVariable;

    invoke-direct {v2}, Landroid/os/ConditionVariable;-><init>()V

    iput-object v2, p0, Lwd/k;->k:Landroid/os/ConditionVariable;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lwd/k;->o:Ljava/lang/Object;

    new-instance v2, Ljava/util/LinkedList;

    invoke-direct {v2}, Ljava/util/LinkedList;-><init>()V

    iput-object v2, p0, Lwd/k;->p:Ljava/util/LinkedList;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lwd/k;->q:Ljava/lang/Object;

    iput v1, p0, Lwd/k;->r:I
    ...
    iput-object p1, p0, Lwd/k;->j:Lwd/k$a;
    ...
    :goto_0
    iput-boolean p1, p0, Lwd/k;->n:Z

    sget-object p1, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    new-array v0, v0, [Ljava/lang/Object;

    invoke-virtual {p0}, Lwd/k;->i()Ljava/lang/String;
    ...
    iput-object p1, p0, Lwd/k;->m:Ljava/lang/String;
    ...
    iput-object v0, p0, Lwd/k;->h:Landroid/os/HandlerThread;

    new-instance p1, Lwd/h;

    invoke-direct {p1}, Lwd/h;-><init>()V

    iput-object p1, p0, Lwd/k;->l:Lwd/h;
    ...
    invoke-virtual {p1, p0}, Lwd/h;->d(Landroid/util/Size;)V
...
.method public D(I)V
    ...
    iget-object v0, p0, Lwd/k;->q:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iput p1, p0, Lwd/k;->r:I
...
.method public G()V
    ...
    iget-object v0, p0, Lwd/k;->h:Landroid/os/HandlerThread;
    ...
    iget-object v3, p0, Lwd/k;->h:Landroid/os/HandlerThread;

    invoke-virtual {v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    invoke-direct {v1, v3, p0}, Lwd/k$b;-><init>(Landroid/os/Looper;Lwd/k;)V

    iput-object v1, p0, Lwd/k;->i:Landroid/os/Handler;
    ...
    invoke-virtual {p0, v0}, Lwd/k;->D(I)V
...
.method public H()V
    ...
    iput-object v3, p0, Lwd/k;->i:Landroid/os/Handler;
...
.method public J()Z
    ...
    invoke-virtual {p0, v2}, Lwd/k;->D(I)V
...
.method public K()V
    ...
    invoke-virtual {p0}, Lwd/k;->s()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lwd/k;->p()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lwd/k;->H()V
...
.method public abstract e(Lwd/h0;)I
    .param p1    # Lwd/h0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public f(Lwd/i;)V
    ...
    iget-object v0, p1, Lwd/i;->a:Landroid/media/Image;

    invoke-virtual {v0}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v1

    iget v3, p1, Lwd/i;->b:I

    iget-object v4, p0, Lwd/k;->j:Lwd/k$a;
    ...
    invoke-interface {v4, v1, v2}, Lwd/k$a;->g(J)Lwd/w;
    ...
    :cond_0
    sget-boolean v8, Lwd/d0;->H:Z

    if-nez v8, :cond_1

    invoke-virtual {v4}, Lwd/w;->e()I

    move-result v8

    invoke-static {v8}, Ltd/c;->d(I)Z
    ...
    iget-object v1, p0, Lwd/k;->l:Lwd/h;

    invoke-virtual {v1, v4, v0, v3}, Lwd/h;->a(Lwd/w;Landroid/media/Image;I)V
    ...
    :goto_1
    iget-object v2, p0, Lwd/k;->j:Lwd/k$a;

    iget-boolean p1, p1, Lwd/i;->c:Z

    invoke-interface {v2, v0, v3, p1}, Lwd/k$a;->c(Landroid/media/Image;IZ)V
    ...
    :cond_6
    iget-object p1, p0, Lwd/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_7
    iget-object p1, p0, Lwd/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_8
    iget-object p1, p0, Lwd/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public y(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;
    ...
    invoke-static {p1, p2, p0}, Ltd/d;->j(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
...
.method public z()V
    ...
    iput-object v0, p0, Lwd/k;->l:Lwd/h;
