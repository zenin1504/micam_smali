...
.method public constructor <init>(Lwd/d0;)V
    ...
    iput-object p1, p0, Lwd/d0$c;->a:Lwd/d0;
...
.method public b(Lwd/d;)V
    ...
    invoke-virtual {p0, p1, v0}, Lwd/d0$c;->d(Lwd/d;Ljava/lang/String;)V
...
.method public c(Lwd/d;)V
    ...
    iget-object v5, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-virtual {v5}, Lwd/d0;->z0()Z
    ...
    iget-object v6, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-static {v6, v7, v8}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;

    move-result-object v6

    invoke-virtual {v5}, Lwd/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v6, v9, v10}, Lwd/w;->w1(J)V

    iget-object v11, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-static {v11, v7, v8}, Lwd/d0;->l(Lwd/d0;J)Lwd/w;

    iget-object v11, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-static {v11, v9, v10, v6}, Lwd/d0;->K(Lwd/d0;JLwd/w;)V

    :cond_1
    if-ne v1, v0, :cond_4

    iget-object v1, p0, Lwd/d0$c;->a:Lwd/d0;
    ...
    invoke-virtual {v0}, Lwd/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-static {v4, v7, v8}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;

    move-result-object v4

    if-eqz v4, :cond_9

    invoke-virtual {v4, v1}, Lwd/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V

    invoke-virtual {v4}, Lwd/w;->q()Lwd/x;

    move-result-object v1

    invoke-virtual {v1}, Lwd/x;->Z0()Z
    ...
    invoke-virtual {v4}, Lwd/w;->M()Lbk/c;
    ...
    invoke-direct/range {v0 .. v6}, Lwd/h0;-><init>(Ljava/util/List;ZJZLbk/c;)V

    invoke-virtual {p1}, Lwd/d;->c()I

    move-result v0

    invoke-virtual {p0, v0}, Lwd/h0;->h(I)V
    ...
    iget-object v0, p1, Lwd/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p1, p0}, Lwd/k;->e(Lwd/h0;)I

    goto/16 :goto_1

    :cond_8
    iget-object p1, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-static {p1}, Lwd/d0;->d(Lwd/d0;)Lwd/k$a;

    move-result-object p1

    invoke-interface {p1, v7, v8, v3}, Lwd/k$a;->f(JI)V
    ...
    invoke-virtual {p1, v1}, Lq6/n;->V(Ljava/lang/String;)V
    ...
    invoke-interface {p1, v0, v3, v3}, Lwd/k$a;->c(Landroid/media/Image;IZ)V

    invoke-virtual {v0}, Landroid/media/Image;->close()V

    invoke-virtual {p0, v0}, Lwd/d0$c;->a(Landroid/media/Image;)V
    ...
    :cond_a
    iget-object v0, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-static {v0, v7, v8}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;
    ...
    invoke-static {v7}, Lcom/android/camera2/s3;->e0(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    invoke-virtual {v5}, Lwd/d$a;->e()Landroid/media/Image;

    move-result-object v1

    invoke-virtual {v0, v6}, Lwd/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v5, v1, v4}, Ltd/d;->j(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
    ...
    invoke-direct {v5, v4, v3, v6}, Lwd/i;-><init>(Landroid/media/Image;IZ)V

    invoke-virtual {v0, v5}, Lwd/k;->d(Lwd/i;)V
    ...
    :cond_b
    invoke-virtual {p0, v1}, Lwd/d0$c;->a(Landroid/media/Image;)V

    goto :goto_1

    :cond_c
    invoke-virtual {p0, p1, v1}, Lwd/d0$c;->d(Lwd/d;Ljava/lang/String;)V
...
.method public final d(Lwd/d;Ljava/lang/String;)V
    .locals 13
    .param p1    # Lwd/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v5, v9, v10}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;
    ...
    iget-object v7, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-virtual {p1}, Lwd/d;->b()I

    move-result v9

    invoke-static {v7, p1, v9}, Lwd/d0;->O(Lwd/d0;Lwd/d;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    invoke-virtual {v5, v7}, Lwd/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v7, v10, v11}, Lwd/d0;->N(Lwd/d0;J)Lwd/w;
    ...
    iget-object v8, p0, Lwd/d0$c;->a:Lwd/d0;

    invoke-virtual {p1}, Lwd/d;->b()I

    move-result v9

    invoke-static {v8, p1, v9}, Lwd/d0;->O(Lwd/d0;Lwd/d;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v8

    invoke-virtual {v7, v8}, Lwd/w;->I0(Lcom/xiaomi/protocol/ICustomCaptureResult;)V
    ...
    invoke-static {v0, p2, p0}, Lwd/d0;->k(Lwd/d0;Lwd/d$a;Lwd/e;)V
    ...
    iget-object v5, v4, Lwd/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_9
    iget-object p0, p0, Lwd/d0$c;->a:Lwd/d0;
    ...
    invoke-virtual {v0, v2}, Lwd/h0;->i(I)V

    :cond_b
    if-eqz v4, :cond_c

    invoke-virtual {v4, v0}, Lwd/k;->e(Lwd/h0;)I
