...
.method public constructor <init>(Lwd/k$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Lwd/b;-><init>(Lwd/k$a;Lcom/xiaomi/engine/BufferFormat;)V
...
.method public X(Lwd/h0;)V
    ...
    invoke-virtual {p1}, Lwd/h0;->f()Lbk/c;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lwd/f;->g0(Lwd/h0;)V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Lwd/f;->h0(Lwd/h0;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object v1, p0, Lwd/b;->x:Landroid/media/ImageReader;

    new-instance v2, Lwd/f$a;

    invoke-direct {v2, p0}, Lwd/f$a;-><init>(Lwd/f;)V
    ...
    iget-object v2, p0, Lwd/b;->x:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, Lwd/b;->y:Landroid/media/ImageReader;

    new-instance v2, Lwd/f$b;

    invoke-direct {v2, p0}, Lwd/f$b;-><init>(Lwd/f;)V
    ...
    iget-object v2, p0, Lwd/b;->y:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lwd/b;->z:Landroid/media/ImageReader;

    new-instance v1, Lwd/f$c;

    invoke-direct {v1, p0}, Lwd/f$c;-><init>(Lwd/f;)V
    ...
    iget-object p0, p0, Lwd/b;->z:Landroid/media/ImageReader;
...
.method public final f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-virtual {v0}, Ll9/es;->b()Ljava/lang/Object;
    ...
    :cond_2
    new-instance p1, Lwd/f$d;

    invoke-direct {p1, p0}, Lwd/f$d;-><init>(Lwd/f;)V
    ...
    iget-object p1, p0, Lwd/b;->B:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p2, p0, Lwd/b;->v:Lcom/xiaomi/engine/TaskSession;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Lwd/b;->w:Lwd/j0;

    invoke-virtual {p2}, Lwd/j0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_4
    new-instance p1, Lwd/f$e;

    invoke-direct {p1, p0}, Lwd/f$e;-><init>(Lwd/f;)V
...
.method public final g0(Lwd/h0;)V
    .locals 9
    .param p1    # Lwd/h0;
    ...
    invoke-virtual {v1}, Lwd/d$a;->k()Landroid/media/Image;

    move-result-object v3

    invoke-virtual {p0, v2}, Lwd/k;->q(Landroid/media/Image;)Z

    move-result v4

    invoke-virtual {p0, v3}, Lwd/k;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v8, v7}, Ltd/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v1}, Lwd/d$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p1}, Lwd/h0;->e()I

    move-result v4

    invoke-virtual {p0, v1, v2, v7, v4}, Lwd/f;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-virtual {p0, v1, v3, v2, v4}, Lwd/f;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final h0(Lwd/h0;)V
    .locals 7
    .param p1    # Lwd/h0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v4, v5}, Ltd/e;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v1, v2, v5, v4}, Lwd/f;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public p()Z
    ...
    iget-object v1, p0, Lwd/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lwd/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lwd/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lwd/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, p0}, Lwd/k$a;->e(Lwd/k;)Z
    ...
    iget-object p0, p0, Lwd/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
