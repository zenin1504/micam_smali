...
.method public b(Landroid/content/Context;Lu1/i;)Landroid/graphics/PointF;
    ...
    invoke-virtual {v2, p1, p2}, Lu1/d;->b(Landroid/content/Context;Lu1/i;)Lh1/b;
...
.method public f(Landroid/app/Activity;FLu1/i;)V
    ...
    invoke-virtual {p0, p1, p3}, Lv1/i;->k(Landroid/content/Context;Lu1/i;)Landroid/graphics/PointF;

    move-result-object p3

    if-eqz p3, :cond_0

    invoke-virtual {p0}, Lv1/i;->l()[I
...
.method public i(Landroid/app/Activity;FLu1/i;)V
    ...
    invoke-virtual {p0, p1, p3}, Lv1/i;->m(Landroid/content/Context;Lu1/i;)Landroid/graphics/PointF;

    move-result-object p3

    if-eqz p3, :cond_0

    invoke-virtual {p0}, Lv1/i;->n()[I
...
.method public final k(Landroid/content/Context;Lu1/i;)Landroid/graphics/PointF;
    ...
    :cond_0
    iget-object p1, p0, Lv1/b;->a:Lu1/a;
    ...
    iget-object v0, p0, Lv1/b;->a:Lu1/a;

    iget-object v0, v0, Lu1/a;->a:Landroid/graphics/Rect;

    invoke-virtual {v0}, Landroid/graphics/Rect;->height()I

    move-result v0

    iget-object v1, p0, Lv1/b;->a:Lu1/a;

    iget-object v1, v1, Lu1/a;->a:Landroid/graphics/Rect;
    ...
    iget-object p2, p1, Lu1/a;->a:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Lv1/b;->b:Landroid/graphics/PointF;
...
.method public final m(Landroid/content/Context;Lu1/i;)Landroid/graphics/PointF;
    .locals 5
    ...
    invoke-virtual {p2, p1}, Lh1/b;->j(Landroid/content/Context;)I
