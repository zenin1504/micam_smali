...
.method public constructor <init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
    ...
    iput-object v0, p0, Ld0/z;->d:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Ld0/z;->a:Landroid/view/View;
    ...
    iput-object p1, p0, Ld0/z;->b:Landroid/view/ViewGroup;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iput-object p1, p0, Ld0/z;->i:Ljava/lang/StringBuilder;
...
.method public c(Lb0/v;FIZ)V
    ...
    iget-object p3, p0, Ld0/z;->d:Landroid/graphics/Rect;
...
.method public g(Lb0/v;)V
    ...
    iget-object v0, p0, Ld0/z;->i:Ljava/lang/StringBuilder;

    invoke-virtual {p1, v0}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object p0, p0, Ld0/z;->i:Ljava/lang/StringBuilder;
...
.method public i(Lb0/v;Landroid/graphics/Rect;IF)V
    ...
    iget-object p1, p0, Ld0/z;->b:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object p1, p0, Ld0/z;->c:Landroid/graphics/Rect;

    if-nez p1, :cond_1

    new-instance p1, Landroid/graphics/Rect;

    iget-object p4, p0, Ld0/z;->b:Landroid/view/ViewGroup;

    invoke-virtual {p4}, Landroid/view/View;->getLeft()I

    move-result p4

    iget-object v0, p0, Ld0/z;->b:Landroid/view/ViewGroup;

    invoke-virtual {v0}, Landroid/view/View;->getTop()I

    move-result v0

    iget-object v1, p0, Ld0/z;->b:Landroid/view/ViewGroup;

    invoke-virtual {v1}, Landroid/view/View;->getRight()I

    move-result v1

    iget-object v2, p0, Ld0/z;->b:Landroid/view/ViewGroup;
    ...
    iput-object p1, p0, Ld0/z;->c:Landroid/graphics/Rect;
    ...
    iget-object p4, p0, Ld0/z;->c:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Ld0/z;->c:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1, p3}, Ld0/z;->l(Landroid/graphics/Rect;I)Z
    ...
    invoke-virtual {p0, p2, p1, v0}, Ld0/z;->n(Landroid/graphics/Rect;ILandroid/util/Size;)V

    iget-object p0, p0, Ld0/z;->b:Landroid/view/ViewGroup;
...
.method public j()Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/android/camera/j6;->r0(Landroid/content/Context;)Z
...
.method public k(Landroid/widget/TextView;FF)I
    .locals 1
...
.method public l(Landroid/graphics/Rect;I)Z
    .locals 2
...
.method public m(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Ld0/z;->i:Ljava/lang/StringBuilder;
...
.method public n(Landroid/graphics/Rect;ILandroid/util/Size;)V
    ...
    iget-object v0, p0, Ld0/z;->d:Landroid/graphics/Rect;
