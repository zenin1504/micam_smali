...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Le5/i;->a:[Ljava/lang/String;
    ...
    sput-object v0, Le5/i;->b:[Ljava/lang/String;
    ...
    sput-object v0, Le5/i;->c:Landroid/net/Uri;
    ...
    sput-object v0, Le5/i;->d:Ljava/util/List;

    const-string v1, ".mp3"

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v0, Le5/i;->d:Ljava/util/List;
    ...
    sput-object v0, Le5/i;->e:Ljava/util/List;

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v0, Le5/i;->e:Ljava/util/List;
...
.method public static b(JJ)Landroid/net/Uri;
    ...
    sget-object p0, Le5/i;->c:Landroid/net/Uri;
...
.method public static c(Landroid/content/Context;)Ljava/util/List;
    ...
    :goto_1
    iput-object v4, v1, Le5/f;->b:Ljava/lang/String;
    ...
    :goto_2
    iput-object v5, v1, Le5/f;->a:Ljava/lang/String;
    ...
    :goto_3
    iput-object v3, v1, Le5/f;->g:Ljava/lang/String;
    ...
    iput-wide v6, v1, Le5/f;->e:J

    invoke-static {v6, v7}, Le5/i;->a(J)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v1, Le5/f;->f:Ljava/lang/String;
    ...
    iput-wide v8, v1, Le5/f;->c:J

    iget-object v3, v1, Le5/f;->g:Ljava/lang/String;
    ...
    invoke-static {v3}, Le6/ja;->q(Ljava/io/File;)Ljava/lang/String;

    move-result-object v3

    sget-object v9, Le5/i;->d:Ljava/util/List;
    ...
    iget-object v9, v1, Le5/f;->g:Ljava/lang/String;

    invoke-static {v9}, Le6/ja;->s(Ljava/lang/String;)J
    ...
    :cond_4
    iput-object v3, v1, Le5/f;->i:Ljava/lang/String;
...
.method public static d(Ljava/lang/String;Landroid/content/Context;)Ljava/util/List;
    ...
    :cond_0
    sget-object v3, Le5/i;->a:[Ljava/lang/String;

    goto :goto_1

    :cond_1
    :goto_0
    sget-object v3, Le5/i;->b:[Ljava/lang/String;
    ...
    new-instance v9, Le5/f;

    invoke-direct {v9}, Le5/f;-><init>()V
    ...
    :cond_4
    iput-object v10, v9, Le5/f;->b:Ljava/lang/String;
    ...
    sget-object v11, Le6/ja;->r:Ljava/lang/String;
    ...
    :cond_5
    iput-object v7, v9, Le5/f;->h:Ljava/lang/String;
    ...
    :cond_6
    iput-object v7, v9, Le5/f;->a:Ljava/lang/String;
    ...
    iput-wide v10, v9, Le5/f;->e:J

    invoke-static {v10, v11}, Le5/i;->a(J)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v9, Le5/f;->f:Ljava/lang/String;

    invoke-virtual {v8}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object v7

    iput-object v7, v9, Le5/f;->g:Ljava/lang/String;
    ...
    iget-object v8, v9, Le5/f;->a:Ljava/lang/String;
    ...
    iget-object v10, v9, Le5/f;->b:Ljava/lang/String;

    invoke-virtual {v7, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v8, v9, Le5/f;->g:Ljava/lang/String;
    ...
    iget-object v10, v9, Le5/f;->h:Ljava/lang/String;

    invoke-virtual {v7, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v8, v9, Le5/f;->e:J
