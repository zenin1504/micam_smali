...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lp0/c;->g:[I

    const-string v1, "camera_click.ogg"

    const-string v2, "camera_focus.ogg"

    const-string v3, "video_record_start.ogg"

    const-string v4, "video_record_end.ogg"
...
.method public constructor <init>()V
    ...
    .line 2
    invoke-virtual {p0}, Lp0/c;->f()Ljava/util/List;
...
.method public constructor <init>(ILjava/lang/String;I)V
    ...
    .line 6
    iput-object p2, p0, Lp0/c;->c:Ljava/lang/String;

    .line 7
    sget-object p1, Lp0/c;->h:[Ljava/lang/String;

    array-length p1, p1

    new-array p1, p1, [I

    iput-object p1, p0, Lp0/c;->d:[I

    const/4 p1, 0x0

    .line 8
    :goto_0
    iget-object p2, p0, Lp0/c;->d:[I
...
.method public static declared-synchronized c()Lp0/c;
    .locals 2
...
.method public d()Ljava/util/List;
    ...
    iget-object p0, p0, Lp0/c;->f:Ljava/util/List;
...
.method public final f()Ljava/util/List;
    ...
    invoke-direct {v0, v3, v1, v2}, Lp0/c;-><init>(ILjava/lang/String;I)V
...
.method public final g(ILandroid/media/SoundPool;)I
    ...
    sget-object p0, Lp0/c;->i:[Ljava/lang/String;
    ...
    invoke-static {p0, p2}, Lp0/c;->h(Ljava/lang/String;Landroid/media/SoundPool;)I
...
.method public final i(IILandroid/media/SoundPool;)I
    ...
    invoke-virtual {p0, p2}, Lp0/c;->s(I)Ljava/lang/String;

    move-result-object p0

    invoke-static {p0, p3}, Lp0/c;->h(Ljava/lang/String;Landroid/media/SoundPool;)I
...
.method public j(Landroid/media/SoundPool;I)I
    ...
    invoke-virtual {p0, p2}, Lp0/c;->e(I)Z
    ...
    sget-object v0, Lp0/c;->j:[I

    aget v0, v0, p2

    if-ne v0, v1, :cond_0

    invoke-virtual {p0, p2, p1}, Lp0/c;->g(ILandroid/media/SoundPool;)I
    ...
    iget-object v2, p0, Lp0/c;->f:Ljava/util/List;
    ...
    invoke-virtual {v2}, Lp0/c;->b()Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {v2, p2}, Lp0/c;->k(I)Z

    move-result v1

    if-nez v1, :cond_3

    invoke-virtual {p0, v0, p2, p1}, Lp0/c;->i(IILandroid/media/SoundPool;)I

    move-result p0

    invoke-virtual {v2, p2, p0}, Lp0/c;->q(II)V

    :cond_3
    invoke-virtual {v2, p2}, Lp0/c;->r(I)I
...
.method public s(I)Ljava/lang/String;
    ...
    sget-object p0, Lp0/c;->h:[Ljava/lang/String;
...
.method public v(ILandroid/media/SoundPool;FILjava/util/ArrayList;)I
    ...
    invoke-virtual {p0, p1}, Lp0/c;->e(I)Z
    ...
    invoke-virtual {p0, v8, p2}, Lp0/c;->g(ILandroid/media/SoundPool;)I
    ...
    const-string v1, "tryPlaySound play fail, commonSoundIds["
    ...
    iget-object v4, v0, Lp0/c;->f:Ljava/util/List;
    ...
    invoke-virtual {v12}, Lp0/c;->b()Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v12, p1}, Lp0/c;->k(I)Z

    move-result v4

    if-eqz v4, :cond_7

    invoke-virtual {v12, p1}, Lp0/c;->r(I)I
    ...
    const-string v2, "tryPlaySound play fail, ss.soundId("
    ...
    :cond_7
    invoke-virtual {p0, v3, p1, p2}, Lp0/c;->i(IILandroid/media/SoundPool;)I

    move-result v0

    invoke-virtual {v12, p1, v0}, Lp0/c;->q(II)V
