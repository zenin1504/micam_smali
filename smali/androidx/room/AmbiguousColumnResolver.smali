...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILqk/l;)V
    .locals 2
    ...
    invoke-static {p2}, Lfk/w;->W(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILqk/l;)V

    invoke-static {p2}, Lfk/t;->x(Ljava/util/List;)Ljava/lang/Object;
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILqk/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILqk/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lqk/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lqk/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v2, v6}, Lfk/t;->w(Ljava/util/Collection;[Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-static {v2}, Lfk/h0;->a(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-direct {v10, v0, v6, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lqk/q;)V
    ...
    :cond_9
    invoke-static {v14}, Lfk/n;->a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILqk/l;ILjava/lang/Object;)V
    ...
    invoke-direct {v12, v0}, Landroidx/room/AmbiguousColumnResolver$resolve$4;-><init>(Lkotlin/jvm/internal/y;)V

    const/4 v13, 0x6

    const/4 v14, 0x0

    invoke-static/range {v8 .. v14}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILqk/l;ILjava/lang/Object;)V
    ...
    invoke-static {v0, v2}, Lfk/p;->r(Ljava/lang/Iterable;I)I
