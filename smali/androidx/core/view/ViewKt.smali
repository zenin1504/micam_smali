...
# direct methods
.method public static final doOnAttach(Landroid/view/View;Lqk/l;)V
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Landroidx/core/view/ViewKt$doOnAttach$1;-><init>(Landroid/view/View;Lqk/l;)V
...
.method public static final doOnDetach(Landroid/view/View;Lqk/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/core/view/ViewKt$doOnDetach$1;-><init>(Landroid/view/View;Lqk/l;)V
...
.method public static final doOnLayout(Landroid/view/View;Lqk/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Landroidx/core/view/ViewKt$doOnLayout$$inlined$doOnNextLayout$1;-><init>(Lqk/l;)V
...
.method public static final doOnNextLayout(Landroid/view/View;Lqk/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Landroidx/core/view/ViewKt$doOnNextLayout$1;-><init>(Lqk/l;)V
...
.method public static final doOnPreDraw(Landroid/view/View;Lqk/l;)Landroidx/core/view/OneShotPreDrawListener;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0}, Landroidx/core/view/ViewKt$doOnPreDraw$1;-><init>(Lqk/l;Landroid/view/View;)V
...
.method public static final getAllViews(Landroid/view/View;)Lxk/g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, v1}, Landroidx/core/view/ViewKt$allViews$1;-><init>(Landroid/view/View;Lik/d;)V

    invoke-static {v0}, Lxk/j;->b(Lqk/p;)Lxk/g;
...
.method public static final getAncestors(Landroid/view/View;)Lxk/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final postDelayed(Landroid/view/View;JLqk/a;)Ljava/lang/Runnable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p3}, Landroidx/core/view/ViewKt$postDelayed$runnable$1;-><init>(Lqk/a;)V
...
.method public static final postOnAnimationDelayed(Landroid/view/View;JLqk/a;)Ljava/lang/Runnable;
    .locals 1
    ...
    invoke-direct {v0, p3}, Landroidx/core/view/ViewKt$postOnAnimationDelayed$runnable$1;-><init>(Lqk/a;)V
...
.method public static final updateLayoutParams(Landroid/view/View;Lqk/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final synthetic updateLayoutParamsTyped(Landroid/view/View;Lqk/l;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
