...
.field private mHapticFeedbackCompat:Lio/b;
...
.method public constructor <init>(Landroidx/recyclerview/widget/RemixRecyclerView;)V
    ...
    invoke-direct {v1, p1, v0}, Len/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;
...
.method private getHapticFeedbackCompat()Lio/b;
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lio/b;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lio/b;

    :cond_0
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lio/b;
...
.method private internalPostOnAnimation()V
    ...
    invoke-static {v0, p0}, Len/a;->b(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public fling(II)V
    ...
    invoke-direct {v2, v4, v3}, Len/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;
    ...
    :cond_9
    :goto_4
    iget-object v3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;
    ...
    invoke-virtual/range {v3 .. v11}, Len/d;->c(IIIIIIII)V
...
.method public resetFlingPosition()V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;

    invoke-virtual {p0}, Len/d;->s()V
...
.method public run()V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;

    invoke-virtual {v1}, Len/d;->b()Z

    move-result v4

    if-eqz v4, :cond_21

    invoke-virtual {v1}, Len/d;->i()I
    ...
    iget-object v6, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;

    invoke-virtual {v6}, Len/d;->m()I

    move-result v6

    if-ne v6, v3, :cond_1

    invoke-virtual {v1}, Len/d;->g()F
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;

    invoke-virtual {v4}, Len/d;->m()I
    ...
    iget-object v8, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;

    invoke-virtual {v8}, Len/d;->g()F

    move-result v8

    iget-object v9, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;

    invoke-virtual {v9}, Len/d;->h()F

    move-result v9

    invoke-interface {v7, v8, v9}, Lhm/c;->b(FF)Z
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;

    invoke-virtual {v5}, Len/d;->o()I
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->getHapticFeedbackCompat()Lio/b;

    move-result-object v1

    const/16 v4, 0xc9

    invoke-virtual {v1, v4}, Lio/b;->e(I)V
...
.method public smoothScrollBy(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_2
    iget-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;

    invoke-virtual {p3}, Len/d;->m()I
    ...
    invoke-direct {p3, v2, p4}, Len/d;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Len/d;
    ...
    invoke-virtual/range {v1 .. v7}, Len/d;->x(IIIIII)V
