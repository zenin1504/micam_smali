...
.method public static synthetic m(Lt4/l;Landroidx/fragment/app/FragmentTransaction;IIILjava/util/List;Ljava/util/List;Lcom/android/camera/fragment/BaseFragment;)V
    .locals 0

    invoke-direct/range {p0 .. p7}, Lt4/l;->n(Landroidx/fragment/app/FragmentTransaction;IIILjava/util/List;Ljava/util/List;Lcom/android/camera/fragment/BaseFragment;)V

    return-void
.end method

.method private synthetic n(Landroidx/fragment/app/FragmentTransaction;IIILjava/util/List;Ljava/util/List;Lcom/android/camera/fragment/BaseFragment;)V
    .locals 2

    invoke-virtual {p0, p1, p2, p7}, Lt4/h;->d(Landroidx/fragment/app/FragmentTransaction;ILandroidx/fragment/app/Fragment;)V
    ...
    invoke-virtual {p0, p3, p2, p1}, Lt4/l;->o(II[I)V
...
.method public l(Lmiuix/appcompat/app/AppCompatActivity;Landroidx/fragment/app/FragmentTransaction;Lt4/h$b;)V
    ...
    iget v9, v0, Lcom/android/camera/fragment/w;->b:I

    iget v4, v0, Lcom/android/camera/fragment/w;->c:I

    invoke-virtual {p0, v9}, Lt4/h;->f(I)I

    move-result v0

    iget-object v1, p0, Lt4/h;->a:Lcom/android/camera/fragment/w;

    iget-object v2, v1, Lcom/android/camera/fragment/w;->f:Lcom/android/camera/fragment/v4;

    iget v6, v1, Lcom/android/camera/fragment/w;->e:I

    invoke-virtual {p0, v9}, Lt4/h;->g(I)Ljava/util/List;
    ...
    invoke-virtual {p0, v5, v3}, Lt4/h;->h(Landroidx/fragment/app/FragmentManager;I)Lcom/android/camera/fragment/BaseFragment;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, v4, v0, v2}, Lt4/h;->e(IILcom/android/camera/fragment/v4;)Lcom/android/camera/fragment/BaseFragment;

    move-result-object v0

    new-instance v10, Lt4/h$a;

    new-instance v11, Lt4/k;
    ...
    invoke-direct/range {v1 .. v8}, Lt4/k;-><init>(Lt4/l;Landroidx/fragment/app/FragmentTransaction;IIILjava/util/List;Ljava/util/List;)V

    invoke-direct {v10, p0, v0, p3, v11}, Lt4/h$a;-><init>(Lt4/h;Lcom/android/camera/fragment/BaseFragment;Lt4/h$b;Ljava/util/function/Consumer;)V

    invoke-static {v9}, Lcom/android/camera/fragment/c5;->l(I)I
