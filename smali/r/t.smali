...
.method public static a(Ls/c;)Lh/d;
    .locals 24
    ...
    :pswitch_0
    invoke-static {v0, v14, v13}, Lr/t;->f(Ls/c;Lh/d;Ljava/util/List;)V

    goto :goto_1

    :pswitch_1
    invoke-static {v0, v14, v11}, Lr/t;->c(Ls/c;Lh/d;Landroidx/collection/SparseArrayCompat;)V
    ...
    :pswitch_3
    invoke-static {v0, v14, v9, v10}, Lr/t;->b(Ls/c;Lh/d;Ljava/util/Map;Ljava/util/Map;)V

    goto :goto_1

    :pswitch_4
    invoke-static {v0, v14, v7, v8}, Lr/t;->e(Ls/c;Lh/d;Ljava/util/List;Landroidx/collection/LongSparseArray;)V

    goto :goto_1

    :pswitch_5
    invoke-virtual/range {p0 .. p0}, Ls/c;->l()Ljava/lang/String;
    ...
    invoke-virtual {v14, v0}, Lh/d;->a(Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Ls/c;->h()D
    ...
    invoke-virtual/range {p0 .. p0}, Ls/c;->j()I
    ...
    invoke-virtual/range {v2 .. v13}, Lh/d;->r(Landroid/graphics/Rect;FFFLjava/util/List;Landroidx/collection/LongSparseArray;Ljava/util/Map;Ljava/util/Map;Landroidx/collection/SparseArrayCompat;Ljava/util/Map;Ljava/util/List;)V
...
.method public static b(Ls/c;Lh/d;Ljava/util/Map;Ljava/util/Map;)V
    .locals 10
    ...
    invoke-static {p0, p1}, Lr/s;->b(Ls/c;Lh/d;)Lp/d;
    ...
    invoke-direct/range {v4 .. v9}, Lh/g;-><init>(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0}, Lh/g;->d()Ljava/lang/String;
...
.method public static c(Ls/c;Lh/d;Landroidx/collection/SparseArrayCompat;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1}, Lr/j;->a(Ls/c;Lh/d;)Lm/d;
...
.method public static d(Ls/c;Ljava/util/Map;)V
    ...
    invoke-virtual {v0}, Lm/c;->b()Ljava/lang/String;
...
.method public static e(Ls/c;Lh/d;Ljava/util/List;Landroidx/collection/LongSparseArray;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1}, Lt/d;->c(Ljava/lang/String;)V
...
.method public static f(Ls/c;Lh/d;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
