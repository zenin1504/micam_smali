...
.method public constructor <init>(Lh/f;Lp/d;)V
    ...
    iput-object p1, p0, Lp/c;->w:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lp/c;->x:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lp/c;->y:Landroid/graphics/Rect;
...
.method public final I()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v0}, Lh/f;->t(Ljava/lang/String;)Landroid/graphics/Bitmap;
...
.method public s(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    iget-object v2, p0, Lp/c;->w:Landroid/graphics/Paint;

    invoke-virtual {v2, p3}, Landroid/graphics/Paint;->setAlpha(I)V

    iget-object p3, p0, Lp/c;->z:Lk/a;
    ...
    iget-object p2, p0, Lp/c;->x:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Lp/c;->y:Landroid/graphics/Rect;
    ...
    iget-object p3, p0, Lp/c;->y:Landroid/graphics/Rect;

    iget-object p0, p0, Lp/c;->w:Landroid/graphics/Paint;
