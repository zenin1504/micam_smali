...
.method public constructor <init>(Lh/f;Lp/d;)V
    ...
    iput-object v0, p0, Lp/h;->w:Ljava/lang/StringBuilder;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lp/h;->x:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lp/h;->y:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lp/h;->z:Landroid/graphics/Paint;

    new-instance v0, Lp/h$b;

    invoke-direct {v0, p0, v1}, Lp/h$b;-><init>(Lp/h;I)V

    iput-object v0, p0, Lp/h;->A:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lp/h;->C:Landroidx/collection/LongSparseArray;

    iput-object p1, p0, Lp/h;->E:Lh/f;

    invoke-virtual {p2}, Lp/d;->a()Lh/d;

    move-result-object p1

    iput-object p1, p0, Lp/h;->F:Lh/d;
    ...
    iput-object p2, p0, Lp/h;->G:Lk/a;

    invoke-virtual {p2, p0}, Lk/a;->a(Lk/a$b;)V

    iget-object p2, p0, Lp/h;->G:Lk/a;
    ...
    iput-object p2, p0, Lp/h;->H:Lk/a;

    invoke-virtual {p2, p0}, Lk/a;->a(Lk/a$b;)V

    iget-object p2, p0, Lp/h;->H:Lk/a;
    ...
    iput-object p2, p0, Lp/h;->I:Lk/a;

    invoke-virtual {p2, p0}, Lk/a;->a(Lk/a$b;)V

    iget-object p2, p0, Lp/h;->I:Lk/a;
    ...
    iput-object p1, p0, Lp/h;->J:Lk/a;

    invoke-virtual {p1, p0}, Lk/a;->a(Lk/a$b;)V

    iget-object p1, p0, Lp/h;->J:Lk/a;
...
.method public final J(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_1
    :goto_1
    iget-object v2, p0, Lp/h;->C:Landroidx/collection/LongSparseArray;
    ...
    iget-object p0, p0, Lp/h;->C:Landroidx/collection/LongSparseArray;
    ...
    :cond_2
    iget-object v0, p0, Lp/h;->w:Ljava/lang/StringBuilder;
    ...
    iget-object v2, p0, Lp/h;->w:Ljava/lang/StringBuilder;
    ...
    :cond_3
    iget-object p1, p0, Lp/h;->w:Ljava/lang/StringBuilder;
...
.method public final L(Lm/d;Landroid/graphics/Matrix;FLm/b;Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Lp/h;->x:Landroid/graphics/RectF;

    invoke-virtual {v2, v3, v0}, Landroid/graphics/Path;->computeBounds(Landroid/graphics/RectF;Z)V

    iget-object v3, p0, Lp/h;->y:Landroid/graphics/Matrix;
...
.method public final P(Ljava/lang/String;Lm/b;Landroid/graphics/Matrix;Lm/c;Landroid/graphics/Canvas;FF)V
    ...
    invoke-virtual {p4}, Lm/c;->a()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p4}, Lm/c;->c()Ljava/lang/String;

    move-result-object v3

    invoke-static {v1, v2, v3}, Lm/d;->c(CLjava/lang/String;Ljava/lang/String;)I

    move-result v1

    iget-object v2, p0, Lp/h;->F:Lh/d;

    invoke-virtual {v2}, Lh/d;->c()Landroidx/collection/SparseArrayCompat;
...
.method public final R(Lm/b;Lm/c;Landroid/graphics/Matrix;Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lp/h;->E:Lh/f;

    invoke-virtual {p2}, Lm/c;->a()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p2}, Lm/c;->c()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {v1, v2, p2}, Lh/f;->G(Ljava/lang/String;Ljava/lang/String;)Landroid/graphics/Typeface;
    ...
    iget-object v2, p0, Lp/h;->E:Lh/f;

    invoke-virtual {v2}, Lh/f;->F()Lh/r;

    iget-object v2, p0, Lp/h;->z:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Lp/h;->A:Landroid/graphics/Paint;
...
.method public final S(Lm/d;)Ljava/util/List;
    ...
    iget-object v0, p0, Lp/h;->B:Ljava/util/Map;
    ...
    iget-object v6, p0, Lp/h;->E:Lh/f;

    invoke-direct {v5, v6, p0, v4}, Lj/d;-><init>(Lh/f;Lp/a;Lo/n;)V
...
.method public final T(Ljava/lang/String;Lm/c;FF)F
    ...
    invoke-static {v2, v3, v4}, Lm/d;->c(CLjava/lang/String;Ljava/lang/String;)I

    move-result v2

    iget-object v3, p0, Lp/h;->F:Lh/d;

    invoke-virtual {v3}, Lh/d;->c()Landroidx/collection/SparseArrayCompat;
...
.method public a(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
    ...
    iget-object p2, p0, Lp/h;->F:Lh/d;

    invoke-virtual {p2}, Lh/d;->b()Landroid/graphics/Rect;
...
.method public g(Ljava/lang/Object;Lu/c;)V
    ...
    sget-object v0, Lh/k;->a:Ljava/lang/Integer;

    const/4 v1, 0x0

    if-ne p1, v0, :cond_3

    iget-object p1, p0, Lp/h;->G:Lk/a;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Lk/a;->m(Lu/c;)V
    ...
    :cond_7
    sget-object v0, Lh/k;->o:Ljava/lang/Float;

    if-ne p1, v0, :cond_b

    iget-object p1, p0, Lp/h;->I:Lk/a;
    ...
    :cond_b
    sget-object v0, Lh/k;->p:Ljava/lang/Float;
    ...
    :cond_f
    sget-object v0, Lh/k;->B:Ljava/lang/Float;
...
.method public s(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    iget-object p3, p0, Lp/h;->E:Lh/f;

    invoke-virtual {p3}, Lh/f;->x0()Z
    ...
    iget-object v0, p0, Lp/h;->F:Lh/d;

    invoke-virtual {v0}, Lh/d;->g()Ljava/util/Map;
    ...
    :cond_2
    iget-object v1, p0, Lp/h;->z:Landroid/graphics/Paint;
    ...
    :goto_0
    iget-object v1, p0, Lp/h;->H:Lk/a;

    if-eqz v1, :cond_3

    iget-object v2, p0, Lp/h;->A:Landroid/graphics/Paint;
    ...
    :cond_3
    iget-object v1, p0, Lp/h;->A:Landroid/graphics/Paint;
