...
.method public static synthetic b(Lp/a;Z)V
    .locals 0
...
.method public static t(Lp/d;Lh/f;Lh/d;)Lp/a;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-direct {p2, p1, p0}, Lp/h;-><init>(Lh/f;Lp/d;)V
    ...
    invoke-direct {p2, p1, p0}, Lp/e;-><init>(Lh/f;Lp/d;)V
    ...
    invoke-direct {p2, p1, p0}, Lp/c;-><init>(Lh/f;Lp/d;)V
    ...
    invoke-direct {p2, p1, p0}, Lp/g;-><init>(Lh/f;Lp/d;)V
    ...
    invoke-virtual {p2, v1}, Lh/d;->n(Ljava/lang/String;)Ljava/util/List;

    move-result-object v1

    invoke-direct {v0, p1, p0, v1, p2}, Lp/b;-><init>(Lh/f;Lp/d;Ljava/util/List;Lh/d;)V
    ...
    invoke-direct {p2, p1, p0}, Lp/f;-><init>(Lh/f;Lp/d;)V
...
.method public final A(F)V
    ...
    iget-object v0, p0, Lp/a;->n:Lh/f;

    invoke-virtual {v0}, Lh/f;->p()Lh/d;

    move-result-object v0

    invoke-virtual {v0}, Lh/d;->m()Lh/n;
    ...
    invoke-virtual {v0, p0, p1}, Lh/n;->a(Ljava/lang/String;F)V
...
.method public d(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    invoke-static {p1}, Lh/c;->b(Ljava/lang/String;)F
    ...
    invoke-virtual {p0, v2, v3, v4}, Lp/a;->a(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
    ...
    invoke-static {p1, v3, v4, v5}, Lt/h;->n(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lp/a;->d(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V

    invoke-static {v2}, Lh/c;->a(Ljava/lang/String;)V

    invoke-virtual {p1}, Landroid/graphics/Canvas;->restore()V

    invoke-static {v2}, Lh/c;->b(Ljava/lang/String;)F
    ...
    invoke-static {p0}, Lh/c;->b(Ljava/lang/String;)F
...
.method public g(Ljava/lang/Object;Lu/c;)V
    ...
    invoke-virtual {p0, p1, p2}, Lk/o;->c(Ljava/lang/Object;Lu/c;)Z
...
.method public final j(Landroid/graphics/Canvas;Landroid/graphics/Matrix;Lo/g;Lk/a;Lk/a;)V
    ...
    invoke-static {p1, p3, v0}, Lt/h;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final n(Landroid/graphics/Canvas;Landroid/graphics/Matrix;)V
    ...
    invoke-static {p1, v1, v2, v3}, Lt/h;->n(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
    ...
    invoke-static {p0}, Lh/c;->a(Ljava/lang/String;)V
...
.method public final y(Landroid/graphics/RectF;Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {v0, v2, p2, v3}, Lp/a;->a(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
