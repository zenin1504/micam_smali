...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lt/h;->a:Landroid/graphics/PathMeasure;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, Lt/h;->b:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, Lt/h;->c:Landroid/graphics/Path;

    const/4 v0, 0x4

    new-array v0, v0, [F

    sput-object v0, Lt/h;->d:[F
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    sget-object v1, Lt/h;->a:Landroid/graphics/PathMeasure;
    ...
    invoke-static {v3, v2}, Lt/g;->f(FF)I

    move-result p2

    int-to-float v3, p2

    invoke-static {p1, v2}, Lt/g;->f(FF)I
    ...
    :cond_6
    sget-object p2, Lt/h;->b:Landroid/graphics/Path;
    ...
    sget-object v3, Lt/h;->c:Landroid/graphics/Path;
    ...
    sget-object p1, Lt/h;->c:Landroid/graphics/Path;
...
.method public static b(Landroid/graphics/Path;Lj/s;)V
    .locals 3
    .param p1    # Lj/s;
    ...
    invoke-virtual {p1}, Lj/s;->g()Lk/a;

    move-result-object p1

    check-cast p1, Lk/c;

    invoke-virtual {p1}, Lk/c;->o()F
    ...
    invoke-static {p0, v0, v1, p1}, Lt/h;->a(Landroid/graphics/Path;FFF)V
...
.method public static m(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lt/h;->n(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
