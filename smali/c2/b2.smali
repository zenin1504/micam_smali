...
.method public constructor <init>(Landroid/graphics/Rect;)V
    ...
    iput-object v0, p0, Lc2/b2;->a:Lc2/a2;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lc2/b2;->b:Z

    const/4 v1, 0x0

    iput v1, p0, Lc2/b2;->c:F

    iput v1, p0, Lc2/b2;->d:F

    new-instance v1, Lmiuix/animation/utils/VelocityMonitor;

    invoke-direct {v1}, Lmiuix/animation/utils/VelocityMonitor;-><init>()V

    iput-object v1, p0, Lc2/b2;->f:Lmiuix/animation/utils/VelocityMonitor;
    ...
    invoke-virtual {p0, p1}, Lc2/b2;->g(Landroid/graphics/Rect;)V

    return-void
.end method

.method public static synthetic a(Lc2/b2;)Lc2/a2;
    .locals 0

    iget-object p0, p0, Lc2/b2;->a:Lc2/a2;

    return-object p0
.end method

.method public static synthetic b(Lc2/b2;)Lc2/b2$d;
    .locals 0

    iget-object p0, p0, Lc2/b2;->e:Lc2/b2$d;
...
.method public c()Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, Lc2/a2;->b()Landroid/graphics/Rect;
...
.method public final d(Lc2/r1;)Landroid/graphics/Rect;
    .locals 8
    ...
    sget-object v2, Lc2/r1;->j:Lc2/r1;

    invoke-virtual {v2}, Lc2/r1;->a()I
...
.method public e(Lc2/r1;)Landroid/graphics/Rect;
    .locals 6

    iget-object v0, p0, Lc2/b2;->a:Lc2/a2;

    invoke-virtual {v0}, Lc2/a2;->b()Landroid/graphics/Rect;

    move-result-object v0

    sget-object v1, Lc2/b2$c;->a:[I
    ...
    invoke-virtual {p0, p1}, Lc2/b2;->d(Lc2/r1;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, Lc2/a2;->c()Landroid/graphics/Point;
...
.method public f()V
    ...
    iget-object v0, p0, Lc2/b2;->f:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iget-object v2, p0, Lc2/b2;->f:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iget-object v4, p0, Lc2/b2;->a:Lc2/a2;

    invoke-virtual {v4}, Lc2/a2;->d()Landroid/graphics/Rect;

    move-result-object v4

    iget-object v5, p0, Lc2/b2;->a:Lc2/a2;

    invoke-virtual {v5}, Lc2/a2;->c()Landroid/graphics/Point;
    ...
    new-instance v13, Lc2/b2$a;

    invoke-direct {v13, p0}, Lc2/b2$a;-><init>(Lc2/b2;)V
    ...
    new-instance v5, Lc2/b2$b;

    invoke-direct {v5, p0}, Lc2/b2$b;-><init>(Lc2/b2;)V
...
.method public g(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Lc2/a2;->e(Landroid/graphics/Rect;)V

    iget-object p0, p0, Lc2/b2;->a:Lc2/a2;

    invoke-virtual {p0, p1}, Lc2/a2;->h(Landroid/graphics/Rect;)V

    return-void
.end method

.method public h(Lc2/b2$d;)V
    .locals 5
    ...
    invoke-virtual {v0}, Lc2/a2;->c()Landroid/graphics/Point;

    move-result-object v0

    iget-object v1, p0, Lc2/b2;->f:Lmiuix/animation/utils/VelocityMonitor;
    ...
    iput-object p1, p0, Lc2/b2;->e:Lc2/b2$d;
...
.method public i(FF)V
    ...
    iput p1, p0, Lc2/b2;->c:F

    iput p2, p0, Lc2/b2;->d:F
...
.method public j(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lc2/a2;->i(II)V

    iget-object p1, p0, Lc2/b2;->e:Lc2/b2$d;

    invoke-interface {p1}, Lc2/b2$d;->a()V

    iget-object p1, p0, Lc2/b2;->a:Lc2/a2;

    invoke-virtual {p1}, Lc2/a2;->c()Landroid/graphics/Point;

    move-result-object p1

    iget-object p0, p0, Lc2/b2;->f:Lmiuix/animation/utils/VelocityMonitor;
