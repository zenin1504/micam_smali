.class public Lcom/android/camera/effect/renders/h0;
...
.method public final a([IFFFF[F)V
    ...
    invoke-virtual {v1, p2, p3, v2}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    invoke-virtual {p2, p4, p5, p3}, Lcom/android/camera/effect/s;->k(FFF)V
    ...
    iget p2, p0, Lcom/android/camera/effect/renders/h0;->a:I
    ...
    iget p5, p0, Lcom/android/camera/effect/renders/h0;->b:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/h0;->c:I

    invoke-static {p1, p2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    :cond_2
    invoke-virtual {p0, p6}, Lcom/android/camera/effect/renders/h0;->c([F)V
...
.method public final b(Lg2/b;)Z
    .locals 7

    iget-object p1, p1, Lg2/b;->e:Lak/b;

    iget-object v0, p1, Lak/b;->d:Lak/b$a;

    iget-object v1, v0, Lak/b$a;->a:Ljava/nio/ByteBuffer;

    iget-object v2, v0, Lak/b$a;->b:Ljava/nio/ByteBuffer;

    iget-object v3, v0, Lak/b$a;->c:Ljava/nio/ByteBuffer;

    iget v4, p1, Lak/b;->b:I

    iget v5, p1, Lak/b;->c:I

    iget-object v6, p0, Lcom/android/camera/effect/renders/h0;->d:[I

    invoke-static/range {v1 .. v6}, Lof/i;->c(Ljava/nio/Buffer;Ljava/nio/Buffer;Ljava/nio/Buffer;II[I)Z
...
.method public c([F)V
    ...
    invoke-static {p1}, Lcom/android/camera2/g;->V1(Lcom/android/camera2/f;)I
    ...
    :cond_2
    iget p0, p0, Lcom/android/camera/effect/renders/h0;->e:I
...
.method public draw(Lg2/c;)Z
    ...
    iget-object v0, p1, Lg2/b;->e:Lak/b;

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/h0;->b(Lg2/b;)Z
    ...
    invoke-virtual {p1}, Lg2/b;->b()Landroid/util/Size;
    ...
    iget-object v7, p1, Lg2/b;->b:[F

    move-object v1, p0

    invoke-virtual/range {v1 .. v7}, Lcom/android/camera/effect/renders/h0;->a([IFFFF[F)V
...
.method public initShader()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/h0;->getFragShaderString()Ljava/lang/String;
...
.method public initVertexData()V
    ...
    sget-object v0, Lcom/android/camera/effect/renders/h0;->f:[F
    ...
    sget-object v0, Lcom/android/camera/effect/renders/h0;->g:[F
