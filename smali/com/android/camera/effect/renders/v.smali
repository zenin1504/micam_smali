.class public Lcom/android/camera/effect/renders/v;
...
.method public draw(Lg2/c;)Z
    ...
    invoke-virtual {p0, v0, v4}, Lcom/android/camera/effect/renders/u;->bindTexture(Lcom/android/gallery3d/ui/b;I)Z
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/v;->a()V
    ...
    invoke-virtual {v4}, Lcom/android/camera/effect/s;->a()F

    move-result v4

    iget-object v6, p0, Lcom/android/camera/effect/renders/r;->mGLCanvas:Lcom/android/gallery3d/ui/g;

    invoke-interface {v6}, Lcom/android/gallery3d/ui/g;->getState()Lcom/android/camera/effect/s;

    move-result-object v6

    invoke-virtual {v6}, Lcom/android/camera/effect/s;->b()F

    move-result v6

    iget-boolean v7, p0, Lcom/android/camera/effect/renders/u;->mBlendEnabled:Z
    ...
    invoke-virtual {v0, v4, v7, v8}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    invoke-virtual {v0, v4, v3, v7}, Lcom/android/camera/effect/s;->k(FFF)V
    ...
    invoke-virtual {v3}, Lcom/android/camera/effect/s;->c()[F
    ...
    invoke-interface {v2}, Lcom/android/gallery3d/ui/g;->getState()Lcom/android/camera/effect/s;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/camera/effect/s;->a()F

    move-result v2

    invoke-static {v0, v2}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget v0, p0, Lcom/android/camera/effect/renders/u;->mUniformBlendAlphaH:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/v;->a:I
...
.method public initShader()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/v;->getFragShaderString()Ljava/lang/String;
...
.method public initVertexData()V
    ...
    sget-object v0, Lcom/android/camera/effect/renders/v;->b:[F
    ...
    sget-object v0, Lcom/android/camera/effect/renders/v;->c:[F
