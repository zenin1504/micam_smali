...
.method public constructor <init>(Lcom/android/gallery3d/ui/g;ILn2/f;Landroid/content/Context;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/camera/effect/renders/a0;->c:Ln2/f;

    invoke-virtual {p0, p4}, Lcom/android/camera/effect/renders/a0;->initFilter(Landroid/content/Context;)V
...
.method public final checkRenderRect(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/a0;->updateVertexData(Landroid/graphics/Rect;)V
...
.method public destroy()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/a0;->releaseFilter()V
...
.method public draw(Lg2/c;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera/effect/renders/a0;->c:Ln2/f;
    ...
    iget v0, p1, Lg2/h;->c:I

    iget-object p1, p1, Lg2/h;->b:Landroid/graphics/Rect;

    invoke-static {}, Lsd/a;->b()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {p0, v0, p1, v1}, Lcom/android/camera/effect/renders/a0;->drawTexture(ILandroid/graphics/Rect;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0, p1, v1}, Lcom/android/camera/effect/renders/a0;->drawTexture(Lcom/android/gallery3d/ui/b;Landroid/graphics/Rect;Landroid/content/Context;)V
...
.method public drawTexture(ILandroid/graphics/Rect;Landroid/content/Context;)V
    ...
    .line 15
    invoke-virtual {p0, p2}, Lcom/android/camera/effect/renders/a0;->checkRenderRect(Landroid/graphics/Rect;)V
    ...
    .line 17
    iget-object p0, p0, Lcom/android/camera/effect/renders/a0;->c:Ln2/f;

    invoke-virtual {p0, p1, p2, v0, p3}, Ln2/f;->j(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)I
...
.method public drawTexture(Lcom/android/gallery3d/ui/b;Landroid/graphics/Rect;Landroid/content/Context;)V
    ...
    .line 9
    iget-object p2, p0, Lcom/android/camera/effect/renders/a0;->c:Ln2/f;
    ...
    invoke-virtual {p2, p1, v0, p0, p3}, Ln2/f;->j(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)I
...
.method public initFilter(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Ln2/f;->d(Landroid/content/Context;)V

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v0, "initFilter id: "

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v0, p0, Lcom/android/camera/effect/renders/r;->mId:I
...
.method public initVertexData()V
    ...
    sget-object v0, Lcom/android/camera/effect/renders/a0;->d:[F
...
.method public setViewportSize(II)V
    ...
    invoke-virtual {p0, p1, p2}, Ln2/f;->g(II)V

    :cond_0
    return-void
.end method

.method public final updateVertexData(Landroid/graphics/Rect;)V
    .locals 9
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    invoke-virtual {v0, v1, p1, v2}, Lcom/android/camera/effect/s;->k(FFF)V

    iget-object v3, p0, Lcom/android/camera/effect/renders/a0;->b:[F
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/s;->c()[F

    move-result-object v5

    const/4 v6, 0x0

    sget-object v7, Lcom/android/camera/effect/renders/a0;->d:[F
    ...
    iget-object v4, p0, Lcom/android/camera/effect/renders/a0;->b:[F
    ...
    iget-object v5, p0, Lcom/android/camera/effect/renders/a0;->b:[F
