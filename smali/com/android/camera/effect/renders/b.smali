...
.method public final b(FFFFLcom/android/gallery3d/ui/i;)V
    .locals 2
    ...
    invoke-virtual {p0, p5, v0}, Lcom/android/camera/effect/renders/b;->n(Lcom/android/gallery3d/ui/i;Z)V

    iget-object p5, p0, Lcom/android/camera/effect/renders/r;->mGLCanvas:Lcom/android/gallery3d/ui/g;

    invoke-interface {p5}, Lcom/android/gallery3d/ui/g;->getState()Lcom/android/camera/effect/s;

    move-result-object p5

    invoke-virtual {p5}, Lcom/android/camera/effect/s;->i()V
    ...
    invoke-virtual {p5, p1, p2, v1}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    invoke-virtual {p5, p3, p4, p1}, Lcom/android/camera/effect/s;->k(FFF)V

    iget p2, p0, Lcom/android/camera/effect/renders/u;->mUniformMVPMatrixH:I
    ...
    invoke-virtual {p3}, Lcom/android/camera/effect/s;->c()[F
    ...
    iget p2, p0, Lcom/android/camera/effect/renders/u;->mUniformSTMatrixH:I
    ...
    invoke-virtual {p3}, Lcom/android/camera/effect/s;->e()[F

    move-result-object p3

    invoke-static {p2, v0, p4, p3, p4}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    iget p2, p0, Lcom/android/camera/effect/renders/u;->mUniformAlphaH:I
    ...
    invoke-virtual {p3}, Lcom/android/camera/effect/s;->a()F

    move-result p3

    invoke-static {p2, p3}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p2, p0, Lcom/android/camera/effect/renders/u;->mUniformBlendAlphaH:I
    ...
    invoke-virtual {p3}, Lcom/android/camera/effect/s;->b()F
...
.method public final c(Lcom/android/gallery3d/ui/b;FFIIII)V
    ...
    :cond_0
    iget-boolean p1, p0, Lcom/android/camera/effect/renders/u;->mBlendEnabled:Z
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/s;->a()F
    ...
    iget v2, p0, Lcom/android/camera/effect/renders/u;->mAttributePositionH:I
    ...
    iget p4, p0, Lcom/android/camera/effect/renders/u;->mAttributePositionH:I
    ...
    iget v2, p0, Lcom/android/camera/effect/renders/u;->mAttributeTexCoorH:I

    invoke-static/range {v2 .. v7}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZII)V

    iget p4, p0, Lcom/android/camera/effect/renders/u;->mAttributeTexCoorH:I

    invoke-static {p4}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    iget-object p4, p0, Lcom/android/camera/effect/renders/r;->mGLCanvas:Lcom/android/gallery3d/ui/g;

    invoke-interface {p4}, Lcom/android/gallery3d/ui/g;->getState()Lcom/android/camera/effect/s;
    ...
    invoke-virtual {p4, p2, p3, p5}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    iget p2, p0, Lcom/android/camera/effect/renders/u;->mUniformTextureH:I
...
.method public final d(Lcom/android/gallery3d/ui/b;IFFFFF)V
    ...
    iget-boolean p2, p0, Lcom/android/camera/effect/renders/u;->mBlendEnabled:Z
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/s;->i()V
    ...
    invoke-virtual {p1, p4, p5, p2}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    invoke-virtual {p1, p6, p7, p4}, Lcom/android/camera/effect/s;->k(FFF)V
    ...
    invoke-virtual {p5}, Lcom/android/camera/effect/s;->c()[F
    ...
    invoke-virtual {p5}, Lcom/android/camera/effect/s;->e()[F
    ...
    invoke-virtual {p5}, Lcom/android/camera/effect/s;->a()F
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/u;->mUniformBlendAlphaH:I
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/s;->b()F
...
.method public draw(Lg2/c;)Z
    ...
    iget-object p1, p1, Lg2/p;->d:Ljava/nio/FloatBuffer;
    ...
    iget-object v0, p1, Lg2/n;->d:Lcom/android/gallery3d/ui/b;

    iget-object v2, p1, Lg2/n;->b:Landroid/graphics/RectF;

    iget-object p1, p1, Lg2/n;->c:Landroid/graphics/RectF;
    ...
    iget-object v3, p1, Lg2/l;->g:Lcom/android/gallery3d/ui/b;

    iget v4, p1, Lg2/l;->h:I

    iget v5, p1, Lg2/l;->d:F

    iget v6, p1, Lg2/l;->b:F

    iget v7, p1, Lg2/l;->c:F

    iget v8, p1, Lg2/l;->e:F

    iget v9, p1, Lg2/l;->f:F
    ...
    iget-object v3, p1, Lg2/j;->d:Lcom/android/gallery3d/ui/b;

    iget v4, p1, Lg2/j;->b:F

    iget v5, p1, Lg2/j;->c:F

    iget v6, p1, Lg2/j;->e:I

    iget v7, p1, Lg2/j;->f:I

    iget v8, p1, Lg2/j;->g:I

    iget v9, p1, Lg2/j;->h:I
    ...
    iget v3, p1, Lg2/m;->b:F

    iget v4, p1, Lg2/m;->c:F

    iget v5, p1, Lg2/m;->d:F

    iget v6, p1, Lg2/m;->e:F

    iget-object v7, p1, Lg2/m;->f:Lcom/android/gallery3d/ui/i;

    move-object v2, p0

    invoke-virtual/range {v2 .. v7}, Lcom/android/camera/effect/renders/b;->f(FFFFLcom/android/gallery3d/ui/i;)V
    ...
    iget v3, p1, Lg2/i;->b:F

    iget v4, p1, Lg2/i;->c:F

    iget v5, p1, Lg2/i;->d:F

    iget v6, p1, Lg2/i;->e:F

    iget-object v7, p1, Lg2/i;->f:Lcom/android/gallery3d/ui/i;

    move-object v2, p0

    invoke-virtual/range {v2 .. v7}, Lcom/android/camera/effect/renders/b;->b(FFFFLcom/android/gallery3d/ui/i;)V

    :goto_0
    return v1
.end method

.method public final f(FFFFLcom/android/gallery3d/ui/i;)V
    .locals 3
    ...
    invoke-virtual {v1, p1, p2, v2}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    invoke-virtual {p1, p3, p4, p2}, Lcom/android/camera/effect/s;->k(FFF)V
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/u;->mUniformPointSize:I

    invoke-virtual {p5}, Lcom/android/gallery3d/ui/i;->b()F
...
.method public getFragShaderString()Ljava/lang/String;
    ...
    invoke-static {}, Lsd/a;->b()Landroid/content/Context;
...
.method public final h(Lcom/android/gallery3d/ui/b;Landroid/graphics/RectF;Landroid/graphics/RectF;)V
    ...
    invoke-virtual {v0, v1, v2, v3, p2}, Lcom/android/camera/effect/s;->n(FFFF)V
...
.method public final i(Lcom/android/gallery3d/ui/b;Landroid/graphics/RectF;[F)V
    ...
    invoke-virtual {v4}, Lcom/android/camera/effect/s;->b()F

    move-result v4

    instance-of v5, p1, Lcom/android/gallery3d/ui/p;

    if-eqz v5, :cond_2

    move-object v5, p1

    check-cast v5, Lcom/android/gallery3d/ui/p;

    invoke-virtual {v5}, Lcom/android/gallery3d/ui/p;->isPremultiplied()Z
    ...
    :goto_0
    iget-boolean v6, p0, Lcom/android/camera/effect/renders/u;->mBlendEnabled:Z
    ...
    :goto_1
    invoke-virtual {p0, p1, v5}, Lcom/android/camera/effect/renders/u;->setBlendEnabled(ZZ)V
    ...
    invoke-virtual {p1, v5, v6, v1}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    invoke-virtual {p1, v1, p2, v2}, Lcom/android/camera/effect/s;->k(FFF)V
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/s;->c()[F
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/s;->e()[F
...
.method public initVertexData()V
    ...
    sget-object v0, Lcom/android/camera/effect/renders/b;->c:[F
    ...
    sget-object v0, Lcom/android/camera/effect/renders/b;->d:[F
...
.method public final j(Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/s;->i()V
    ...
    invoke-virtual {p2, v1, v2, v3}, Lcom/android/camera/effect/s;->q(FFF)V
    ...
    invoke-virtual {p2, v1, p1, v2}, Lcom/android/camera/effect/s;->k(FFF)V
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/s;->a()F
...
.method public final m(IZ)V
    ...
    invoke-interface {v3}, Lcom/android/gallery3d/ui/g;->getState()Lcom/android/camera/effect/s;

    move-result-object v3

    invoke-virtual {v3}, Lcom/android/camera/effect/s;->a()F
...
.method public final n(Lcom/android/gallery3d/ui/i;Z)V
    .locals 1

    invoke-virtual {p1}, Lcom/android/gallery3d/ui/i;->a()I

    move-result v0

    invoke-virtual {p0, v0, p2}, Lcom/android/camera/effect/renders/b;->m(IZ)V

    invoke-virtual {p1}, Lcom/android/gallery3d/ui/i;->b()F
...
.method public final o(Ljava/nio/FloatBuffer;)V
    ...
    iget p0, p0, Lcom/android/camera/effect/renders/u;->mAttributePositionH:I
