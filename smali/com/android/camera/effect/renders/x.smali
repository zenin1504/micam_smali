...
.method public static b(Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/android/camera/effect/renders/x;->a(Ljava/lang/String;)I
...
.method public final c(IIIII[F[FZ)V
    ...
    invoke-static {p2}, Lcom/android/camera/effect/renders/x;->b(Ljava/lang/String;)V
    ...
    invoke-static {p3}, Lcom/android/camera/effect/renders/x;->b(Ljava/lang/String;)V
    ...
    iput p1, p0, Lcom/android/camera/effect/renders/x;->a:I
    ...
    iget p4, p0, Lcom/android/camera/effect/renders/x;->a:I
    ...
    invoke-static {p1}, Lcom/android/camera/effect/renders/x;->b(Ljava/lang/String;)V
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/x;->b:I
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/x;->c:I
    ...
    iget-object p4, p0, Lcom/android/camera/effect/renders/x;->e:Lvg/a;

    invoke-virtual {p4}, Lvg/a;->d()Ljava/nio/FloatBuffer;
    ...
    invoke-static {p4}, Lcom/android/camera/effect/renders/x;->b(Ljava/lang/String;)V

    iget p5, p0, Lcom/android/camera/effect/renders/x;->d:I

    invoke-static {p5}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    invoke-static {p1}, Lcom/android/camera/effect/renders/x;->b(Ljava/lang/String;)V

    iget v0, p0, Lcom/android/camera/effect/renders/x;->d:I

    iget-object p1, p0, Lcom/android/camera/effect/renders/x;->e:Lvg/a;

    invoke-virtual {p1}, Lvg/a;->a()Ljava/nio/FloatBuffer;
...
.method public draw(Lg2/c;)Z
    ...
    iget v1, p1, Lg2/q;->c:I

    iget-object v0, p1, Lg2/q;->b:Landroid/graphics/Rect;
    ...
    iget-object v6, p1, Lg2/q;->e:[F

    iget-object v7, p1, Lg2/q;->d:[F

    iget-boolean v8, p1, Lg2/q;->f:Z

    move-object v0, p0

    invoke-virtual/range {v0 .. v8}, Lcom/android/camera/effect/renders/x;->c(IIIII[F[FZ)V
...
.method public initShader()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/x;->getVertexShaderString()Ljava/lang/String;
...
.method public initVertexData()V
    ...
    iput-object v0, p0, Lcom/android/camera/effect/renders/x;->e:Lvg/a;
