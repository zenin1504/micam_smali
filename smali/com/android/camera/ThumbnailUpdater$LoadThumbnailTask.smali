...
.field public final l:Ljava/lang/ref/Reference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/lang/ref/Reference<",
...
# direct methods
.method public constructor <init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/r5;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 1
    invoke-direct/range {v0 .. v5}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/r5;)V

    return-void
.end method

.method public constructor <init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/r5;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->l:Ljava/lang/ref/Reference;
    ...
    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->m:Ljava/lang/ref/Reference;
...
.method public bridge synthetic k([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->w([Ljava/lang/Void;)Lcom/android/camera/r5;
...
.method public bridge synthetic u(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->x(Lcom/android/camera/r5;)V

    return-void
.end method

.method public varargs w([Ljava/lang/Void;)Lcom/android/camera/r5;
    .locals 17
    ...
    iget-boolean v2, v1, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->h:Z
    ...
    iget-object v0, v1, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->k:Ljava/lang/ref/Reference;
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->o()Z
    ...
    invoke-static {v6}, Lcom/android/camera/r5;->s(Landroid/content/ContentResolver;)Lcom/android/camera/r5$b;
    ...
    :cond_2
    iget-object v0, v7, Lcom/android/camera/r5$b;->d:Landroid/net/Uri;
    ...
    check-cast v0, Lcom/android/camera/r5;
    ...
    invoke-static {v11, v6}, Lcom/android/camera/j6;->s3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    :cond_3
    iget-wide v13, v7, Lcom/android/camera/r5$b;->j:J

    :goto_1
    invoke-virtual {v0, v13, v14}, Lcom/android/camera/r5;->M(J)V
    ...
    invoke-static {v3, v11}, Lr7/i;->f(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-virtual {v12, v11}, Le1/c;->r(Ljava/lang/Long;)Lc1/b;
    ...
    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->wa()Z
    ...
    invoke-static {v3, v6}, Lcom/android/camera/r5;->v(Landroid/content/Context;Landroid/content/ContentResolver;)Lcom/android/camera/r5;
    ...
    :cond_d
    new-array v8, v10, [Lcom/android/camera/r5;

    const/4 v11, 0x2

    iput v11, v1, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->n:I

    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->L9()Z
    ...
    invoke-static {v3, v8, v6, v7}, Lcom/android/camera/r5;->u(Landroid/content/Context;[Lcom/android/camera/r5;Landroid/net/Uri;Lcom/android/camera/r5$b;)I
    ...
    iput v9, v1, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->n:I
    ...
    invoke-virtual {v3}, Lcom/android/camera/ActivityBase;->Bd()Ljava/util/ArrayList;

    move-result-object v9

    invoke-static {v3, v8, v9, v6}, Lcom/android/camera/r5;->w(Landroid/content/Context;[Lcom/android/camera/r5;Ljava/util/ArrayList;Landroid/net/Uri;)I
    ...
    iput v4, v1, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->n:I
    ...
    :cond_13
    iget-wide v12, v7, Lcom/android/camera/r5$b;->c:J

    :goto_8
    invoke-virtual {v0, v12, v13}, Lcom/android/camera/r5;->T(J)V
    ...
    :cond_14
    iget-boolean v2, v7, Lcom/android/camera/r5$b;->i:Z

    :goto_9
    invoke-virtual {v0, v2}, Lcom/android/camera/r5;->R(Z)V
    ...
    :cond_18
    iget-boolean v1, v7, Lcom/android/camera/r5$b;->i:Z

    :goto_b
    invoke-virtual {v0, v1}, Lcom/android/camera/r5;->R(Z)V
...
.method public x(Lcom/android/camera/r5;)V
    .locals 6
    ...
    invoke-virtual {p0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->n()Z
    ...
    iget-object v0, p0, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;->l:Ljava/lang/ref/Reference;
    ...
    invoke-static {v0, p1, v2, v1, p0}, Lcom/android/camera/ThumbnailUpdater;->e(Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/r5;ZZZ)V
