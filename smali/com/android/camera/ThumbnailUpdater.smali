...
# interfaces
.implements Lcom/android/camera/x5;
...
.method public static synthetic e(Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/r5;ZZZ)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->v(Lcom/android/camera/r5;ZZZ)V

    return-void
.end method

.method public static synthetic f(Z)Landroid/net/Uri;
    .locals 0
...
.method public static synthetic g(Landroid/net/Uri;Z)J
    .locals 0
...
.method public static j(Z)Landroid/net/Uri;
    ...
    invoke-static {v3}, Lu9/a;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method private synthetic r(ZIZ)V
    ...
    const-string p1, "won\'t update thumbnail, protocol not registered"
    ...
    :cond_0
    invoke-interface {v0}, La7/d;->canProvide()Z
    ...
    const-string p1, "won\'t update thumbnail host departed"
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/r5;

    invoke-interface {v0, p0, p1, p2, p3}, La7/d;->m4(Lcom/android/camera/r5;ZIZ)V
...
.method public i()V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/s5;-><init>(Lcom/android/camera/ThumbnailUpdater;)V
...
.method public k()V
    ...
    invoke-virtual {v1}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->h()V
    ...
    iget-object v4, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/r5;

    const/4 v5, 0x1

    invoke-direct {v1, v5, v3, p0, v4}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/r5;)V

    invoke-virtual {v0}, Landroidx/activity/ComponentActivity;->getLifecycle()Landroidx/lifecycle/Lifecycle;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->e(Landroidx/lifecycle/Lifecycle;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->l(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
...
.method public l(Z)V
    ...
    iget-object v8, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/r5;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Lcom/android/camera/r5;)V

    invoke-virtual {v0}, Landroidx/activity/ComponentActivity;->getLifecycle()Landroidx/lifecycle/Lifecycle;

    move-result-object p1

    invoke-virtual {v1, p1}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->e(Landroidx/lifecycle/Lifecycle;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->l(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
...
.method public n()Lcom/android/camera/r5;
    .locals 0
...
.method public t()V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/r5;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lcom/android/camera/r5;->l()Z
    ...
    invoke-virtual {v2, v0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->e(Landroidx/lifecycle/Lifecycle;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
    ...
    new-array v3, v3, [Lcom/android/camera/r5;

    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/r5;

    aput-object p0, v3, v1

    invoke-virtual {v0, v2, v3}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->l(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;

    :cond_1
    return-void
.end method

.method public u(Lcom/android/camera/r5;ZZ)V
    .locals 1

    const/4 v0, 0x1

    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/android/camera/ThumbnailUpdater;->v(Lcom/android/camera/r5;ZZZ)V

    return-void
.end method

.method public final v(Lcom/android/camera/r5;ZZZ)V
    .locals 0

    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->a:Lcom/android/camera/r5;
...
.method public x()V
    ...
    invoke-direct {v0, v1, p0}, Lcom/android/camera/ThumbnailUpdater$a;-><init>(Landroid/os/Handler;Lcom/android/camera/x5;)V
    ...
    invoke-direct {v0, v1, p0}, Lcom/android/camera/ThumbnailUpdater$b;-><init>(Landroid/os/Handler;Lcom/android/camera/x5;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/u5;-><init>(Lcom/android/camera/ThumbnailUpdater;)V
...
.method public y(ZZ)V
    ...
    invoke-direct {v2, p0, p1, v0, p2}, Lcom/android/camera/t5;-><init>(Lcom/android/camera/ThumbnailUpdater;ZIZ)V
