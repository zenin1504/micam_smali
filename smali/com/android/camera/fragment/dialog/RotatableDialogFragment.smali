...
.method public static synthetic Bh(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Fh(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
...
.method public static synthetic Ch(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;Landroid/app/Dialog;ILandroid/content/DialogInterface;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Hh(Landroid/app/Dialog;ILandroid/content/DialogInterface;)V

    return-void
.end method

.method public static synthetic Dh(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Gh(Landroid/content/DialogInterface;I)V

    return-void
.end method

.method public static synthetic Fh(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    .locals 0
...
.method private synthetic Hh(Landroid/app/Dialog;ILandroid/content/DialogInterface;)V
    .locals 2
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Kh(I)V
...
# virtual methods
.method public final Eh(Landroid/os/Bundle;Lcom/android/camera2/u3;)Lmiuix/appcompat/app/AlertDialog$a;
    .locals 6
    ...
    invoke-virtual {v4, v0}, Lmiuix/appcompat/app/AlertDialog$a;->G(I)Lmiuix/appcompat/app/AlertDialog$a;

    :cond_0
    if-eq v2, v1, :cond_1

    invoke-virtual {v4, v2}, Lmiuix/appcompat/app/AlertDialog$a;->m(I)Lmiuix/appcompat/app/AlertDialog$a;
    ...
    invoke-virtual {v4, p0}, Lmiuix/appcompat/app/AlertDialog$a;->J(Landroid/view/View;)Lmiuix/appcompat/app/AlertDialog$a;

    :cond_2
    if-eq v3, v1, :cond_3

    invoke-virtual {v4, v3, p2}, Lmiuix/appcompat/app/AlertDialog$a;->A(ILandroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$a;

    :cond_3
    if-eq p1, v1, :cond_4

    invoke-virtual {v4, p1, p2}, Lmiuix/appcompat/app/AlertDialog$a;->r(ILandroid/content/DialogInterface$OnClickListener;)Lmiuix/appcompat/app/AlertDialog$a;

    :cond_4
    const/4 p0, 0x1

    invoke-virtual {v4, p0}, Lmiuix/appcompat/app/AlertDialog$a;->c(Z)Lmiuix/appcompat/app/AlertDialog$a;

    invoke-virtual {v4, p2}, Lmiuix/appcompat/app/AlertDialog$a;->v(Landroid/content/DialogInterface$OnCancelListener;)Lmiuix/appcompat/app/AlertDialog$a;

    new-instance p0, Lcom/android/camera/fragment/dialog/o;

    invoke-direct {p0}, Lcom/android/camera/fragment/dialog/o;-><init>()V

    invoke-virtual {v4, p0}, Lmiuix/appcompat/app/AlertDialog$a;->y(Landroid/content/DialogInterface$OnKeyListener;)Lmiuix/appcompat/app/AlertDialog$a;

    return-object v4
.end method

.method public Ih(Landroidx/fragment/app/FragmentManager;)V
    .locals 0
    ...
    invoke-static {p1, p0}, Lbf/e;->d(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)Z

    return-void
.end method

.method public Jh(IIIII)V
    .locals 2
...
.method public Kh(I)V
    ...
    :cond_0
    invoke-static {v0}, Lem/m;->i(Landroid/view/View;)Landroid/graphics/Point;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-static {v1, v2}, Lcom/android/camera2/u3;->d(Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnCancelListener;)Lcom/android/camera2/u3;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lcom/android/camera/fragment/dialog/RotatableDialogFragment;->Eh(Landroid/os/Bundle;Lcom/android/camera2/u3;)Lmiuix/appcompat/app/AlertDialog$a;
    ...
    invoke-virtual {v1, v0}, Lcom/android/camera2/u3;->c(Landroid/app/Dialog;)V
