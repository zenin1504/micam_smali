...
.method public b(Lcom/android/camera/fragment/ocr/views/b$d;FFZ)Lcom/android/camera/fragment/ocr/views/b$d;
    ...
    invoke-virtual {p2}, Lcom/android/camera/fragment/ocr/views/b$c;->d()Z
    ...
    invoke-virtual {p3, p2}, Lcom/android/camera/fragment/ocr/views/b$c;->f(Lcom/android/camera/fragment/ocr/views/b$c;)V
    ...
    invoke-virtual {p2, p3}, Lcom/android/camera/fragment/ocr/views/b$c;->c(Lcom/android/camera/fragment/ocr/views/b$c;)I
    ...
    invoke-virtual {p2, p3}, Lcom/android/camera/fragment/ocr/views/b$c;->f(Lcom/android/camera/fragment/ocr/views/b$c;)V
    ...
    invoke-virtual {p3, p4}, Lcom/android/camera/fragment/ocr/views/b$c;->f(Lcom/android/camera/fragment/ocr/views/b$c;)V
    ...
    invoke-virtual {p3, p4, p2}, Lcom/android/camera/fragment/ocr/views/b$c;->e(II)V
    ...
    invoke-virtual {p1, p3}, Lcom/android/camera/fragment/ocr/views/b$c;->f(Lcom/android/camera/fragment/ocr/views/b$c;)V

    iget-object p1, p0, Lcom/android/camera/fragment/ocr/views/b;->c:Lcom/android/camera/fragment/ocr/views/b$c;

    invoke-virtual {p1, p4, p2}, Lcom/android/camera/fragment/ocr/views/b$c;->e(II)V
...
.method public m()Z
    ...
    invoke-virtual {v0}, Lcom/android/camera/fragment/ocr/views/b$c;->d()Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/fragment/ocr/views/b$c;->c(Lcom/android/camera/fragment/ocr/views/b$c;)I
...
.method public r()V
    ...
    invoke-virtual {v1, v2, v2}, Lcom/android/camera/fragment/ocr/views/b$c;->e(II)V
    ...
    invoke-virtual {v1, v0, v2}, Lcom/android/camera/fragment/ocr/views/b$c;->e(II)V
...
.method public s(I)V
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/camera/fragment/ocr/views/b$c;->e(II)V
    ...
    invoke-virtual {v1, p1, v0}, Lcom/android/camera/fragment/ocr/views/b$c;->e(II)V
...
.method public v(FF)Lcom/android/camera/fragment/ocr/views/b$d;
    ...
    invoke-static {v1, v3, v5, p1}, Lef/a;->e(FFFF)Landroid/graphics/PointF;

    move-result-object p1

    invoke-static {p1, v0}, Lef/a;->d(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    invoke-static {p2, v1, v2, p1}, Lef/a;->e(FFFF)Landroid/graphics/PointF;
