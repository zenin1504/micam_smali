...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p1, p0}, Lg5/f;-><init>(Lcom/android/camera/fragment/ocr/views/ParticleAnimView;)V
...
.method public static synthetic a(Lcom/android/camera/fragment/ocr/views/ParticleAnimView;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/ocr/views/ParticleAnimView;->f()V

    return-void
.end method

.method public static synthetic b(Lcom/android/camera/fragment/ocr/views/ParticleAnimView;)Landroid/graphics/Rect;
    .locals 0
...
.method public final c()V
    ...
    new-instance v2, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;-><init>(Lcom/android/camera/fragment/ocr/views/ParticleAnimView;Lcom/android/camera/fragment/ocr/views/ParticleAnimView$a;)V
...
.method public d()V
    ...
    check-cast v2, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;

    invoke-virtual {v2}, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;->f()V
...
.method public final f()V
    ...
    check-cast v1, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;

    invoke-virtual {v1}, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;->g()V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v1}, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;->a(Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;)F
    ...
    invoke-static {v1}, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;->b(Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;)F
    ...
    invoke-static {v1}, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;->c(Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;)F

    move-result v2

    invoke-static {v1}, Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;->d(Lcom/android/camera/fragment/ocr/views/ParticleAnimView$b;)F
