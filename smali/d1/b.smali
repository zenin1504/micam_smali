...
.method public constructor <init>(Lorg/greenrobot/greendao/database/Database;Lorg/greenrobot/greendao/identityscope/IdentityScopeType;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Ld1/b;->a:Lorg/greenrobot/greendao/internal/DaoConfig;
    ...
    iput-object p3, p0, Ld1/b;->b:Lorg/greenrobot/greendao/internal/DaoConfig;
    ...
    invoke-direct {p2, p1, p0}, Lcom/android/camera/db/greendao/SaveTaskDao;-><init>(Lorg/greenrobot/greendao/internal/DaoConfig;Ld1/b;)V

    iput-object p2, p0, Ld1/b;->c:Lcom/android/camera/db/greendao/SaveTaskDao;

    new-instance p1, Lcom/android/camera/db/greendao/InnerTaskDao;

    invoke-direct {p1, p3, p0}, Lcom/android/camera/db/greendao/InnerTaskDao;-><init>(Lorg/greenrobot/greendao/internal/DaoConfig;Ld1/b;)V

    iput-object p1, p0, Ld1/b;->d:Lcom/android/camera/db/greendao/InnerTaskDao;

    const-class p3, Lc1/b;
...
# virtual methods
.method public a()Lcom/android/camera/db/greendao/InnerTaskDao;
    .locals 0
...
.method public b()Lcom/android/camera/db/greendao/SaveTaskDao;
    .locals 0
