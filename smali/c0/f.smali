...
.method public constructor <init>(ZLandroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Lc0/j;-><init>(Z)V

    iput-object p2, p0, Lc0/f;->e:Landroid/content/Context;
...
.method public static synthetic i()V
    ...
    invoke-static {}, Lc0/f;->o()V

    return-void
.end method

.method public static synthetic j(Lc0/f;DDJ)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lc0/f;->p(DDJ)V
...
.method public static synthetic o()V
    ...
    invoke-interface {v0, v1}, La7/c0;->findBestWatermarkItem(I)V
...
.method private synthetic p(DDJ)V
    ...
    const-string v11, "use DataItemGlobal to cache data too early"
    ...
    iget-object v2, v0, Lc0/f;->e:Landroid/content/Context;
    ...
    invoke-virtual {v0, v3}, Lc0/f;->k(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lc0/f;->k(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0, v14, v1}, Lz0/a$a;->putFloat(Ljava/lang/String;F)Lz0/a$a;

    double-to-float v1, v9

    invoke-interface {v0, v13, v1}, Lz0/a$a;->putFloat(Ljava/lang/String;F)Lz0/a$a;

    invoke-virtual {v11}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0, v12, v1}, Lz0/a$a;->putString(Ljava/lang/String;Ljava/lang/String;)Lz0/a$a;
    ...
    invoke-interface {v0, v14, v2}, Lz0/a$a;->putFloat(Ljava/lang/String;F)Lz0/a$a;

    double-to-float v2, v9

    invoke-interface {v0, v13, v2}, Lz0/a$a;->putFloat(Ljava/lang/String;F)Lz0/a$a;

    invoke-virtual {v11}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v2

    invoke-interface {v0, v12, v2}, Lz0/a$a;->putString(Ljava/lang/String;Ljava/lang/String;)Lz0/a$a;
    ...
    invoke-interface {v2, v14, v3}, Lz0/a$a;->putFloat(Ljava/lang/String;F)Lz0/a$a;

    double-to-float v3, v9

    invoke-interface {v2, v13, v3}, Lz0/a$a;->putFloat(Ljava/lang/String;F)Lz0/a$a;

    invoke-virtual {v11}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v12, v3}, Lz0/a$a;->putString(Ljava/lang/String;Ljava/lang/String;)Lz0/a$a;
...
.method public f(DD)Ljava/lang/String;
    ...
    invoke-virtual/range {v3 .. v11}, Lc0/f;->l(DDDD)D
    ...
    :cond_1
    :goto_0
    invoke-virtual/range {p0 .. p4}, Lc0/f;->m(DD)V
...
.method public g()Ljava/util/ArrayList;
    ...
    invoke-virtual {p0}, Lb0/c;->a()Ljava/util/ArrayList;
...
.method public final m(DD)V
    ...
    iget-object v0, p0, Lc0/f;->e:Landroid/content/Context;

    invoke-virtual {p0, v0}, Lc0/f;->n(Landroid/content/Context;)Z
    ...
    invoke-direct/range {v1 .. v8}, Lc0/d;-><init>(Lc0/f;DDJ)V

    invoke-static {v0, v9}, Lbf/j;->b(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
