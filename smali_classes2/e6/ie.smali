...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Le6/ie;->D:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, Le6/ie;->E:[F
...
.method public constructor <init>(Lcom/xiaomi/mediaprocess/OpenGlRender;)V
    ...
    iput v0, p0, Le6/ie;->a:I

    iput v0, p0, Le6/ie;->b:I

    iput v0, p0, Le6/ie;->c:I

    iput v0, p0, Le6/ie;->d:I

    const/4 v0, 0x0

    iput-object v0, p0, Le6/ie;->i:Ljava/nio/ByteBuffer;

    iput-object v0, p0, Le6/ie;->j:Ljava/nio/ByteBuffer;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Le6/ie;->m:[F

    const/16 v1, 0x200

    iput v1, p0, Le6/ie;->w:I

    const/4 v1, 0x1

    new-array v2, v1, [I

    iput-object v2, p0, Le6/ie;->x:[I

    new-array v1, v1, [I

    iput-object v1, p0, Le6/ie;->A:[I

    iput-object v0, p0, Le6/ie;->B:Ljava/nio/ByteBuffer;

    new-instance v0, Le6/ie$a;

    invoke-direct {v0, p0}, Le6/ie$a;-><init>(Le6/ie;)V

    iput-object v0, p0, Le6/ie;->C:Landroid/graphics/SurfaceTexture$OnFrameAvailableListener;

    iput-object p1, p0, Le6/ie;->k:Lcom/xiaomi/mediaprocess/OpenGlRender;

    return-void
.end method

.method public static synthetic d(Le6/ie;)Landroid/opengl/GLSurfaceView;
    .locals 0

    iget-object p0, p0, Le6/ie;->h:Landroid/opengl/GLSurfaceView;
...
.method public a(IIII)V
    ...
    invoke-virtual {p0}, Le6/ie;->c()V

    invoke-static {p1, p2, p3, p4}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget p1, p0, Le6/ie;->g:I
    ...
    iget-object p1, p0, Le6/ie;->m:[F

    invoke-static {p1, p2}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    iget p1, p0, Le6/ie;->q:I

    const/4 p3, 0x1

    iget-object p4, p0, Le6/ie;->m:[F
    ...
    iget-object v5, p0, Le6/ie;->i:Ljava/nio/ByteBuffer;
    ...
    iget-object v5, p0, Le6/ie;->j:Ljava/nio/ByteBuffer;
...
.method public final b()V
    ...
    iput-object v1, v0, Le6/ie;->i:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, v0, Le6/ie;->i:Ljava/nio/ByteBuffer;

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->asFloatBuffer()Ljava/nio/FloatBuffer;

    move-result-object v1

    sget-object v2, Le6/ie;->D:[F
    ...
    iput-object v1, v0, Le6/ie;->j:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, v0, Le6/ie;->j:Ljava/nio/ByteBuffer;

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->asFloatBuffer()Ljava/nio/FloatBuffer;

    move-result-object v1

    sget-object v3, Le6/ie;->E:[F
    ...
    invoke-virtual {v0, v3, v1}, Le6/ie;->f(Ljava/lang/String;Ljava/lang/String;)I

    move-result v1

    iput v1, v0, Le6/ie;->e:I
    ...
    iput-object v1, v0, Le6/ie;->A:[I

    aget v1, v1, v2

    iput v1, v0, Le6/ie;->n:I
    ...
    invoke-virtual {v0, v3, v10}, Le6/ie;->f(Ljava/lang/String;Ljava/lang/String;)I

    move-result v10

    iput v10, v0, Le6/ie;->f:I

    invoke-static {v10, v4}, Landroid/opengl/GLES20;->glGetAttribLocation(ILjava/lang/String;)I

    move-result v4

    iput v4, v0, Le6/ie;->c:I
    ...
    iget-object v4, v0, Le6/ie;->r:[I

    aget v4, v4, v2

    iput v4, v0, Le6/ie;->t:I
    ...
    iput-object v4, v0, Le6/ie;->s:[I

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget-object v4, v0, Le6/ie;->s:[I

    aget v4, v4, v2

    iput v4, v0, Le6/ie;->u:I
    ...
    invoke-virtual {v0, v3, v4}, Le6/ie;->f(Ljava/lang/String;Ljava/lang/String;)I

    move-result v3

    iput v3, v0, Le6/ie;->g:I

    invoke-static {v3}, Landroid/opengl/GLES20;->glUseProgram(I)V

    iget v3, v0, Le6/ie;->g:I

    invoke-static {v3, v7}, Landroid/opengl/GLES20;->glGetUniformLocation(ILjava/lang/String;)I

    move-result v3

    iput v3, v0, Le6/ie;->q:I
    ...
    iget-object v1, v0, Le6/ie;->B:Ljava/nio/ByteBuffer;

    move-object/from16 v18, v1

    invoke-static/range {v10 .. v18}, Landroid/opengl/GLES20;->glTexImage2D(IIIIIIIILjava/nio/Buffer;)V

    iget v1, v0, Le6/ie;->z:I

    iget-object v0, v0, Le6/ie;->B:Ljava/nio/ByteBuffer;
...
.method public final c()V
    ...
    iget v0, p0, Le6/ie;->t:I

    invoke-static {v0}, Lcom/xiaomi/gl/MIGL;->glBindFramebuffer(I)V

    iget v0, p0, Le6/ie;->e:I
    ...
    iget v1, p0, Le6/ie;->n:I

    invoke-static {v0, v1}, Landroid/opengl/GLES20;->glBindTexture(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v0, p0, Le6/ie;->o:I

    invoke-static {v0, v2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v0, p0, Le6/ie;->p:I

    const/4 v1, 0x1

    iget-object v3, p0, Le6/ie;->m:[F

    invoke-static {v0, v1, v2, v3, v2}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v0, p0, Le6/ie;->a:I

    invoke-static {v0}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v3, p0, Le6/ie;->a:I
    ...
    iget-object v8, p0, Le6/ie;->i:Ljava/nio/ByteBuffer;

    invoke-static/range {v3 .. v8}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZILjava/nio/Buffer;)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v0, p0, Le6/ie;->b:I

    invoke-static {v0}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget v3, p0, Le6/ie;->b:I

    iget-object v8, p0, Le6/ie;->j:Ljava/nio/ByteBuffer;
...
.method public final f(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v0, p1}, Le6/ie;->h(ILjava/lang/String;)I

    move-result v0

    const v1, 0x8b30

    invoke-virtual {p0, v1, p2}, Le6/ie;->h(ILjava/lang/String;)I
...
.method public g(Landroid/graphics/SurfaceTexture;)V
    ...
    invoke-virtual {p0}, Le6/ie;->b()V

    iget-object v1, p0, Le6/ie;->i:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Le6/ie;->j:Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Le6/ie;->k:Lcom/xiaomi/mediaprocess/OpenGlRender;

    iget v3, p0, Le6/ie;->f:I

    iget v4, p0, Le6/ie;->u:I

    iget v5, p0, Le6/ie;->v:I

    iget v6, p0, Le6/ie;->c:I

    iget v7, p0, Le6/ie;->d:I

    invoke-virtual/range {v2 .. v9}, Lcom/xiaomi/mediaprocess/OpenGlRender;->c(IIIII[B[B)V

    iget-object v0, p0, Le6/ie;->k:Lcom/xiaomi/mediaprocess/OpenGlRender;

    iget v1, p0, Le6/ie;->u:I

    invoke-virtual {v0, v1}, Lcom/xiaomi/mediaprocess/OpenGlRender;->b(I)V

    iput-object p1, p0, Le6/ie;->l:Landroid/graphics/SurfaceTexture;

    iget p0, p0, Le6/ie;->n:I
...
.method public i()V
    ...
    iget-object v0, p0, Le6/ie;->A:[I

    const-string v1, "MiGLSurfaceViewRender"

    invoke-static {v0, v1}, Lcom/xiaomi/gl/MIGL;->glDeleteTextures([ILjava/lang/String;)V

    iget-object v0, p0, Le6/ie;->x:[I

    invoke-static {v0, v1}, Lcom/xiaomi/gl/MIGL;->glDeleteTextures([ILjava/lang/String;)V

    iget-object v0, p0, Le6/ie;->s:[I

    invoke-static {v0, v1}, Lcom/xiaomi/gl/MIGL;->glDeleteTextures([ILjava/lang/String;)V

    iget-object v0, p0, Le6/ie;->r:[I
    ...
    iget-object v2, p0, Le6/ie;->A:[I

    const/4 v3, 0x0

    aput-object v2, v0, v3

    iget-object v2, p0, Le6/ie;->x:[I

    const/4 v4, 0x1

    aput-object v2, v0, v4

    iget-object v2, p0, Le6/ie;->s:[I

    const/4 v5, 0x2

    aput-object v2, v0, v5

    iget-object v2, p0, Le6/ie;->r:[I
    ...
    iput v3, p0, Le6/ie;->e:I

    iput v3, p0, Le6/ie;->f:I

    iput v3, p0, Le6/ie;->g:I
...
.method public j(Ljava/nio/ByteBuffer;)V
    ...
    iput-object p1, p0, Le6/ie;->B:Ljava/nio/ByteBuffer;
...
.method public k(I)V
    ...
    iget-object v0, p0, Le6/ie;->l:Landroid/graphics/SurfaceTexture;

    invoke-virtual {v0}, Landroid/graphics/SurfaceTexture;->updateTexImage()V

    iget-object v0, p0, Le6/ie;->l:Landroid/graphics/SurfaceTexture;

    iget-object v1, p0, Le6/ie;->m:[F

    invoke-virtual {v0, v1}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v0, p0, Le6/ie;->m:[F

    const/4 v1, 0x0

    invoke-static {v0, v1}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    iget-object v2, p0, Le6/ie;->m:[F
