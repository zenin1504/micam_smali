...
# direct methods
.method public constructor <init>(Landroid/content/Context;ILx8/c$e;)V
    .locals 4
    ...
    iput-object v0, p0, Lx8/c;->a:Landroid/content/Context;

    const/16 v1, 0x5a

    iput v1, p0, Lx8/c;->c:I

    const/4 v1, 0x0

    iput v1, p0, Lx8/c;->e:I
    ...
    iput-object v2, p0, Lx8/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;

    iput v1, p0, Lx8/c;->g:I

    iput v1, p0, Lx8/c;->h:I

    iput v1, p0, Lx8/c;->i:I

    iput v1, p0, Lx8/c;->j:I

    iput v1, p0, Lx8/c;->l:I

    iput v1, p0, Lx8/c;->m:I

    iput-boolean v1, p0, Lx8/c;->s:Z

    iput-boolean v1, p0, Lx8/c;->t:Z

    iput-boolean v1, p0, Lx8/c;->u:Z

    new-instance v1, Lx8/c$d;

    invoke-direct {v1, p0}, Lx8/c$d;-><init>(Lx8/c;)V

    iput-object v1, p0, Lx8/c;->y:Lcom/arcsoft/camera/wideselfie/WideSelfieCallback;

    new-instance v1, Lx8/c$b;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v2

    invoke-direct {v1, p0, v2}, Lx8/c$b;-><init>(Lx8/c;Landroid/os/Looper;)V

    iput-object v1, p0, Lx8/c;->z:Landroid/os/Handler;

    new-instance v1, Lx8/c$c;

    invoke-direct {v1, v0}, Lx8/c$c;-><init>(Lx8/c$a;)V

    iput-object v1, p0, Lx8/c;->A:Landroid/hardware/SensorEventListener;
    ...
    iput-object p2, p0, Lx8/c;->r:Ljava/lang/ref/WeakReference;
    ...
    iput-object p1, p0, Lx8/c;->p:Landroid/hardware/SensorManager;
    ...
    iput-object p1, p0, Lx8/c;->q:Landroid/hardware/Sensor;

    iget-object p1, p0, Lx8/c;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, Lx8/c;->v:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    new-instance p1, Lx8/c$a;

    iget-object p2, p0, Lx8/c;->v:Landroid/os/HandlerThread;

    invoke-virtual {p2}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object p2

    invoke-direct {p1, p0, p2}, Lx8/c$a;-><init>(Lx8/c;Landroid/os/Looper;)V

    iput-object p1, p0, Lx8/c;->w:Landroid/os/Handler;

    return-void
.end method

.method public static synthetic a(Lx8/c;[B)V
    .locals 0

    invoke-virtual {p0, p1}, Lx8/c;->n([B)V

    return-void
.end method

.method public static synthetic b(Lx8/c;ILcom/arcsoft/camera/wideselfie/ProcessResult;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lx8/c;->k(ILcom/arcsoft/camera/wideselfie/ProcessResult;)V

    return-void
.end method

.method public static synthetic c(Lx8/c;)Ljava/lang/ref/WeakReference;
    .locals 0

    iget-object p0, p0, Lx8/c;->r:Ljava/lang/ref/WeakReference;

    return-object p0
.end method

.method public static synthetic d(Lx8/c;)I
    .locals 0

    iget p0, p0, Lx8/c;->c:I

    return p0
.end method

.method public static synthetic e(Lx8/c;)Landroid/graphics/Rect;
    .locals 0

    iget-object p0, p0, Lx8/c;->o:Landroid/graphics/Rect;

    return-object p0
.end method

.method public static synthetic f(Lx8/c;)Z
    .locals 0

    iget-boolean p0, p0, Lx8/c;->x:Z

    return p0
.end method

.method public static synthetic g(Lx8/c;I)I
    .locals 0

    iput p1, p0, Lx8/c;->d:I

    return p1
.end method

.method public static synthetic h(Lx8/c;)I
    .locals 0

    iget p0, p0, Lx8/c;->e:I
...
.method public final k(ILcom/arcsoft/camera/wideselfie/ProcessResult;)V
    ...
    iget-object v0, p0, Lx8/c;->z:Landroid/os/Handler;
    ...
    :cond_0
    iget-object p0, p0, Lx8/c;->z:Landroid/os/Handler;
...
.method public l()Z
    ...
    iget-object p0, p0, Lx8/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public m(Landroid/media/Image;)V
    ...
    iget-object v0, p0, Lx8/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lx8/c;->w:Landroid/os/Handler;
...
.method public final n([B)V
    ...
    :goto_0
    iget-object v5, p0, Lx8/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean p1, p0, Lx8/c;->t:Z

    if-nez p1, :cond_4

    iput-boolean v3, p0, Lx8/c;->t:Z

    goto/16 :goto_1

    :cond_2
    iget-object p1, p0, Lx8/c;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lx8/c;->r:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lx8/c$e;

    if-eqz v0, :cond_3

    invoke-interface {v0}, Lx8/c$e;->onWideSelfCompleted()V
...
.method public o()V
    ...
    iget-object v1, p0, Lx8/c;->z:Landroid/os/Handler;
    ...
    iget-object v0, p0, Lx8/c;->v:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Lx8/c;->v:Landroid/os/HandlerThread;
...
.method public p()V
    ...
    iget-boolean v0, p0, Lx8/c;->u:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lx8/c;->p:Landroid/hardware/SensorManager;

    iget-object v1, p0, Lx8/c;->A:Landroid/hardware/SensorEventListener;

    invoke-virtual {v0, v1}, Landroid/hardware/SensorManager;->unregisterListener(Landroid/hardware/SensorEventListener;)V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lx8/c;->u:Z
...
.method public q()V
    ...
    iget-object v2, p0, Lx8/c;->q:Landroid/hardware/Sensor;

    const/16 v3, 0x2710

    iget-object v4, p0, Lx8/c;->w:Landroid/os/Handler;
...
.method public r(Ljava/lang/String;IIII)V
    ...
    :cond_0
    iput p2, p0, Lx8/c;->i:I

    iput p3, p0, Lx8/c;->j:I

    iput p4, p0, Lx8/c;->g:I

    iput p5, p0, Lx8/c;->h:I

    iget-object p3, p0, Lx8/c;->a:Landroid/content/Context;
    ...
    iput p3, p0, Lx8/c;->l:I

    iget p3, p0, Lx8/c;->j:I
    ...
    :try_start_0
    iget-object p2, p0, Lx8/c;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, p1}, Lx8/c;->j(Landroid/hardware/camera2/CameraCharacteristics;)Landroid/util/SizeF;

    move-result-object p1

    iput-object p1, p0, Lx8/c;->k:Landroid/util/SizeF;
    :try_end_0
...
.method public t()I
    ...
    iget v2, p0, Lx8/c;->h:I

    const/16 v4, 0x802

    iget v5, p0, Lx8/c;->c:I
    ...
    :goto_1
    iput-boolean v2, p0, Lx8/c;->x:Z

    iget-object v2, p0, Lx8/c;->a:Landroid/content/Context;

    invoke-static {v2}, Lx8/b;->a(Landroid/content/Context;)Lx8/b;
    ...
    iget v5, p0, Lx8/c;->h:I

    iget v8, p0, Lx8/c;->n:I

    mul-int/2addr v5, v8

    invoke-virtual {v2}, Lx8/b;->c()I
    ...
    iget v9, p0, Lx8/c;->l:I

    iget v10, p0, Lx8/c;->m:I

    add-int/2addr v10, v2

    invoke-direct {v8, v1, v2, v9, v10}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v8, p0, Lx8/c;->o:Landroid/graphics/Rect;

    goto :goto_2

    :cond_2
    iget v5, p0, Lx8/c;->g:I

    invoke-virtual {v2}, Lx8/b;->e()I
    ...
    invoke-virtual {v2}, Lx8/b;->b()I

    move-result v8

    div-int/2addr v5, v8

    iget-boolean v8, p0, Lx8/c;->x:Z
    ...
    iget-object v2, p0, Lx8/c;->k:Landroid/util/SizeF;
    ...
    iget-object v2, p0, Lx8/c;->y:Lcom/arcsoft/camera/wideselfie/WideSelfieCallback;
