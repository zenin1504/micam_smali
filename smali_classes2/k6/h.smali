...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lk6/h;->a:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Lk6/h;->b:Landroid/util/SparseArray;

    return-void
.end method

.method public static synthetic a(Lk6/h;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;ILk6/a;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lk6/h;->i(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;ILk6/a;)V
...
.method public static synthetic b(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;Ljava/lang/Long;)V
    ...
    invoke-static {p0, p1}, Lk6/h;->g(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;Ljava/lang/Long;)V
...
.method public static synthetic c(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;Ljava/lang/Long;)V
    ...
    invoke-static {p0, p1}, Lk6/h;->f(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;Ljava/lang/Long;)V

    return-void
.end method

.method public static synthetic d(Ljava/lang/String;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;Lk6/a;)Lio/reactivex/ObservableSource;
    .locals 0

    invoke-static {p0, p1, p2}, Lk6/h;->h(Ljava/lang/String;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;Lk6/a;)Lio/reactivex/ObservableSource;
...
.method public static synthetic e(Lk6/h;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;ILjava/lang/Throwable;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lk6/h;->j(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;ILjava/lang/Throwable;)V
...
.method public static synthetic h(Ljava/lang/String;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;Lk6/a;)Lio/reactivex/ObservableSource;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p2}, Lk6/a;->a()Ljava/lang/String;
    ...
    invoke-virtual {v0, p0}, Li7/u;->w(I)Lio/reactivex/Observable;

    move-result-object p0

    new-instance v1, Lk6/g;

    invoke-direct {v1, p1}, Lk6/g;-><init>(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;)V
    ...
    invoke-virtual {v0, p2}, Li7/d;->n(Ljava/lang/Object;)Lio/reactivex/Observable;
...
.method private synthetic i(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;ILk6/a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p0, p2}, Lk6/h;->k(I)V
...
.method private synthetic j(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;ILjava/lang/Throwable;)V
    ...
    invoke-static {p3}, Lq7/a;->x1(Ljava/lang/String;)V
...
.method public cancelDownloadSync(I)Z
    ...
    iget-object v0, p0, Lk6/h;->b:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, p1}, Lk6/h;->k(I)V
...
.method public final k(I)V
    ...
    iget-object v0, p0, Lk6/h;->a:Landroid/util/SparseArray;
    ...
    iget-object p0, p0, Lk6/h;->a:Landroid/util/SparseArray;
...
.method public startDownload(ILjava/util/List;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;)V
    ...
    iget-object p2, p0, Lk6/h;->b:Landroid/util/SparseArray;
    ...
    invoke-direct {p2, v0, v1}, Li7/u;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    const/16 v1, 0x78

    invoke-virtual {p2, v1}, Li7/u;->w(I)Lio/reactivex/Observable;

    move-result-object v1

    new-instance v2, Lk6/c;

    invoke-direct {v2, p3}, Lk6/c;-><init>(Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;)V

    invoke-virtual {v1, v2}, Lio/reactivex/Observable;->subscribe(Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;

    new-instance v1, Lk6/a;

    invoke-direct {v1, v0}, Lk6/a;-><init>(Ljava/lang/String;)V

    invoke-virtual {p2, v1}, Li7/d;->n(Ljava/lang/Object;)Lio/reactivex/Observable;
    ...
    invoke-direct {p2, v0}, Lk6/b;-><init>(Ljava/lang/String;)V

    const-class v0, Lk6/a;

    invoke-virtual {p2, v0}, Li7/d;->m(Ljava/lang/Class;)Lio/reactivex/Observable;

    move-result-object p2

    new-instance v0, Lk6/d;

    invoke-direct {v0, v1, p3}, Lk6/d;-><init>(Ljava/lang/String;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;)V
    ...
    invoke-direct {v0, p0, p3, p1}, Lk6/e;-><init>(Lk6/h;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;I)V

    new-instance v1, Lk6/f;

    invoke-direct {v1, p0, p3, p1}, Lk6/f;-><init>(Lk6/h;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;I)V
