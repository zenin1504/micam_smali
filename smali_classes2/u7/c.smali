...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lu7/c;->i:Landroid/os/ParcelFileDescriptor;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lu7/c;->j:Ljava/util/Set;

    iput-object p1, p0, Lu7/c;->c:Landroid/content/Context;
...
# virtual methods
.method public declared-synchronized a(Ls5/a$b;)V
    .locals 1
    ...
    :try_start_0
    iget-object v0, p0, Lu7/c;->j:Ljava/util/Set;
...
.method public b()V
    ...
    iget-object v0, p0, Lu7/c;->g:Ljava/lang/String;
    ...
    iget-object v1, p0, Lu7/c;->g:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lu7/c;->b:Landroid/os/ParcelFileDescriptor;

    invoke-static {v0}, Lem/b;->a(Ljava/io/Closeable;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lu7/c;->b:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {p0}, Lu7/c;->c()V

    iput-object v0, p0, Lu7/c;->a:Landroid/net/Uri;

    iget-object v1, p0, Lu7/c;->d:Landroid/content/ContentValues;
    ...
    :cond_1
    iput-object v0, p0, Lu7/c;->d:Landroid/content/ContentValues;
...
.method public final c()V
    ...
    iget-object v0, p0, Lu7/c;->a:Landroid/net/Uri;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lu7/c;->c:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    iget-object v1, p0, Lu7/c;->a:Landroid/net/Uri;

    invoke-static {v0, v1}, Lu7/c;->s(Landroid/content/ContentResolver;Landroid/net/Uri;)J
    ...
    iget-object p0, p0, Lu7/c;->a:Landroid/net/Uri;
...
.method public d()V
    ...
    iget-object v0, p0, Lu7/c;->i:Landroid/os/ParcelFileDescriptor;
...
.method public e()Landroid/content/ContentValues;
    ...
    iget-object p0, p0, Lu7/c;->d:Landroid/content/ContentValues;
...
.method public f()Ljava/io/FileDescriptor;
    ...
    invoke-virtual {p0}, Lu7/c;->i()Landroid/os/ParcelFileDescriptor;
...
.method public g()Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Lu7/c;->r(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/lang/String;
...
.method public i()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual {p0}, Lu7/c;->g()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0}, Lu7/c;->h()Landroid/net/Uri;

    move-result-object p0

    invoke-static {v0, p0}, Lcom/android/camera/j6;->A1(Ljava/lang/String;Landroid/net/Uri;)Landroid/os/ParcelFileDescriptor;
...
.method public j()Ljava/lang/String;
    ...
    iget-object p0, p0, Lu7/c;->h:Ljava/lang/String;
...
.method public declared-synchronized l()Ljava/util/Set;
    ...
    iget-object v1, p0, Lu7/c;->j:Ljava/util/Set;
...
.method public m(ZLandroid/content/Intent;)V
    ...
    invoke-virtual {p0, p2}, Lu7/c;->q(Landroid/content/Intent;)V
...
.method public n()Landroid/net/Uri;
    ...
    iget-object v4, p0, Lu7/c;->d:Landroid/content/ContentValues;
    ...
    iget-object v5, p0, Lu7/c;->d:Landroid/content/ContentValues;
    ...
    invoke-static {v5}, Lr7/w;->k0(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-virtual {p0, v4}, Lu7/c;->o(Landroid/content/ContentValues;)Z
    ...
    :cond_2
    iget-object v1, p0, Lu7/c;->c:Landroid/content/Context;

    const/4 v6, 0x1

    invoke-static {v1, v6, v5}, Lr7/w;->y(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
...
.method public p()Z
    ...
    iget-object p0, p0, Lu7/c;->f:Landroid/os/ParcelFileDescriptor;
...
.method public final q(Landroid/content/Intent;)V
    ...
    iput-object p1, p0, Lu7/c;->e:Landroid/net/Uri;
    ...
    iget-object v2, p0, Lu7/c;->e:Landroid/net/Uri;
    ...
    iput-object v1, p0, Lu7/c;->f:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object p0, p0, Lu7/c;->e:Landroid/net/Uri;
...
.method public t(Landroid/content/ContentValues;)V
    ...
    iput-object p1, p0, Lu7/c;->d:Landroid/content/ContentValues;
...
.method public v(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lu7/c;->h:Ljava/lang/String;
...
.method public w(Landroid/media/MediaRecorder;Z)V
    ...
    iget-object p0, p0, Lu7/c;->g:Ljava/lang/String;
    ...
    iget-object v2, p0, Lu7/c;->c:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getCacheDir()Ljava/io/File;

    move-result-object v2

    invoke-virtual {p0}, Lu7/c;->p()Z
    ...
    :cond_1
    iget-object v3, p0, Lu7/c;->d:Landroid/content/ContentValues;
    ...
    iput-object p2, p0, Lu7/c;->g:Ljava/lang/String;
    ...
    iget-object v2, p0, Lu7/c;->g:Ljava/lang/String;
    ...
    :cond_3
    iget-object p2, p0, Lu7/c;->d:Landroid/content/ContentValues;
    ...
    invoke-static {p2}, Lr7/w;->k0(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_5

    iget-object v3, p0, Lu7/c;->c:Landroid/content/Context;
    ...
    invoke-static {v2, v5, p2}, Lr7/w;->y(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    iput-object v2, p0, Lu7/c;->a:Landroid/net/Uri;
    ...
    iget-object v4, p0, Lu7/c;->a:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v2, p0, Lu7/c;->a:Landroid/net/Uri;
    ...
    iput-object v2, p0, Lu7/c;->b:Landroid/os/ParcelFileDescriptor;
...
.method public x(Lse/g;Z)V
    ...
    invoke-interface {p1, p0}, Lse/g;->n(Ljava/lang/String;)V
    ...
    invoke-interface {p1, p0}, Lse/g;->k(Ljava/io/FileDescriptor;)V
...
.method public y(Landroid/net/Uri;)V
    ...
    iput-object p1, p0, Lu7/c;->a:Landroid/net/Uri;
