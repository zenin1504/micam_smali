...
.method public l0(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v2, p0, Lb9/n;->l:Landroid/view/Surface;

    if-eqz v2, :cond_3

    iget-object v2, p0, Lb9/n;->m:Landroid/view/Surface;
    ...
    iget-object v4, v2, Lcom/android/camera2/b6$a;->p:[I
    ...
    iget v2, v2, Lcom/android/camera2/b6$a;->u:I
    ...
    iget v4, v2, Lcom/android/camera2/b6$a;->c:I

    iget v2, v2, Lcom/android/camera2/b6$a;->v:I
    ...
    iget-object v5, v5, Lcom/android/camera2/b6$a;->p:[I
    ...
    :goto_2
    invoke-virtual {p0, p1, p2}, Lb9/n;->E0(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
...
.method public t0()Lb9/a$b;
    ...
    invoke-direct {v0, p0}, Lb9/n$a;-><init>(Lb9/n;)V
...
.method public u0()Lb9/a$d;
    ...
    invoke-virtual {v2, v7, v4}, Lcom/android/camera2/r5;->t(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v7, v8, v4}, Lcom/android/camera2/r5;->u(IZ)I
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->y()Lm9/d;

    move-result-object v2

    if-eqz v2, :cond_4

    invoke-virtual {v2}, Lm9/d;->e()Z
    ...
    invoke-virtual {v2}, Lcom/android/camera2/r5;->M()Landroid/view/Surface;
    ...
    invoke-virtual {v2, v7, v4}, Lcom/android/camera2/r5;->C(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v7, v4, v8}, Lcom/android/camera2/r5;->D(ZI)I
    ...
    iput-object v2, p0, Lb9/n;->l:Landroid/view/Surface;

    invoke-interface {v0, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v2, p0, Lb9/a;->a:Lcom/android/camera2/b6;

    invoke-virtual {v2}, Lcom/android/camera2/b6;->a()Z
    ...
    iput-object v2, p0, Lb9/n;->m:Landroid/view/Surface;
    ...
    invoke-virtual {v7}, Lcom/android/camera2/k4;->C()I
    ...
    invoke-virtual {v3}, Lcom/android/camera2/b6;->a()Z
    ...
    iget-object v3, v3, Lcom/android/camera2/b6$a;->f:Lbk/c;

    invoke-virtual {v3}, Lbk/c;->a()I
