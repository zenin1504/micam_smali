...
.method public static c(ZI[I[FLandroid/graphics/Rect;IIII)Landroid/graphics/Rect;
    ...
    invoke-static/range {v0 .. v8}, Lu8/c;->a([II[I[FLandroid/graphics/Rect;IIII)V
    ...
    invoke-static {v12}, Lef/c;->h([I)Landroid/graphics/Rect;
...
.method public static d(Lcom/android/camera/effect/renders/z;Lm2/e;)Lcom/android/camera/effect/renders/z;
    .locals 13

    iget-boolean v0, p1, Lm2/e;->y:Z

    const/4 v1, 0x0

    if-nez v0, :cond_0

    iget-boolean v0, p1, Lm2/e;->z:Z
    ...
    :cond_0
    iget-object v0, p1, Lm2/e;->A:Lcom/android/camera/effect/renders/f;
    ...
    invoke-virtual {v0}, Lcom/android/camera/effect/renders/f;->j()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/z;->a()Lcom/android/camera/effect/renders/c;
    ...
    iget-boolean v1, p1, Lm2/e;->z:Z

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean p1, p1, Lm2/e;->y:Z
    ...
    iget-boolean v6, p1, Lm2/e;->z:Z

    invoke-virtual {p0, v6}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    invoke-virtual {p0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, p1, Lm2/e;->y:Z
    ...
    invoke-direct/range {v3 .. v10}, Lw8/a;-><init>(IIILjava/lang/String;ZZI)V

    goto :goto_1

    :cond_3
    iget-boolean p0, p1, Lm2/e;->z:Z
    ...
    iget p0, p1, Lm2/e;->t:I

    invoke-static {v2, v11, p0, v0}, Lv8/e;->n(IIILcom/android/camera/effect/renders/f;)Lcom/android/camera/effect/renders/z;
    ...
    invoke-static {v2, v11, p0, v0}, Lv8/e;->m(IIILcom/android/camera/effect/renders/f;)Lcom/android/camera/effect/renders/z;
    ...
    invoke-virtual {v1, v12}, Lcom/android/camera/effect/renders/z;->n(Lcom/android/camera/effect/renders/c;)V
...
.method public static f([I[FLandroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v1}, Lef/c;->h([I)Landroid/graphics/Rect;
...
.method public static g(Lcom/android/camera/effect/renders/z;Lm2/e;)Lcom/android/camera/effect/renders/z;
    .locals 13

    iget-object v1, p1, Lm2/e;->x:Ljava/lang/String;
    ...
    iget-object v7, p1, Lm2/e;->x:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v6}, Lw8/b;-><init>(Ljava/lang/String;IIIZZ)V
    ...
    invoke-direct/range {v0 .. v5}, Lv8/c;-><init>(Ljava/lang/String;IIIZ)V

    :goto_1
    invoke-virtual {p0, v12}, Lcom/android/camera/effect/renders/z;->n(Lcom/android/camera/effect/renders/c;)V
...
.method public static i(III)Landroid/graphics/Rect;
    .locals 8
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public static m(Lcom/android/camera/effect/renders/z;)[B
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/z;->i()Lcom/android/gallery3d/ui/b;

    move-result-object p0

    check-cast p0, Lcom/android/gallery3d/ui/p;

    sget-object v0, Landroid/graphics/Bitmap$CompressFormat;->PNG:Landroid/graphics/Bitmap$CompressFormat;

    invoke-virtual {p0, v0}, Lcom/android/gallery3d/ui/p;->getBitmapDataWithRetry(Landroid/graphics/Bitmap$CompressFormat;)[B
...
.method public static n(Lcom/android/camera/effect/renders/z;F)[I
    .locals 3
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/z;->f()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/z;->g()I
...
.method public static o(IIILcom/android/camera/effect/renders/z;Lcom/android/camera/effect/renders/z;)Landroid/graphics/Rect;
    .locals 14
    ...
    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/z;->l()Z

    move-result v10

    new-array v11, v7, [I

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/z;->k()I

    move-result v12

    aput v12, v11, v8

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/z;->d()I

    move-result v12

    aput v12, v11, v6

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/z;->f()I

    move-result v12

    aput v12, v11, v5

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/z;->g()I
    ...
    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/z;->l()Z

    move-result v9

    new-array v7, v7, [I

    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/z;->k()I

    move-result v10

    aput v10, v7, v8

    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/z;->d()I

    move-result v10

    aput v10, v7, v6

    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/z;->f()I

    move-result v6

    aput v6, v7, v5

    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/z;->g()I
    ...
    invoke-static/range {v0 .. v5}, Lu8/c;->p(III[I[IZ)Landroid/graphics/Rect;
...
.method public static p(III[I[IZ)Landroid/graphics/Rect;
    .locals 7
    ...
    invoke-static {v1, p0, p1}, Lu8/c;->b([III)V
