...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lr6/a;->a:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lr6/a;->b:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lr6/a;->c:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lr6/a;->d:Ljava/util/List;
    ...
    sput-object v0, Lr6/a;->g:Ljava/util/List;

    sget-object v0, Lr6/a;->a:Ljava/util/List;

    const-string v1, "android.permission.CAMERA"

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v0, Lr6/a;->b:Ljava/util/List;
    ...
    sget-object v0, Lr6/a;->c:Ljava/util/List;
    ...
    sget-object v3, Lr6/a;->f:Ljava/util/List;

    const-string v4, "android.permission.READ_MEDIA_AUDIO"

    invoke-interface {v3, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v3, Lr6/a;->e:Ljava/util/List;
    ...
    sget-object v3, Lr6/a;->d:Ljava/util/List;
    ...
    :goto_0
    sget-object v3, Lr6/a;->g:Ljava/util/List;

    invoke-interface {v3, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    if-lt v0, v2, :cond_1

    sget-object v0, Lr6/a;->g:Ljava/util/List;

    sget-object v1, Lr6/a;->e:Ljava/util/List;

    invoke-interface {v0, v1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    sget-object v0, Lr6/a;->g:Ljava/util/List;

    sget-object v1, Lr6/a;->f:Ljava/util/List;
    ...
    sget-object v1, Lr6/a;->d:Ljava/util/List;
...
.method public static a(Ljava/util/List;Ljava/lang/String;)V
    ...
    :pswitch_3
    sget-object v2, Lr6/a;->e:Ljava/util/List;
    ...
    :pswitch_4
    sget-object v2, Lr6/a;->d:Ljava/util/List;
    ...
    :pswitch_5
    sget-object v2, Lr6/a;->c:Ljava/util/List;
    ...
    :pswitch_6
    sget-object v2, Lr6/a;->b:Ljava/util/List;
...
.method public static b()Z
    ...
    invoke-static {v0}, Lr6/a;->i(Ljava/util/List;)Ljava/util/List;
...
.method public static c()Z
    ...
    invoke-static {v0}, Lcom/android/camera/j6;->r3(Landroid/content/Context;)Z
...
.method public static f()Z
    ...
    sget-object v0, Lr6/a;->d:Ljava/util/List;
...
.method public static g(Z)Landroid/util/ArrayMap;
    ...
    sget-object v4, Lr6/a;->g:Ljava/util/List;

    invoke-static {v4}, Lr6/a;->i(Ljava/util/List;)Ljava/util/List;

    move-result-object v4

    invoke-static {}, Lr6/a;->q()Z
    ...
    invoke-static {v6}, Lr6/a;->j(Ljava/lang/String;)I
...
.method public static h(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v1}, Lr6/a;->a(Ljava/util/List;Ljava/lang/String;)V
...
.method public static n([Ljava/lang/String;)Z
    ...
    sget-object v5, Lr6/a;->a:Ljava/util/List;
...
.method public static o([Ljava/lang/String;)Z
    ...
    sget-object v5, Lr6/a;->b:Ljava/util/List;
...
.method public static p()Z
    ...
    invoke-static {v3}, Lr6/a;->j(Ljava/lang/String;)I
...
.method public static r(Li5/a;Le0/b;)Z
    .locals 7
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportBluetoothHeadsetMic"
    ...
    invoke-static {v5}, Lr6/a;->j(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lr6/a;->h(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-interface {p1, p0}, Le0/b;->e3(Ljava/lang/String;)V
...
.method public static s(Li5/a;Le0/b;)Z
    .locals 7
    ...
    :cond_3
    sget-object p0, Lr6/a;->b:Ljava/util/List;
...
.method public static t(Landroid/app/Activity;I)Z
    ...
    sget-object v5, Lq6/a;->Z:Lq6/a;

    aput-object v5, v4, v3

    sget-object v5, Lq6/a;->b0:Lq6/a;

    aput-object v5, v4, v1

    const/4 v1, 0x2

    sget-object v5, Lq6/a;->a0:Lq6/a;

    aput-object v5, v4, v1

    invoke-virtual {v2, v4}, Lq6/n;->l([Lq6/a;)V
...
.method public static u(Landroid/app/Activity;ILe0/b;)Z
    .locals 7
    ...
    sget-object v4, Lq6/a;->Z:Lq6/a;

    aput-object v4, v1, v3

    sget-object v4, Lq6/a;->b0:Lq6/a;

    aput-object v4, v1, v2

    const/4 v2, 0x2

    sget-object v4, Lq6/a;->a0:Lq6/a;

    aput-object v4, v1, v2

    invoke-virtual {p2, v1}, Lq6/n;->l([Lq6/a;)V
    ...
    invoke-interface {p2, p0}, Le0/b;->e3(Ljava/lang/String;)V
...
.method public static v(Landroid/app/Activity;I)Z
    ...
    :pswitch_0
    sget-object p1, Lr6/a;->c:Ljava/util/List;

    goto :goto_0

    :pswitch_1
    sget-object p1, Lr6/a;->g:Ljava/util/List;

    goto :goto_0

    :pswitch_2
    sget-object p1, Lr6/a;->b:Ljava/util/List;
