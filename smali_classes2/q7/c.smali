...
.method public static synthetic a(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p0, p1}, Lq7/c;->h(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static b(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0}, Lq7/c;->l(Ljava/lang/String;Ljava/util/Map;)V

    sget-boolean v1, Lq7/c;->b:Z

    if-eqz v1, :cond_0

    invoke-static {p0, v0}, Lq7/c;->c(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static e(Landroid/content/Context;Lio/reactivex/Scheduler;)V
    ...
    sput-object p1, Lq7/c;->e:Lio/reactivex/Scheduler;
    ...
    sget-boolean p1, Lq7/c;->a:Z

    if-nez p1, :cond_1

    invoke-static {p0}, Lq7/c;->g(Landroid/content/Context;)Z
    ...
    sput-boolean v0, Lq7/c;->b:Z

    const-string v0, "camera.camera_statistic"

    invoke-static {v0, p1}, Laf/e;->c(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lq7/c;->c:Z

    if-eqz v0, :cond_1

    :try_start_0
    sput-boolean p1, Lq7/c;->d:Z

    invoke-static {p0}, Lw7/a;->a(Landroid/content/Context;)V
    :try_end_0
...
.method public static synthetic h(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p0, p1}, Lw7/a;->b(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static i(Ljava/lang/String;Ljava/util/Map;)V
    ...
    sget-boolean v0, Lq7/c;->b:Z

    if-eqz v0, :cond_1

    invoke-static {p0, p1}, Lq7/c;->c(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static l(Ljava/lang/String;Ljava/util/Map;)V
    ...
    :cond_0
    sget-object v0, Lq7/c;->e:Lio/reactivex/Scheduler;

    new-instance v1, Lq7/b;

    invoke-direct {v1, p0, p1}, Lq7/b;-><init>(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static m(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p0, p1}, Lq7/c;->l(Ljava/lang/String;Ljava/util/Map;)V

    sget-boolean v0, Lq7/c;->b:Z

    if-eqz v0, :cond_0

    invoke-static {p0, p1}, Lq7/c;->d(Ljava/lang/String;Ljava/util/Map;)V
