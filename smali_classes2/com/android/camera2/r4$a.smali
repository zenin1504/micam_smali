...
.method public static synthetic a(Lcom/android/camera2/r4$a;Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera2/r4$a;->e(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V

    return-void
.end method

.method public static synthetic b(Lcom/android/camera2/r4$a;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera2/r4$a;->d()V

    return-void
.end method

.method public static synthetic c(Lcom/android/camera2/r4$a;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera2/r4$a;->f()V
...
.method private synthetic d()V
    ...
    invoke-static {v0}, Lcom/android/camera2/r4;->k(Lcom/android/camera2/r4;)V

    iget-object v0, p0, Lcom/android/camera2/r4$a;->a:Lcom/android/camera2/r4;

    const/4 v1, 0x0

    iput-boolean v1, v0, Lcom/android/camera2/r4;->f:Z
    ...
    invoke-virtual {v0, p0}, Le1/c;->u(Ljava/lang/String;)V
...
.method private synthetic e(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera2/r4;->y(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
...
.method private synthetic f()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera2/r4;->changeCallbackState(I)V

    iget-object v0, p0, Lcom/android/camera2/r4$a;->a:Lcom/android/camera2/r4;

    invoke-virtual {v0}, Lcom/android/camera2/r4;->B()V
...
.method public onCaptureCompleted()V
    ...
    iget-object v4, v0, Lcom/android/camera2/r4;->l:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/camera2/r4;->A()V

    iget-object v0, p0, Lcom/android/camera2/r4$a;->a:Lcom/android/camera2/r4;

    iget-object v0, v0, Lcom/android/camera2/r4;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/r4;->r()V
...
.method public onCaptureFailed()V
    ...
    invoke-virtual {v0}, Lcom/android/camera2/r4;->tryCallbackCaptureFailed()V
    ...
    iget-object v3, p0, Lcom/android/camera2/r4$a;->a:Lcom/android/camera2/r4;

    iget-object v3, v3, Lcom/android/camera2/y4;->mSavePath:Ljava/lang/String;
    ...
    new-instance v1, Lcom/android/camera2/o4;

    invoke-direct {v1, p0}, Lcom/android/camera2/o4;-><init>(Lcom/android/camera2/r4$a;)V
...
.method public onImageReceived(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    iput-object p1, v0, Lcom/android/camera2/r4;->n:Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;

    iget-object v1, v0, Lcom/android/camera2/y4;->mButtonStatus:Li6/a;
    ...
    new-instance v2, Lcom/android/camera2/p4;

    invoke-direct {v2, p0, p1}, Lcom/android/camera2/p4;-><init>(Lcom/android/camera2/r4$a;Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V

    new-instance p1, Lcom/android/camera2/q4;

    invoke-direct {p1, p0}, Lcom/android/camera2/q4;-><init>(Lcom/android/camera2/r4$a;)V

    invoke-virtual {v1, v2, p1, v0}, Li6/a;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V

    goto :goto_1

    :cond_1
    invoke-virtual {v0, p1}, Lcom/android/camera2/r4;->y(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
