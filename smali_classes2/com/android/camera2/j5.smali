...
# instance fields
.field public final a:Lcom/android/camera2/b6;
...
.method public constructor <init>(Lcom/android/camera2/k4;Landroid/hardware/camera2/CaptureResult;Li6/a;)V
    ...
    iput p3, p0, Lcom/android/camera2/j5;->h:I

    const/4 p3, -0x1

    iput p3, p0, Lcom/android/camera2/j5;->m:I
    ...
    iput-object p1, p0, Lcom/android/camera2/j5;->a:Lcom/android/camera2/b6;

    return-void
.end method

.method public static synthetic h(Lcom/android/camera2/j5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/j5;->e:I

    return p0
.end method

.method public static synthetic i(Lcom/android/camera2/j5;)I
    .locals 2

    iget v0, p0, Lcom/android/camera2/j5;->e:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lcom/android/camera2/j5;->e:I

    return v0
.end method

.method public static synthetic j(Lcom/android/camera2/j5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/j5;->c:I

    return p0
.end method

.method public static synthetic k(Lcom/android/camera2/j5;)I
    .locals 0
...
.method public static synthetic l(Lcom/android/camera2/j5;)Landroid/util/Size;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/j5;->l:Landroid/util/Size;

    return-object p0
.end method

.method public static synthetic m(Lcom/android/camera2/j5;)Lwd/w;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/j5;->n:Lwd/w;

    return-object p0
.end method

.method public static synthetic n(Lcom/android/camera2/j5;Lwd/w;)Lwd/w;
    .locals 0

    iput-object p1, p0, Lcom/android/camera2/j5;->n:Lwd/w;

    return-object p1
.end method

.method public static synthetic o(Lcom/android/camera2/j5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/j5;->d:I

    return p0
.end method

.method public static synthetic p(Lcom/android/camera2/j5;)I
    .locals 2

    iget v0, p0, Lcom/android/camera2/j5;->d:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lcom/android/camera2/j5;->d:I

    return v0
.end method

.method public static synthetic q(Lcom/android/camera2/j5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/j5;->m:I
...
.method public generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-static {v2}, Lcom/android/camera2/g;->w5(Lcom/android/camera2/f;)Z
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/camera2/j5;->j:Landroid/view/Surface;
    ...
    invoke-virtual {v8}, Lcom/android/camera2/a;->v()I
    ...
    invoke-virtual {v4}, Lcom/android/camera2/k4;->S()Z
    ...
    iget-object v4, p0, Lcom/android/camera2/j5;->i:Landroid/view/Surface;
    ...
    invoke-virtual {v8}, Lcom/android/camera2/r5;->c0()Landroid/view/Surface;
    ...
    iget-object v9, p0, Lcom/android/camera2/j5;->k:Landroid/util/Size;

    invoke-virtual {p0, v4, v9, v8, v2}, Lcom/android/camera2/f5;->configParallelSession(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v2

    iput-object v2, p0, Lcom/android/camera2/f5;->mBufferFormat:Lcom/xiaomi/engine/BufferFormat;

    goto :goto_2

    :cond_5
    iget-object v4, p0, Lcom/android/camera2/j5;->k:Landroid/util/Size;

    invoke-virtual {p0, v4, v8, v2}, Lcom/android/camera2/f5;->configParallelSession(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->u3()Z
    ...
    invoke-virtual {v9}, Lcom/android/camera2/k4;->C()I
    ...
    invoke-virtual {v2, v0, v6}, Lcom/android/camera2/k4;->b3(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget v2, p0, Lcom/android/camera2/j5;->c:I
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->P()I
    ...
    :cond_e
    iget-object v1, p0, Lcom/android/camera2/j5;->a:Lcom/android/camera2/b6;
    ...
    invoke-static {v0, p0, v1}, Lcom/android/camera2/r3;->v1(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/f;Ljava/lang/String;)V
...
.method public prepare()V
    ...
    iget-boolean v0, p0, Lcom/android/camera2/j5;->g:Z

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/android/camera2/j5;->s()V
    ...
    iget-object v0, p0, Lcom/android/camera2/j5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    invoke-virtual {v0}, Lcom/xiaomi/camera/imagecodec/FeatureSetting;->getFrameCount()I

    move-result v0

    iput v0, p0, Lcom/android/camera2/j5;->c:I
    ...
    iget v0, p0, Lcom/android/camera2/j5;->h:I
...
.method public final s()V
    ...
    iget-object v1, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/r5;->Q()Landroid/view/Surface;

    move-result-object v1

    iput-object v1, v0, Lcom/android/camera2/j5;->j:Landroid/view/Surface;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object v1, v0, Lcom/android/camera2/j5;->j:Landroid/view/Surface;

    const/4 v3, 0x1

    if-nez v1, :cond_0

    iput-boolean v3, v0, Lcom/android/camera2/j5;->g:Z
    ...
    invoke-virtual {v5}, Lcom/android/camera2/k4;->n4()Z
    ...
    invoke-virtual {v5}, Lcom/android/camera2/k4;->X()Z
    ...
    invoke-virtual {v5}, Lcom/android/camera2/k4;->H()I
    ...
    iget-object v6, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;
    ...
    invoke-virtual {v7}, Lcom/android/camera2/k4;->s4()Z

    move-result v7

    invoke-virtual {v6, v5, v7}, Lcom/android/camera2/r5;->C(IZ)Landroid/view/Surface;

    move-result-object v6

    iput-object v6, v0, Lcom/android/camera2/j5;->i:Landroid/view/Surface;
    ...
    :cond_6
    iput v5, v0, Lcom/android/camera2/j5;->m:I

    iget-object v6, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    invoke-virtual {v6}, Lcom/android/camera2/k4;->s4()Z

    move-result v6

    invoke-virtual {v1, v5, v6}, Lcom/android/camera2/l3;->f(IZ)Lcom/android/camera/i3;

    move-result-object v6

    invoke-virtual {v6}, Lcom/android/camera/i3;->h()Landroid/util/Size;

    move-result-object v6

    iput-object v6, v0, Lcom/android/camera2/j5;->l:Landroid/util/Size;

    iget-object v6, v0, Lcom/android/camera2/j5;->i:Landroid/view/Surface;

    invoke-static {v6}, Landroid/hardware/camera2/utils/SurfaceUtils;->getSurfaceSize(Landroid/view/Surface;)Landroid/util/Size;

    move-result-object v6

    iput-object v6, v0, Lcom/android/camera2/j5;->k:Landroid/util/Size;
    ...
    iget-object v8, v0, Lcom/android/camera2/j5;->l:Landroid/util/Size;
    ...
    iget-object v8, v0, Lcom/android/camera2/j5;->k:Landroid/util/Size;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/l3;->J0()Lcom/android/camera/i3;

    move-result-object v6

    if-nez v6, :cond_7

    iget-object v7, v0, Lcom/android/camera2/j5;->k:Landroid/util/Size;
    ...
    :goto_5
    iget-object v9, v0, Lcom/android/camera2/j5;->k:Landroid/util/Size;
    ...
    :cond_9
    iget-object v9, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/l3;->K0()I

    move-result v9

    invoke-direct {v6, v7, v8, v9}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;-><init>(III)V

    iget-object v7, v0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {}, Lp6/a;->a()Lp6/a;

    move-result-object v8

    invoke-virtual {v8}, Lp6/a;->b()Lcom/android/camera/b4$b;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/l3;->P()I
    ...
    invoke-static {v7}, Lcom/android/camera2/s3;->j0(Landroid/hardware/camera2/CaptureResult;)Ljava/lang/Integer;
    ...
    :goto_6
    iput-boolean v13, v0, Lcom/android/camera2/j5;->b:Z
    ...
    :cond_e
    iput-boolean v3, v0, Lcom/android/camera2/j5;->b:Z
    ...
    :goto_7
    iget-object v13, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    invoke-static {v7}, Ltd/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;

    move-result-object v4

    invoke-virtual {v1}, Lcom/android/camera2/l3;->W()J
    ...
    :cond_11
    :goto_8
    iget-object v3, v0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    sget-object v9, Ll9/ds;->U1:Ll9/es;

    invoke-static {v3, v9}, Ll9/fs;->l(Landroid/hardware/camera2/CaptureResult;Ll9/es;)Ljava/lang/Object;
    ...
    :goto_9
    iget-object v10, v0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    sget-object v12, Ll9/ds;->T1:Ll9/es;

    invoke-static {v10, v12}, Ll9/fs;->l(Landroid/hardware/camera2/CaptureResult;Ll9/es;)Ljava/lang/Object;
    ...
    :cond_13
    iget-object v12, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/camera2/g;->v5(Lcom/android/camera2/f;)Z
    ...
    iget-object v3, v0, Lcom/android/camera2/j5;->k:Landroid/util/Size;

    iget-object v7, v0, Lcom/android/camera2/j5;->l:Landroid/util/Size;
    ...
    invoke-virtual {v8, v2, v4, v1, v3}, Lcom/android/camera/b4$b;->G(Lcom/xiaomi/camera/isp/IspInterfaceIO;Landroid/os/Parcelable;Lcom/xiaomi/camera/imagecodec/QueryFeatureSettingParameter;Z)Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    move-result-object v1

    iput-object v1, v0, Lcom/android/camera2/j5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    iget-object v3, v0, Lcom/android/camera2/j5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    iput-boolean v1, v0, Lcom/android/camera2/j5;->g:Z
...
.method public startSessionCapture()V
    ...
    :cond_0
    iget-object v3, p0, Lcom/android/camera2/j5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    :goto_0
    iget v6, p0, Lcom/android/camera2/j5;->c:I
    ...
    invoke-virtual {v5}, Lcom/android/camera2/l3;->C2()Z
    ...
    iget-object v7, p0, Lcom/android/camera2/j5;->l:Landroid/util/Size;

    invoke-virtual {v7}, Landroid/util/Size;->getWidth()I

    move-result v7

    iget-object v8, p0, Lcom/android/camera2/j5;->l:Landroid/util/Size;
    ...
    invoke-virtual {p0, v2, v6, v3}, Lcom/android/camera2/f5;->generatePreProcessData(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-virtual {p0, v2}, Lcom/android/camera2/f5;->preCapture(Lcom/xiaomi/engine/PreProcessData;)V
...
.method public t()Z
    ...
    invoke-static {v0}, Lcom/android/camera2/s3;->h0(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/camera2/j5;->f:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
