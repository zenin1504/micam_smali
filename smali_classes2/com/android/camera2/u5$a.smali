.class public Lcom/android/camera2/u5$a;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/camera2/u5;->generateCaptureCallback()Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
.end annotation
...
# instance fields
.field public final synthetic a:Lcom/android/camera2/u5;


# direct methods
.method public constructor <init>(Lcom/android/camera2/u5;)V
    .locals 0

    iput-object p1, p0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;
...
.method public final a()V
    ...
    iget-object v0, p0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;
    ...
    :cond_0
    invoke-static {v0}, Lcom/android/camera2/u5;->j(Lcom/android/camera2/u5;)I
    ...
    iget-object v4, p0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    invoke-virtual {v4}, Lcom/android/camera2/y4;->isQuickShotAnimation()Z

    move-result v5

    iget-object p0, p0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;
...
.method public onCaptureBufferLost(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/view/Surface;J)V
    ...
    iget-object p1, p0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;
...
.method public onCaptureCompleted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/TotalCaptureResult;)V
    ...
    invoke-static {p1}, Lcom/android/camera2/u5;->n(Lcom/android/camera2/u5;)I
    ...
    invoke-static {v0}, Lcom/android/camera2/u5;->m(Lcom/android/camera2/u5;)I
    ...
    iget-object p3, p0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    invoke-static {p3}, Lcom/android/camera2/u5;->m(Lcom/android/camera2/u5;)I
    ...
    invoke-static {p1}, Lcom/android/camera2/u5;->j(Lcom/android/camera2/u5;)I

    move-result p1

    iget-object p2, p0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    invoke-static {p2}, Lcom/android/camera2/u5;->m(Lcom/android/camera2/u5;)I

    move-result p2

    if-ne p1, p2, :cond_1

    invoke-virtual {p0}, Lcom/android/camera2/u5$a;->a()V
...
.method public onCaptureStarted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;JJ)V
    ...
    iget-object v1, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;
    ...
    iget-object v5, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;
    ...
    invoke-static {v1}, Lcom/android/camera2/u5;->i(Lcom/android/camera2/u5;)I
    ...
    invoke-static {v1}, Lcom/android/camera2/u5;->h(Lcom/android/camera2/u5;)I

    move-result v1

    iget-object v2, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    invoke-static {v2}, Lcom/android/camera2/u5;->j(Lcom/android/camera2/u5;)I
    ...
    invoke-virtual {v13, v1}, Lwd/w;->N0(Z)V

    new-instance v2, Lcom/android/camera2/t3$b;

    iget-object v3, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    iget-object v3, v3, Lcom/android/camera2/f5;->mAlgoSize:Lcom/android/camera/i3;

    invoke-direct {v2, v3}, Lcom/android/camera2/t3$b;-><init>(Lcom/android/camera/i3;)V

    iget-object v3, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    iget-boolean v4, v3, Lcom/android/camera2/y4;->mAnchorFrame:Z

    if-eqz v4, :cond_2

    iget v5, v3, Lcom/android/camera2/y4;->mSoundTime:I
    ...
    iget-object v3, v3, Lcom/android/camera2/y4;->mButtonStatus:Li6/a;
    ...
    invoke-virtual {v2, v6}, Lcom/android/camera2/t3$b;->b(Lcom/android/camera2/w5;)Lcom/android/camera2/t3$b;

    move-result-object v2

    iget-object v3, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    iget v3, v3, Lcom/android/camera2/y4;->mSatCameraId:I

    invoke-virtual {v2, v3}, Lcom/android/camera2/t3$b;->c(I)Lcom/android/camera2/t3$b;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/camera2/t3$b;->a()Lcom/android/camera2/t3;

    move-result-object v2

    invoke-interface {v12, v13, v2}, Lcom/android/camera2/a$l;->onCaptureStart(Lwd/w;Lcom/android/camera2/t3;)Lwd/w;
    ...
    iget-object v3, v3, Lcom/android/camera2/f5;->mCaptureId:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lwd/w;->H0(Ljava/lang/String;)V

    iget-object v3, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    invoke-static {v3}, Lcom/android/camera2/u5;->j(Lcom/android/camera2/u5;)I

    move-result v3

    invoke-virtual {v2, v3}, Lwd/w;->E0(I)V

    iget-object v3, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    invoke-static {v3}, Lcom/android/camera2/u5;->k(Lcom/android/camera2/u5;)I

    move-result v3

    invoke-virtual {v2, v3}, Lwd/w;->B0(I)V

    iget-object v3, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    iget-object v3, v3, Lcom/android/camera2/f5;->mBufferFormat:Lcom/xiaomi/engine/BufferFormat;

    invoke-virtual {v2, v3}, Lwd/w;->J0(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {v3}, Lwd/x;->r0()Lwd/z;

    move-result-object v3

    if-eqz v3, :cond_3

    invoke-virtual {v3, v1}, Lwd/z;->K(Z)V

    iget-object v0, v0, Lcom/android/camera2/u5$a;->a:Lcom/android/camera2/u5;

    invoke-static {v0}, Lcom/android/camera2/u5;->l(Lcom/android/camera2/u5;)[I

    move-result-object v0

    invoke-virtual {v3, v0}, Lwd/z;->L([I)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/b4$b;->z(Lwd/w;)V
