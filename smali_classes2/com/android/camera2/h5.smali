...
.field public F:Lcom/android/camera2/b6;
...
.field public o:Lm9/s;

.field public p:[I

.field public q:Lbk/c;
...
# direct methods
.method public constructor <init>(Lcom/android/camera2/k4;Landroid/hardware/camera2/CaptureResult;ZILbk/c;Li6/a;Z)V
    .locals 1
    .param p5    # Lbk/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iput p6, p0, Lcom/android/camera2/h5;->j:I

    iput-boolean p6, p0, Lcom/android/camera2/h5;->r:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/camera2/h5;->s:Landroid/view/Surface;

    iput-object v0, p0, Lcom/android/camera2/h5;->t:Landroid/view/Surface;

    const/4 v0, -0x1

    iput v0, p0, Lcom/android/camera2/h5;->v:I

    iput v0, p0, Lcom/android/camera2/h5;->w:I

    iput v0, p0, Lcom/android/camera2/h5;->x:I

    iput v0, p0, Lcom/android/camera2/h5;->y:I

    iput-boolean p6, p0, Lcom/android/camera2/h5;->A:Z

    iput-boolean p3, p0, Lcom/android/camera2/h5;->h:Z

    iput-object p2, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    iput p4, p0, Lcom/android/camera2/h5;->z:I
    ...
    iput-object p5, p0, Lcom/android/camera2/h5;->q:Lbk/c;

    iput-boolean p7, p0, Lcom/android/camera2/h5;->C:Z

    invoke-virtual {p1}, Lcom/android/camera2/k4;->L()Lcom/android/camera2/b6;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera2/h5;->F:Lcom/android/camera2/b6;
...
.method private synthetic P(I)Z
    ...
    iget p0, p0, Lcom/android/camera2/h5;->x:I
...
.method public static synthetic h(Lcom/android/camera2/h5;I)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera2/h5;->P(I)Z
...
.method public static synthetic i(Lcom/android/camera2/h5;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/camera2/h5;->h:Z

    return p0
.end method

.method public static synthetic j(Lcom/android/camera2/h5;)I
    .locals 0
...
.method public static synthetic k(Lcom/android/camera2/h5;)Z
    .locals 0

    invoke-virtual {p0}, Lcom/android/camera2/h5;->O()Z
...
.method public static synthetic l(Lcom/android/camera2/h5;)I
    .locals 2

    iget v0, p0, Lcom/android/camera2/h5;->e:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lcom/android/camera2/h5;->e:I

    return v0
.end method

.method public static synthetic m(Lcom/android/camera2/h5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/h5;->v:I

    return p0
.end method

.method public static synthetic n(Lcom/android/camera2/h5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/h5;->w:I

    return p0
.end method

.method public static synthetic o(Lcom/android/camera2/h5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/h5;->b:I

    return p0
.end method

.method public static synthetic p(Lcom/android/camera2/h5;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/camera2/h5;->r:Z

    return p0
.end method

.method public static synthetic q(Lcom/android/camera2/h5;)Lbk/c;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/h5;->q:Lbk/c;

    return-object p0
.end method

.method public static synthetic r(Lcom/android/camera2/h5;)I
    .locals 0

    iget p0, p0, Lcom/android/camera2/h5;->j:I

    return p0
.end method

.method public static synthetic s(Lcom/android/camera2/h5;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/camera2/h5;->i:Z

    return p0
.end method

.method public static synthetic t(Lcom/android/camera2/h5;)I
    .locals 0
...
.method public static synthetic u(Lcom/android/camera2/h5;)[I
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/h5;->k:[I

    return-object p0
.end method

.method public static synthetic v(Lcom/android/camera2/h5;)I
    .locals 0
...
.method public static synthetic w(Lcom/android/camera2/h5;)I
    .locals 2

    iget v0, p0, Lcom/android/camera2/h5;->d:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lcom/android/camera2/h5;->d:I
...
.method public final A(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    iget-boolean v0, p0, Lcom/android/camera2/h5;->f:Z
...
.method public final B(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v0, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v0}, Lcom/android/camera2/s3;->x(Landroid/hardware/camera2/CaptureResult;)[I

    move-result-object v0

    iget v1, p0, Lcom/android/camera2/h5;->b:I
    ...
    iget-object v1, p0, Lcom/android/camera2/h5;->k:[I
    ...
    :goto_1
    iget-boolean v3, p0, Lcom/android/camera2/h5;->g:Z
    ...
    :goto_3
    iget v3, p0, Lcom/android/camera2/h5;->j:I
    ...
    :cond_5
    iget v3, p0, Lcom/android/camera2/h5;->b:I
    ...
    :goto_4
    iget-object v3, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v3}, Lcom/android/camera2/s3;->l0(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    :cond_7
    invoke-static {p1, v4}, Lcom/android/camera2/r3;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    :goto_7
    invoke-static {p1, v3}, Lcom/android/camera2/r3;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    :cond_c
    :goto_8
    iget v3, p0, Lcom/android/camera2/h5;->l:I
    ...
    invoke-static {v3}, Lcom/android/camera2/g;->P(Lcom/android/camera2/f;)B
    ...
    sget-object v3, Ll9/fk;->G4:Ll9/es;
    ...
    invoke-static {p1, v3, v0}, Ll9/fs;->p(Landroid/hardware/camera2/CaptureRequest$Builder;Ll9/es;Ljava/lang/Object;)V

    :cond_f
    iget v0, p0, Lcom/android/camera2/h5;->l:I

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    iget v3, p0, Lcom/android/camera2/h5;->m:I
    ...
    iget-boolean v0, p0, Lcom/android/camera2/h5;->A:Z
    ...
    iget-object v0, p0, Lcom/android/camera2/h5;->G:[B
    ...
    invoke-virtual {v0}, Lbb/c;->R9()Z

    move-result v0

    if-eqz v0, :cond_12

    iget-object v0, p0, Lcom/android/camera2/h5;->B:[I
    ...
    invoke-virtual {v7}, Lcom/android/camera2/k4;->q()Lcom/android/camera2/f;

    move-result-object v7

    invoke-static {v7}, Lcom/android/camera2/g;->q(Lcom/android/camera2/f;)I
    ...
    invoke-virtual {v8}, Lcom/android/camera2/a;->T()Z
    ...
    invoke-virtual {v8}, Lcom/android/camera2/k4;->s()Lcom/android/camera2/l3;

    move-result-object v8

    invoke-virtual {v8}, Lcom/android/camera2/l3;->A2()Z
    ...
    invoke-virtual {v8}, Lcom/android/camera2/k4;->q()Lcom/android/camera2/f;

    move-result-object v8

    iget-object v9, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v8, v9}, Lcom/android/camera2/s3;->b0(Lcom/android/camera2/f;Landroid/hardware/camera2/CaptureResult;)Z
    ...
    iget v8, p0, Lcom/android/camera2/h5;->b:I
    ...
    iget v7, p0, Lcom/android/camera2/h5;->b:I
    ...
    :cond_1f
    iget-boolean v6, p0, Lcom/android/camera2/h5;->n:Z
    ...
    invoke-static {v0}, Lcom/android/camera2/g;->s6(Lcom/android/camera2/f;)Z
    ...
    iget v0, p0, Lcom/android/camera2/h5;->b:I
    ...
    iget v0, p0, Lcom/android/camera2/h5;->j:I
    ...
    iget v0, p0, Lcom/android/camera2/h5;->a:I
    ...
    invoke-virtual {v0}, Lcom/android/camera2/a;->U()Z
    ...
    :cond_2b
    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/h5;->H(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
...
.method public final C(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget p2, p0, Lcom/android/camera2/h5;->b:I
...
.method public final D(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v4, p0, Lcom/android/camera2/h5;->o:Lm9/s;
    ...
    invoke-static {p1, v6}, Lcom/android/camera2/r3;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    iget-object v1, p0, Lcom/android/camera2/h5;->o:Lm9/s;
    ...
    invoke-virtual {v0}, Lcom/android/camera2/f;->E()Landroid/hardware/camera2/CameraCharacteristics;

    move-result-object v0

    sget-object v1, Ll9/q8;->N3:Ll9/es;

    invoke-static {v0, v1}, Ll9/fs;->i(Landroid/hardware/camera2/CameraCharacteristics;Ll9/es;)Ljava/lang/Object;
    ...
    :goto_1
    iget-object v0, p0, Lcom/android/camera2/h5;->p:[I
    ...
    iget v4, p0, Lcom/android/camera2/h5;->z:I
    ...
    :cond_7
    :goto_3
    iget v0, p0, Lcom/android/camera2/h5;->c:I
    ...
    iget-object v0, p0, Lcom/android/camera2/h5;->o:Lm9/s;

    invoke-virtual {v0}, Lm9/s;->c()[I
    ...
    invoke-virtual {p2}, Lcom/android/camera2/k4;->Y3()Lcom/android/camera2/r5;
...
.method public final E(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v2, p0, Lcom/android/camera2/h5;->F:Lcom/android/camera2/b6;
    ...
    iget-boolean v2, v2, Lcom/android/camera2/b6$a;->l:Z
    ...
    iget v2, p0, Lcom/android/camera2/h5;->b:I
    ...
    :cond_3
    iget-object v2, p0, Lcom/android/camera2/h5;->k:[I

    if-eqz v2, :cond_7

    iget-boolean v2, p0, Lcom/android/camera2/h5;->i:Z
    ...
    iget v3, p0, Lcom/android/camera2/h5;->x:I
    ...
    iget v3, p0, Lcom/android/camera2/h5;->y:I
    ...
    iget v2, p0, Lcom/android/camera2/h5;->y:I
    ...
    iget-object v5, p0, Lcom/android/camera2/h5;->k:[I
    ...
    :goto_1
    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/h5;->V(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
...
.method public final G(Lcom/android/camera2/l3;I)V
    .locals 4

    invoke-virtual {p1}, Lcom/android/camera2/l3;->S1()Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/camera2/h5;->g:Z
    ...
    iput p1, p0, Lcom/android/camera2/h5;->j:I

    xor-int/lit8 p1, v0, 0x1

    iput-boolean p1, p0, Lcom/android/camera2/h5;->i:Z

    invoke-virtual {p0, p1}, Lcom/android/camera2/h5;->T(Z)V
    ...
    :cond_3
    iput v2, p0, Lcom/android/camera2/h5;->j:I
...
.method public final H(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v2, v2, Lcom/android/camera2/r5;->f:Landroid/media/ImageReader;
    ...
    :cond_2
    invoke-static {v1}, Lcom/android/camera2/g;->V2(Lcom/android/camera2/f;)Z
    ...
    :cond_5
    invoke-static {v1}, Lcom/android/camera2/g;->W2(Lcom/android/camera2/f;)Z
    ...
    iget-boolean p2, p0, Lcom/android/camera2/h5;->E:Z
    ...
    iget-boolean v2, p0, Lcom/android/camera2/h5;->E:Z
...
.method public final I()Z
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->I2()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera2/h5;->F()Z
    ...
    iget v5, p0, Lcom/android/camera2/h5;->j:I
    ...
    iget-boolean v5, p0, Lcom/android/camera2/h5;->r:Z
...
.method public final J()V
    ...
    iget-object v0, p0, Lcom/android/camera2/h5;->F:Lcom/android/camera2/b6;
    ...
    iget-boolean v1, v0, Lcom/android/camera2/b6$a;->w:Z

    iput-boolean v1, p0, Lcom/android/camera2/h5;->n:Z
    ...
    iget-boolean v3, p0, Lcom/android/camera2/h5;->n:Z
    ...
    iget-boolean v1, v0, Lcom/android/camera2/b6$a;->s:Z

    iput-boolean v1, p0, Lcom/android/camera2/h5;->A:Z
    ...
    iget-boolean v4, p0, Lcom/android/camera2/h5;->A:Z
    ...
    iget-object v1, v0, Lcom/android/camera2/b6$a;->t:[I

    iput-object v1, p0, Lcom/android/camera2/h5;->B:[I

    iget v1, v0, Lcom/android/camera2/b6$a;->c:I

    iput v1, p0, Lcom/android/camera2/h5;->b:I

    iget v1, v0, Lcom/android/camera2/b6$a;->d:I

    iput v1, p0, Lcom/android/camera2/h5;->c:I

    iget-object v1, v0, Lcom/android/camera2/b6$a;->p:[I

    iput-object v1, p0, Lcom/android/camera2/h5;->k:[I

    iget v1, v0, Lcom/android/camera2/b6$a;->x:I

    iput v1, p0, Lcom/android/camera2/h5;->a:I

    iget v1, v0, Lcom/android/camera2/b6$a;->q:I

    iput v1, p0, Lcom/android/camera2/h5;->l:I

    iget v1, v0, Lcom/android/camera2/b6$a;->r:I

    iput v1, p0, Lcom/android/camera2/h5;->m:I
    ...
    iget v4, p0, Lcom/android/camera2/h5;->l:I
    ...
    iget v4, p0, Lcom/android/camera2/h5;->m:I
    ...
    iget-object v4, p0, Lcom/android/camera2/h5;->k:[I
    ...
    iget v1, v0, Lcom/android/camera2/b6$a;->u:I

    iput v1, p0, Lcom/android/camera2/h5;->x:I

    iget v1, v0, Lcom/android/camera2/b6$a;->v:I

    iput v1, p0, Lcom/android/camera2/h5;->y:I

    invoke-static {v0}, Lcom/android/camera2/b6;->b(Lcom/android/camera2/b6$a;)Z

    move-result v1

    iput-boolean v1, p0, Lcom/android/camera2/h5;->r:Z

    iget-object v1, v0, Lcom/android/camera2/b6$a;->f:Lbk/c;

    iput-object v1, p0, Lcom/android/camera2/h5;->q:Lbk/c;

    iget-object v0, v0, Lcom/android/camera2/b6$a;->z:[B

    iput-object v0, p0, Lcom/android/camera2/h5;->G:[B
...
.method public final K()I
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->C1()F

    move-result v2

    invoke-static {v1, v0, v2}, Lcom/android/camera/j6;->K2(Lcom/android/camera2/a;Ljava/util/HashMap;F)Z
    ...
    invoke-static {v0}, Lcom/android/camera2/s3;->C(Landroid/hardware/camera2/CaptureResult;)I
...
.method public final L()V
    ...
    invoke-virtual {v3}, Lcom/android/camera2/l3;->J0()Lcom/android/camera/i3;
    ...
    :cond_0
    invoke-virtual {v3}, Lcom/android/camera/i3;->e()I
    ...
    :cond_1
    invoke-virtual {v3}, Lcom/android/camera/i3;->c()I
    ...
    invoke-virtual {v6}, Lcom/android/camera2/l3;->K0()I
    ...
    invoke-virtual {v4}, Lp6/a;->b()Lcom/android/camera/b4$b;

    move-result-object v4

    iget-object v5, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-static {v5}, Ltd/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;

    move-result-object v0

    const/4 v2, 0x0

    invoke-virtual {v4, v6, v0, v2, v1}, Lcom/android/camera/b4$b;->G(Lcom/xiaomi/camera/isp/IspInterfaceIO;Landroid/os/Parcelable;Lcom/xiaomi/camera/imagecodec/QueryFeatureSettingParameter;Z)Lcom/xiaomi/camera/imagecodec/FeatureSetting;
...
.method public final N()Z
    ...
    invoke-static {v0}, Lcom/android/camera2/g;->R2(Lcom/android/camera2/f;)Z
...
.method public final Q()V
    ...
    iput v0, p0, Lcom/android/camera2/h5;->b:I
...
.method public final R(Ljava/lang/Integer;)V
    ...
    invoke-virtual {v3}, Lcom/android/camera2/l3;->M1()Z
    ...
    invoke-virtual {p1}, Lcom/android/camera2/l3;->M1()Z
    ...
    invoke-virtual {p1}, Lcom/android/camera2/l3;->v()Lcom/android/camera/fragment/beauty/d0;
    ...
    invoke-virtual {p1}, Lcom/android/camera/fragment/beauty/d0;->h()Z
    ...
    iput p1, p0, Lcom/android/camera2/h5;->b:I

    iput p1, p0, Lcom/android/camera2/h5;->c:I
    ...
    invoke-static {p1, v0}, Lcom/android/camera2/s3;->w(Lcom/android/camera2/f;Landroid/hardware/camera2/CaptureResult;)I
...
.method public final S()V
    ...
    invoke-virtual {v1, v0}, Lcom/android/camera2/k4;->E1(Lcom/android/camera2/f;)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/camera2/h5;->n:Z
    ...
    invoke-virtual {v3}, Lcom/android/camera2/a;->U()Z
    ...
    iget-boolean v5, p0, Lcom/android/camera2/h5;->n:Z
    ...
    iput-boolean v3, p0, Lcom/android/camera2/h5;->A:Z
    ...
    iget-boolean v5, p0, Lcom/android/camera2/h5;->A:Z
    ...
    invoke-static {v3}, Lcom/android/camera2/s3;->y(Landroid/hardware/camera2/CaptureResult;)[I
    ...
    iget-boolean v4, p0, Lcom/android/camera2/h5;->n:Z

    const/4 v5, 0x0

    if-eqz v4, :cond_5

    iput-object v5, p0, Lcom/android/camera2/h5;->B:[I
    ...
    iput-object v0, p0, Lcom/android/camera2/h5;->k:[I
    ...
    invoke-static {v0}, Lcom/android/camera2/s3;->B(Landroid/hardware/camera2/CaptureResult;)[B

    move-result-object v0

    new-instance v1, Lm9/h;

    invoke-direct {v1, v0}, Lm9/h;-><init>([B)V

    invoke-virtual {v1}, Lm9/h;->c()I

    move-result v0

    iput v0, p0, Lcom/android/camera2/h5;->a:I
    ...
    :cond_6
    iput-object v3, p0, Lcom/android/camera2/h5;->B:[I
    ...
    invoke-static {v0}, Lcom/android/camera2/s3;->A(Landroid/hardware/camera2/CaptureResult;)I

    move-result v0

    iput v0, p0, Lcom/android/camera2/h5;->l:I

    iget-object v0, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v0}, Lcom/android/camera2/s3;->z(Landroid/hardware/camera2/CaptureResult;)I

    move-result v0

    iput v0, p0, Lcom/android/camera2/h5;->m:I
...
.method public final T(Z)V
    ...
    invoke-static {v0}, Lcom/android/camera2/s3;->y(Landroid/hardware/camera2/CaptureResult;)[I
    ...
    invoke-static {v3}, Lcom/android/camera2/s3;->B(Landroid/hardware/camera2/CaptureResult;)[B

    move-result-object v3

    iget-object v4, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v4}, Lcom/android/camera2/s3;->E(Landroid/hardware/camera2/CaptureResult;)[B
    ...
    invoke-direct {v5, v3, p1, v4}, Lm9/h;-><init>([BZ[B)V
    ...
    invoke-virtual {v5}, Lm9/h;->d()I

    move-result p1

    iput p1, p0, Lcom/android/camera2/h5;->b:I

    invoke-virtual {v5}, Lm9/h;->b()[I

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera2/h5;->k:[I
    ...
    :cond_1
    iput-object v0, p0, Lcom/android/camera2/h5;->B:[I
    ...
    iput-object p1, p0, Lcom/android/camera2/h5;->B:[I

    :goto_2
    iget-object p1, p0, Lcom/android/camera2/h5;->k:[I
    ...
    new-instance v0, Lcom/android/camera2/g5;

    invoke-direct {v0, p0}, Lcom/android/camera2/g5;-><init>(Lcom/android/camera2/h5;)V
    ...
    iput p1, p0, Lcom/android/camera2/h5;->y:I
    ...
    :cond_3
    iget-object p1, p0, Lcom/android/camera2/h5;->q:Lbk/c;
    ...
    invoke-virtual {p1}, Lbb/c;->w1()I

    move-result p1

    const-string v3, "camera.sr.framecount"

    invoke-static {v3, p1}, Laf/e;->e(Ljava/lang/String;I)I
    ...
    invoke-virtual {p1}, Lbk/c;->d()I

    move-result p1

    iget-object v1, p0, Lcom/android/camera2/h5;->q:Lbk/c;

    invoke-virtual {v1}, Lbk/c;->e()I
...
.method public final U()V
    ...
    invoke-virtual {v0}, Lm9/n;->d()Lm9/s;

    move-result-object v0

    iput-object v0, p0, Lcom/android/camera2/h5;->o:Lm9/s;
    ...
    invoke-virtual {v0}, Lcom/android/camera2/l3;->v0()[B
    ...
    invoke-static {v0}, Lcom/android/camera2/s3;->U(Landroid/hardware/camera2/CaptureResult;)[B
    ...
    invoke-static {v0, v1, v2}, Lm9/s;->d([BLjava/lang/String;Z)Lm9/s;
    ...
    iget-object v2, p0, Lcom/android/camera2/h5;->o:Lm9/s;
    ...
    invoke-virtual {v0}, Lcom/android/camera2/l3;->F0()I

    move-result v0

    iput v0, p0, Lcom/android/camera2/h5;->D:I

    iget-object v0, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v0}, Lcom/android/camera2/s3;->T(Landroid/hardware/camera2/CaptureResult;)[I

    move-result-object v0

    iput-object v0, p0, Lcom/android/camera2/h5;->p:[I
    ...
    iget-object v3, p0, Lcom/android/camera2/h5;->p:[I
    ...
    invoke-virtual {p0}, Lcom/android/camera2/h5;->L()V

    :cond_2
    return-void
.end method

.method public final V(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-static {v0}, Lcom/android/camera2/g;->a(Lcom/android/camera2/f;)Z
...
.method public final W(ILandroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    iget-object v0, p0, Lcom/android/camera2/h5;->q:Lbk/c;
    ...
    iget-object v0, p0, Lcom/android/camera2/h5;->s:Landroid/view/Surface;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/camera2/h5;->t:Landroid/view/Surface;
    ...
    iget-object p1, p0, Lcom/android/camera2/h5;->t:Landroid/view/Surface;

    invoke-virtual {p2, p1}, Landroid/hardware/camera2/CaptureRequest$Builder;->removeTarget(Landroid/view/Surface;)V

    iget-object p1, p0, Lcom/android/camera2/h5;->s:Landroid/view/Surface;
...
.method public generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-boolean v1, v0, Lcom/android/camera2/h5;->h:Z
    ...
    invoke-virtual {v1}, Lcom/android/camera2/k4;->p()Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-virtual {v1}, Li6/w;->m0()Landroid/hardware/camera2/CameraDevice;
    ...
    :goto_0
    iget-object v3, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;
    ...
    iget v15, v0, Lcom/android/camera2/h5;->j:I
    ...
    invoke-virtual {v3}, Lcom/android/camera2/r5;->Q()Landroid/view/Surface;

    move-result-object v3

    iget-object v15, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    invoke-virtual {v15}, Lcom/android/camera2/k4;->s()Lcom/android/camera2/l3;

    move-result-object v15

    invoke-virtual {v15}, Lcom/android/camera2/l3;->w()Lcom/android/camera/i3;

    move-result-object v15

    iput-object v15, v0, Lcom/android/camera2/f5;->mAlgoSize:Lcom/android/camera/i3;
    ...
    iget-object v6, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/android/camera2/f5;->mLockedAlgoSize:Landroid/util/Size;

    if-eqz v2, :cond_2

    invoke-virtual {v0, v2, v11}, Lcom/android/camera2/f5;->configParallelSession(Landroid/util/Size;I)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v2

    iput-object v2, v0, Lcom/android/camera2/f5;->mBufferFormat:Lcom/xiaomi/engine/BufferFormat;

    goto :goto_1

    :cond_2
    iget v2, v0, Lcom/android/camera2/h5;->j:I

    if-eq v7, v2, :cond_3

    invoke-virtual {v0, v15, v11}, Lcom/android/camera2/f5;->configParallelSession(Landroid/util/Size;I)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_4
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera2/f5;->isIn3OrMoreSatMode()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera2/f5;->isInMultiSurfaceSatMode()Z
    ...
    :cond_5
    iget-object v3, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    iget v10, v0, Lcom/android/camera2/h5;->j:I
    ...
    iget-object v10, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    invoke-virtual {v10}, Lcom/android/camera2/k4;->Y3()Lcom/android/camera2/r5;

    move-result-object v10

    invoke-virtual {v10}, Lcom/android/camera2/r5;->Q()Landroid/view/Surface;
    ...
    invoke-virtual {v10}, Lcom/android/camera2/r5;->G()Landroid/view/Surface;
    ...
    iget v15, v0, Lcom/android/camera2/h5;->z:I
    ...
    iget v10, v0, Lcom/android/camera2/h5;->z:I
    ...
    invoke-virtual {v10}, Lcom/android/camera2/r5;->a0()Landroid/view/Surface;
    ...
    invoke-virtual {v10}, Lcom/android/camera2/r5;->R()Landroid/view/Surface;
    ...
    :cond_c
    iget-boolean v10, v0, Lcom/android/camera2/h5;->g:Z
    ...
    invoke-virtual {v10}, Lcom/android/camera2/r5;->s()Landroid/view/Surface;
    ...
    :cond_d
    iget-object v10, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    iput-object v3, v0, Lcom/android/camera2/f5;->mAlgoSize:Lcom/android/camera/i3;
    ...
    iput v3, v0, Lcom/android/camera2/y4;->mSatCameraId:I

    iget v3, v0, Lcom/android/camera2/h5;->j:I
    ...
    iget v4, v0, Lcom/android/camera2/h5;->z:I
    ...
    iget v4, v0, Lcom/android/camera2/y4;->mSatCameraId:I

    invoke-virtual {v3, v4}, Lcom/android/camera2/r5;->O(I)Landroid/view/Surface;
    ...
    iget v10, v0, Lcom/android/camera2/y4;->mSatCameraId:I

    iget-object v11, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    invoke-virtual {v11}, Lcom/android/camera2/k4;->s4()Z

    move-result v11

    invoke-virtual {v3, v10, v11}, Lcom/android/camera2/r5;->C(IZ)Landroid/view/Surface;
    ...
    iput v3, v0, Lcom/android/camera2/h5;->v:I

    iget v3, v0, Lcom/android/camera2/y4;->mSatCameraId:I
    ...
    :cond_14
    iget-boolean v4, v0, Lcom/android/camera2/h5;->h:Z

    if-nez v4, :cond_1e

    iget-boolean v4, v0, Lcom/android/camera2/h5;->u:Z
    ...
    invoke-virtual {v10}, Lcom/android/camera2/k4;->s4()Z

    move-result v10

    invoke-virtual {v3, v4, v10}, Lcom/android/camera2/r5;->t(IZ)Landroid/view/Surface;

    move-result-object v3

    iget-object v4, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    invoke-virtual {v4}, Lcom/android/camera2/k4;->L3()Landroid/util/Size;

    move-result-object v4

    iget v10, v0, Lcom/android/camera2/h5;->b:I
    ...
    :cond_16
    iget-boolean v3, v0, Lcom/android/camera2/h5;->i:Z
    ...
    invoke-virtual {v3, v4, v10}, Lcom/android/camera2/r5;->V(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v10}, Lcom/android/camera2/k4;->s()Lcom/android/camera2/l3;

    move-result-object v10

    invoke-virtual {v10}, Lcom/android/camera2/l3;->y()Lm9/d;

    move-result-object v10

    if-eqz v10, :cond_18

    invoke-virtual {v10}, Lm9/d;->e()Z
    ...
    invoke-virtual {v10}, Lcom/android/camera2/l3;->C1()F
    ...
    invoke-virtual {v3}, Lcom/android/camera2/r5;->M()Landroid/view/Surface;
    ...
    :goto_7
    iget-object v7, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    invoke-virtual {v7}, Lcom/android/camera2/k4;->G()Lcom/android/camera2/f;

    move-result-object v7

    invoke-static {v7}, Lcom/android/camera2/g;->j3(Lcom/android/camera2/f;)Z

    move-result v7

    if-eqz v7, :cond_1b

    iget-boolean v7, v0, Lcom/android/camera2/h5;->u:Z
    ...
    :cond_1b
    iget v7, v0, Lcom/android/camera2/h5;->j:I
    ...
    invoke-virtual {v3}, Lcom/android/camera2/l3;->C2()Z
    ...
    invoke-virtual {v3}, Lcom/android/camera2/r5;->R()Landroid/view/Surface;
    ...
    invoke-virtual {v3, v4}, Li6/w;->o0(I)Landroid/view/Surface;
    ...
    :cond_1f
    :goto_9
    iget-object v7, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lcom/android/camera2/k4;->I()I

    move-result v7

    iput v7, v0, Lcom/android/camera2/h5;->v:I
    ...
    invoke-virtual {v7}, Lcom/android/camera2/r5;->Y()Landroid/view/Surface;
    ...
    :cond_20
    iget-boolean v7, v0, Lcom/android/camera2/h5;->h:Z
    ...
    invoke-virtual {v7, v13}, Li6/w;->o0(I)Landroid/view/Surface;
    ...
    :goto_b
    iget-boolean v7, v0, Lcom/android/camera2/h5;->r:Z
    ...
    iget-object v15, v0, Lcom/android/camera2/y4;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {v8}, Li6/g;->n()I

    move-result v8

    iput v8, v0, Lcom/android/camera2/h5;->w:I

    iput-object v7, v0, Lcom/android/camera2/h5;->t:Landroid/view/Surface;

    iput-object v3, v0, Lcom/android/camera2/h5;->s:Landroid/view/Surface;
    ...
    iget-object v3, v0, Lcom/android/camera2/h5;->q:Lbk/c;
    ...
    invoke-virtual {v0, v8, v4, v6, v7}, Lcom/android/camera2/f5;->configParallelSession(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v3

    iput-object v3, v0, Lcom/android/camera2/f5;->mBufferFormat:Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v0, v14, v4, v6, v7}, Lcom/android/camera2/f5;->configParallelSession(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v0, v3, v4, v6, v7}, Lcom/android/camera2/f5;->configParallelSession(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_27
    invoke-virtual {v0, v4, v6, v7}, Lcom/android/camera2/f5;->configParallelSession(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    iget v4, v0, Lcom/android/camera2/y4;->mOperationMode:I
    ...
    iget-boolean v2, v0, Lcom/android/camera2/h5;->h:Z

    if-nez v2, :cond_28

    iput-boolean v13, v0, Lcom/android/camera2/h5;->E:Z
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->C2()Z
    ...
    invoke-virtual {v0, v5, v3, v6, v4}, Lcom/android/camera2/f5;->configParallelSession(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v4

    iput-object v4, v0, Lcom/android/camera2/f5;->mBufferFormat:Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v4}, Lcom/android/camera2/l3;->M0()Lcom/android/camera/i3;

    move-result-object v4

    iput-object v4, v0, Lcom/android/camera2/f5;->mAlgoSize:Lcom/android/camera/i3;
    ...
    iget-object v6, v0, Lcom/android/camera2/f5;->mAlgoSize:Lcom/android/camera/i3;

    iget v7, v6, Lcom/android/camera/i3;->a:I
    ...
    invoke-virtual {v0, v4, v5, v6, v3}, Lcom/android/camera2/f5;->configParallelSession(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    iget-object v4, v0, Lcom/android/camera2/f5;->mAlgoSize:Lcom/android/camera/i3;
    ...
    iget-object v3, v0, Lcom/android/camera2/f5;->mAlgoSize:Lcom/android/camera/i3;
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/camera2/f5;->configParallelSession(Landroid/util/Size;I)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_36
    iget-boolean v2, v0, Lcom/android/camera2/h5;->C:Z

    if-eqz v2, :cond_37

    iget v2, v0, Lcom/android/camera2/h5;->z:I

    invoke-virtual {v0, v2}, Lcom/android/camera2/h5;->M(I)Z
    ...
    invoke-static {v2}, Lcom/android/camera2/g;->j4(Lcom/android/camera2/f;)Z
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->a3()Z
    ...
    invoke-virtual {v2}, Lcom/android/camera2/r5;->G()Landroid/view/Surface;
    ...
    :cond_3a
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera2/h5;->N()Z
    ...
    iget-object v5, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    invoke-virtual {v5}, Lcom/android/camera2/k4;->C()I
    ...
    invoke-virtual {v3}, Lcom/android/camera2/k4;->C()I
    ...
    invoke-static {v1, v2}, Lcom/android/camera2/r3;->l(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/l3;)V

    iget-object v2, v0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    const/4 v3, 0x3

    invoke-virtual {v2, v1, v3}, Lcom/android/camera2/k4;->b3(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget v4, v0, Lcom/android/camera2/h5;->j:I
    ...
    iget-boolean v2, v0, Lcom/android/camera2/h5;->u:Z

    if-nez v2, :cond_43

    iget-boolean v2, v0, Lcom/android/camera2/h5;->r:Z

    if-nez v2, :cond_43

    iget-boolean v2, v0, Lcom/android/camera2/h5;->i:Z
    ...
    :cond_44
    :goto_19
    iget-object v2, v0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v2}, Lcom/android/camera2/s3;->x(Landroid/hardware/camera2/CaptureResult;)[I

    move-result-object v2

    iget-boolean v3, v0, Lcom/android/camera2/h5;->g:Z
    ...
    invoke-static {v3, v1, v2}, Lcom/android/camera2/r3;->y0(Lcom/android/camera2/f;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->u2()Z
    ...
    invoke-virtual {v2}, Lcom/android/camera2/l3;->c1()Ljava/lang/String;

    move-result-object v2

    iput-object v2, v0, Lcom/android/camera2/y4;->mSavePath:Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera2/y4;->getFileName()Ljava/lang/String;
    ...
    invoke-static {v1, v3, v2}, Lcom/android/camera2/r3;->v1(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/f;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/android/camera2/l3;->c3()Z
...
.method public prepare()V
    ...
    iget v5, p0, Lcom/android/camera2/h5;->z:I
    ...
    iput-object v3, p0, Lcom/android/camera2/y4;->mPreviewSize:Lcom/android/camera/i3;

    iget-object v3, p0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    iget-object v5, p0, Lcom/android/camera2/f5;->mPreviewCaptureResult:Landroid/hardware/camera2/CaptureResult;

    invoke-virtual {v3, v5}, Lcom/android/camera2/k4;->k4(Landroid/hardware/camera2/CaptureResult;)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/camera2/h5;->u:Z

    invoke-virtual {p0}, Lcom/android/camera2/h5;->K()I
    ...
    iput v1, p0, Lcom/android/camera2/h5;->j:I

    invoke-static {}, Lbb/c;->w2()Lbb/c;

    move-result-object v1

    invoke-virtual {v1}, Lbb/c;->u0()[I
    ...
    iget v10, p0, Lcom/android/camera2/y4;->mOperationMode:I
    ...
    iget-object v5, p0, Lcom/android/camera2/h5;->F:Lcom/android/camera2/b6;
    ...
    iget-boolean v5, v5, Lcom/android/camera2/b6$a;->M:Z
    ...
    iget-object v5, v5, Lcom/android/camera2/b6;->g:Lcom/android/camera2/b6$a;

    iget-boolean v9, v5, Lcom/android/camera2/b6$a;->a:Z

    if-eqz v9, :cond_3

    iget v9, v5, Lcom/android/camera2/b6$a;->b:I

    const/4 v10, -0x1

    if-eq v9, v10, :cond_2

    iput v9, p0, Lcom/android/camera2/h5;->j:I

    iget-boolean v1, v5, Lcom/android/camera2/b6$a;->m:Z

    iput-boolean v1, p0, Lcom/android/camera2/h5;->g:Z

    iget-boolean v1, v5, Lcom/android/camera2/b6$a;->n:Z

    iput-boolean v1, p0, Lcom/android/camera2/h5;->i:Z

    invoke-virtual {p0}, Lcom/android/camera2/h5;->J()V

    goto/16 :goto_6

    :cond_2
    invoke-virtual {p0, v1, v3}, Lcom/android/camera2/h5;->G(Lcom/android/camera2/l3;I)V
    ...
    iput v6, p0, Lcom/android/camera2/h5;->j:I

    invoke-virtual {p0, v4}, Lcom/android/camera2/h5;->T(Z)V
    ...
    invoke-virtual {v3}, Lcom/android/camera2/l3;->B2()Z
    ...
    invoke-virtual {v5}, Lbb/c;->Ga()Z

    move-result v5

    if-eqz v5, :cond_7

    iput-boolean v0, p0, Lcom/android/camera2/h5;->f:Z
    ...
    :goto_1
    iput-boolean v5, p0, Lcom/android/camera2/h5;->f:Z

    :goto_2
    iget-boolean v5, p0, Lcom/android/camera2/h5;->f:Z
    ...
    invoke-virtual {v3}, Lbb/c;->Ga()Z

    move-result v3

    if-eqz v3, :cond_a

    iput v8, p0, Lcom/android/camera2/h5;->j:I

    invoke-virtual {p0, v1}, Lcom/android/camera2/h5;->R(Ljava/lang/Integer;)V
    ...
    iput v7, p0, Lcom/android/camera2/h5;->j:I

    invoke-virtual {p0}, Lcom/android/camera2/h5;->Q()V

    :cond_b
    :goto_3
    iget v1, p0, Lcom/android/camera2/h5;->j:I
    ...
    :cond_c
    :goto_4
    iget v1, p0, Lcom/android/camera2/h5;->z:I
    ...
    :goto_5
    invoke-virtual {p0}, Lcom/android/camera2/h5;->U()V

    :cond_10
    :goto_6
    invoke-virtual {p0}, Lcom/android/camera2/h5;->I()Z
    ...
    iput-boolean v4, p0, Lcom/android/camera2/h5;->E:Z
    ...
    iget v8, p0, Lcom/android/camera2/h5;->j:I
    ...
    iget-boolean v0, p0, Lcom/android/camera2/h5;->h:Z
...
.method public startSessionCapture()V
    ...
    iget v5, p0, Lcom/android/camera2/h5;->b:I
    ...
    :goto_0
    iget v4, p0, Lcom/android/camera2/h5;->b:I
    ...
    iget-boolean v4, p0, Lcom/android/camera2/h5;->u:Z
    ...
    invoke-static {v4}, Lcom/android/camera2/g;->q(Lcom/android/camera2/f;)I
    ...
    iget v4, p0, Lcom/android/camera2/h5;->j:I
    ...
    iget-object v6, p0, Lcom/android/camera2/f5;->mActiveArraySize:Landroid/graphics/Rect;

    invoke-static {v4, v6}, Lz8/a;->z(FLandroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v4

    iget-object v6, p0, Lcom/android/camera2/y4;->mMiCamera:Lcom/android/camera2/k4;

    invoke-virtual {v6}, Lcom/android/camera2/k4;->q()Lcom/android/camera2/f;
    ...
    iget-object v8, p0, Lcom/android/camera2/f5;->mActiveArraySize:Landroid/graphics/Rect;
    ...
    iget-object v7, p0, Lcom/android/camera2/f5;->mActiveArraySize:Landroid/graphics/Rect;
    ...
    sget-object v6, Ll9/ds;->O1:Ll9/es;

    invoke-static {v4, v6}, Ll9/fs;->l(Landroid/hardware/camera2/CaptureResult;Ll9/es;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1, v3, v4}, Lcom/android/camera2/h5;->x(Landroid/hardware/camera2/CaptureRequest$Builder;II)V

    iget-boolean v4, p0, Lcom/android/camera2/h5;->r:Z

    if-eqz v4, :cond_b

    invoke-virtual {p0, v3, v1}, Lcom/android/camera2/h5;->W(ILandroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    invoke-virtual {p0, v1, v4, v3}, Lcom/android/camera2/f5;->generatePreProcessData(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object v1

    if-eqz v1, :cond_e

    invoke-virtual {p0, v1}, Lcom/android/camera2/f5;->preCapture(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    invoke-virtual {v1, v3}, Lq6/n;->o(Ljava/lang/String;)J
    ...
    iget-boolean v1, p0, Lcom/android/camera2/h5;->h:Z
    :try_end_0
    ...
    invoke-virtual {v1}, Li6/w;->n0()Landroid/hardware/camera2/CameraCaptureSession;
...
.method public final x(Landroid/hardware/camera2/CaptureRequest$Builder;II)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/h5;->C(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/h5;->z(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    goto :goto_0

    :cond_2
    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/h5;->D(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    goto :goto_0

    :cond_3
    invoke-virtual {p0, p1}, Lcom/android/camera2/h5;->A(Landroid/hardware/camera2/CaptureRequest$Builder;)V

    goto :goto_0

    :cond_4
    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/h5;->E(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    goto :goto_0

    :cond_5
    invoke-virtual {p0, p1}, Lcom/android/camera2/h5;->y(Landroid/hardware/camera2/CaptureRequest$Builder;)V

    goto :goto_0

    :cond_6
    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/h5;->B(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-static {p1, p2, p3}, Lcom/android/camera2/r3;->O1(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/f;Z)V
    ...
    invoke-static {p1, p0, p3}, Lcom/android/camera2/r3;->D1(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/f;Z)V
...
.method public final y(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    iget-boolean p0, p0, Lcom/android/camera2/h5;->f:Z
