...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/timerburst/a;->a:Lv7/s;
    ...
    iget-object v2, p0, Lcom/android/camera/timerburst/a;->a:Lv7/s;

    invoke-virtual {v2, v0}, Lv7/s;->d(I)V

    iget-object p0, p0, Lcom/android/camera/timerburst/a;->a:Lv7/s;

    int-to-long v0, v1

    invoke-virtual {p0, v0, v1}, Lv7/s;->c(J)V
...
.method public static synthetic b(La7/d3;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/timerburst/a;->r(La7/d3;)V
...
.method public static synthetic r(La7/d3;)V
    .locals 3
...
.method public d(I)V
    ...
    iget-object v0, p0, Lcom/android/camera/timerburst/a;->a:Lv7/s;

    add-int/lit8 v1, p1, -0x1

    invoke-virtual {v0, v1}, Lv7/s;->d(I)V
...
.method public s()V
    ...
    invoke-static {p0}, Lcom/android/camera/h3;->K9(I)V

    const/4 p0, 0x5

    invoke-static {p0}, Lcom/android/camera/h3;->J9(I)V
...
.method public sb(Landroid/view/View;FII)V
    ...
    invoke-virtual {p0, v3, v4}, Lv7/s;->c(J)V

    invoke-static {p3}, Lcom/android/camera/h3;->J9(I)V

    const-string p0, "pref_camera_timer_burst_interval"

    invoke-static {p0, p2}, Lcom/android/camera/h3;->L9(Ljava/lang/String;F)V
    ...
    new-instance p0, Lv7/t;

    invoke-direct {p0, p1}, Lv7/t;-><init>(Landroid/view/View;)V
    ...
    :pswitch_1
    sget-object p4, Lcom/android/camera/timerburst/a;->i:[I
    ...
    :cond_2
    iget-object p4, p0, Lcom/android/camera/timerburst/a;->a:Lv7/s;

    mul-int/lit8 v3, p3, 0xa

    invoke-virtual {p4, v3}, Lv7/s;->d(I)V

    invoke-static {p3}, Lcom/android/camera/h3;->K9(I)V

    const-string p4, "pref_camera_timer_burst_total_count"

    invoke-static {p4, p2}, Lcom/android/camera/h3;->L9(Ljava/lang/String;F)V
    ...
    new-instance p4, Lv7/u;

    invoke-direct {p4}, Lv7/u;-><init>()V
    ...
    new-instance p0, Lv7/v;

    invoke-direct {p0, p1}, Lv7/v;-><init>(Landroid/view/View;)V
...
.method public final t(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/camera/timerburst/a;->a:Lv7/s;

    invoke-static {}, Lcom/android/camera/h3;->F1()I

    move-result v0

    invoke-virtual {p1, v0}, Lv7/s;->d(I)V
...
.method public u()V
    ...
    invoke-virtual {p0, v0}, Lv7/s;->d(I)V
