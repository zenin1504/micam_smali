...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lcom/android/camera/ui/HistogramView;->f:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;

    const/16 p1, 0x100

    new-array p2, p1, [I

    iput-object p2, p0, Lcom/android/camera/ui/HistogramView;->h:[I
    ...
    iput-object p1, p0, Lcom/android/camera/ui/HistogramView;->k:[I

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lcom/android/camera/ui/HistogramView;->l:Landroid/graphics/RectF;
...
.method public final a(Landroid/graphics/Canvas;I[IILandroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v7, v0, Lcom/android/camera/ui/HistogramView;->f:Landroid/graphics/Paint;
    ...
    iget-object v7, v0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;

    invoke-virtual {v7}, Landroid/graphics/Path;->reset()V

    iget-object v7, v0, Lcom/android/camera/ui/HistogramView;->l:Landroid/graphics/RectF;
    ...
    iget-object v10, v0, Lcom/android/camera/ui/HistogramView;->l:Landroid/graphics/RectF;

    iget v11, v0, Lcom/android/camera/ui/HistogramView;->m:F
    ...
    iget-object v10, v0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;
    ...
    iget-object v11, v0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;
    ...
    :cond_0
    iget-object v13, v0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;
    ...
    :cond_2
    iget-object v2, v0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;
    ...
    iget-object v0, v0, Lcom/android/camera/ui/HistogramView;->f:Landroid/graphics/Paint;
...
.method public final b(Landroid/graphics/Canvas;I[IILandroid/graphics/PorterDuff$Mode;)V
    ...
    iget v0, p0, Lcom/android/camera/ui/HistogramView;->m:F
    ...
    iget-object v4, p0, Lcom/android/camera/ui/HistogramView;->f:Landroid/graphics/Paint;
    ...
    iget-object p4, p0, Lcom/android/camera/ui/HistogramView;->f:Landroid/graphics/Paint;
    ...
    iget-object p4, p0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;

    invoke-virtual {p4}, Landroid/graphics/Path;->reset()V

    iget-object p4, p0, Lcom/android/camera/ui/HistogramView;->l:Landroid/graphics/RectF;
    ...
    iget-object v4, p0, Lcom/android/camera/ui/HistogramView;->l:Landroid/graphics/RectF;
    ...
    iget-object v4, p0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;
    ...
    iget-object v6, p0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/camera/ui/HistogramView;->g:Landroid/graphics/Path;
    ...
    iget-object p0, p0, Lcom/android/camera/ui/HistogramView;->f:Landroid/graphics/Paint;
...
.method public e([I)V
    ...
    iget-object p0, p0, Lcom/android/camera/ui/HistogramView;->h:[I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Lcom/android/camera/ui/HistogramView;->h:[I
    ...
    iget-object v4, p0, Lcom/android/camera/ui/HistogramView;->i:[I
    ...
    iget-object v6, p0, Lcom/android/camera/ui/HistogramView;->h:[I
...
.method public setRoundRadius(F)V
    ...
    iput p1, p0, Lcom/android/camera/ui/HistogramView;->m:F
