...
# virtual methods
.method public final a(ZLcom/android/camera/data/data/b;IZ)V
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/u1;->setCircleRes(I)V
    ...
    iget v1, p2, Lcom/android/camera/data/data/b;->i:I

    invoke-virtual {v0, v1}, Lcom/android/camera/ui/u1;->setTextRes(I)V

    iget-boolean v1, p0, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->b:Z

    invoke-virtual {v0, v1}, Lcom/android/camera/ui/u1;->setExpandAnimateLTR(Z)V

    if-eqz p4, :cond_0

    sget-object p4, Lcom/android/camera/ui/u1;->a0:Ljava/lang/Float;
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/u1;->setmBackgroundColor(I)V

    invoke-virtual {v0, p4}, Lcom/android/camera/ui/u1;->setmBgViewAlpha(F)V

    :cond_0
    invoke-virtual {p0, v0, p2, p1}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->j(Landroid/view/View;Lcom/android/camera/data/data/b;Z)V

    invoke-virtual {v0, p1}, Lcom/android/camera/ui/u1;->e(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/camera/ui/u1;->getMaxLength()F
...
.method public final d(Ljava/util/List;Ljava/util/List;)Z
    ...
    iget-object v4, p1, Lcom/android/camera/data/data/b;->o:Ljava/lang/String;
...
.method public final e(Ljava/util/List;)Ljava/util/List;
    ...
    iget v6, v2, Lcom/android/camera/data/data/b;->i:I
    ...
    iget v7, v2, Lcom/android/camera/data/data/b;->l:I
...
.method public final f(Z)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->k()V

    const/4 v0, 0x0

    if-nez p1, :cond_1

    invoke-virtual {p0}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->h()V
    ...
    check-cast v1, Lcom/android/camera/ui/u1;
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/camera/ui/u1;->j(IF)V
    ...
    invoke-virtual {v1, p1, v2}, Lcom/android/camera/ui/u1;->k(IF)V
    ...
    iget-object v0, p0, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->g:Lcom/android/camera/data/data/a;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->i(IZ)V
...
.method public final g(I)V
    ...
    invoke-virtual {v1}, Le8/l;->B()Z

    move-result v1

    if-eqz v1, :cond_0

    sget-object v0, Lcom/android/camera/ui/u1;->a0:Ljava/lang/Float;
    ...
    check-cast v3, Lcom/android/camera/ui/u1;

    invoke-virtual {v3, v1}, Lcom/android/camera/ui/u1;->setmBackgroundColor(I)V

    invoke-virtual {v3, v0}, Lcom/android/camera/ui/u1;->setmBgViewAlpha(F)V

    if-ne v2, p1, :cond_1

    invoke-virtual {v3, v0}, Lcom/android/camera/ui/u1;->setCurrentBgAlphaValue(F)V
...
.method public final h()V
    ...
    sget-object v2, Lcom/android/camera/ui/u1;->y:Ljava/lang/Float;
    ...
    invoke-virtual {v3}, Le8/l;->B()Z

    move-result v3

    if-eqz v3, :cond_0

    sget-object v2, Lcom/android/camera/ui/u1;->a0:Ljava/lang/Float;
    ...
    :goto_1
    invoke-virtual {v1, v2}, Lcom/android/camera/ui/u1;->setCurrentBgAlphaValue(F)V
...
.method public final i(IZ)V
    ...
    invoke-virtual {p0, v0, p1, p2}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->j(Landroid/view/View;Lcom/android/camera/data/data/b;Z)V

    :cond_0
    return-void
.end method

.method public final j(Landroid/view/View;Lcom/android/camera/data/data/b;Z)V
    .locals 3
    ...
    iget-object v1, p2, Lcom/android/camera/data/data/b;->m:Ljava/lang/String;
    ...
    :goto_0
    iget v2, p2, Lcom/android/camera/data/data/b;->l:I
...
.method public l(Lcom/android/camera/data/data/a;I)V
    .locals 5
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->e(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->g(I)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->f(Z)V
    ...
    invoke-virtual {v4}, Lw0/n1;->G0()Le8/l;

    move-result-object v4

    invoke-virtual {v4}, Le8/l;->B()Z

    move-result v4

    invoke-virtual {p0, v2, v1, p1, v4}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->a(ZLcom/android/camera/data/data/b;IZ)V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ui/TopAlertCapsuleSwitchView;->f(Z)V
