...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lw8/c;->n:Ljava/lang/String;
...
.method public constructor <init>(IIZZFLjava/lang/String;Landroid/text/TextPaint;ILandroid/graphics/drawable/Drawable;IILjava/lang/String;Landroid/text/TextPaint;Ljava/lang/String;Landroid/text/TextPaint;)V
    ...
    iput-boolean p3, p0, Lw8/c;->a:Z

    iput-boolean p4, p0, Lw8/c;->b:Z

    iput p5, p0, Lw8/c;->m:F

    iput-object p6, p0, Lw8/c;->c:Ljava/lang/String;

    iput-object p7, p0, Lw8/c;->d:Landroid/graphics/Paint;

    iput p8, p0, Lw8/c;->e:I

    iput-object p9, p0, Lw8/c;->f:Landroid/graphics/drawable/Drawable;

    iput p10, p0, Lw8/c;->g:I

    iput p11, p0, Lw8/c;->h:I

    iput-object p12, p0, Lw8/c;->i:Ljava/lang/String;

    iput-object p13, p0, Lw8/c;->j:Landroid/graphics/Paint;

    iput-object p14, p0, Lw8/c;->k:Ljava/lang/String;

    iput-object p15, p0, Lw8/c;->l:Landroid/graphics/Paint;
...
.method public static b(Ljava/lang/String;FZ)Lw8/c;
    .locals 22
    ...
    invoke-static {v1, v0}, Lw8/c;->a(Landroid/graphics/Typeface;F)Landroid/text/TextPaint;
    ...
    invoke-virtual {v8}, Lbb/c;->q2()Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v15}, Lw8/c;-><init>(IIZZFLjava/lang/String;Landroid/text/TextPaint;ILandroid/graphics/drawable/Drawable;IILjava/lang/String;Landroid/text/TextPaint;Ljava/lang/String;Landroid/text/TextPaint;)V
    ...
    invoke-static {v0, v2}, Lw8/c;->a(Landroid/graphics/Typeface;F)Landroid/text/TextPaint;
...
.method public onDraw(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, Lw8/c;->d:Landroid/graphics/Paint;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getFontMetricsInt()Landroid/graphics/Paint$FontMetricsInt;

    move-result-object v0

    iget-boolean v2, p0, Lw8/c;->a:Z
    ...
    iget-object v3, p0, Lw8/c;->j:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, p2, v2, v3}, Landroid/graphics/Canvas;->drawText(Ljava/lang/String;FFLandroid/graphics/Paint;)V

    iget-object v0, p0, Lw8/c;->j:Landroid/graphics/Paint;

    iget-object v2, p0, Lw8/c;->i:Ljava/lang/String;
    ...
    iget-object v0, p0, Lw8/c;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lw8/c;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget v5, p0, Lw8/c;->h:I

    invoke-static {v4, v5}, Ljava/lang/Math;->max(II)I

    move-result v5

    iget v6, p0, Lw8/c;->h:I

    invoke-static {v4, v6}, Ljava/lang/Math;->min(II)I

    move-result v4

    iget-boolean v6, p0, Lw8/c;->b:Z
    ...
    iget-object v4, p0, Lw8/c;->d:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, v3, p2, v4}, Landroid/graphics/Canvas;->drawText(Ljava/lang/String;FFLandroid/graphics/Paint;)V

    iget-object v0, p0, Lw8/c;->d:Landroid/graphics/Paint;

    iget-object v4, p0, Lw8/c;->c:Ljava/lang/String;

    invoke-virtual {v0, v4}, Landroid/graphics/Paint;->measureText(Ljava/lang/String;)F

    move-result v0

    iget-object v4, p0, Lw8/c;->i:Ljava/lang/String;

    iget-object v6, p0, Lw8/c;->j:Landroid/graphics/Paint;

    invoke-virtual {p1, v4, v0, p2, v6}, Landroid/graphics/Canvas;->drawText(Ljava/lang/String;FFLandroid/graphics/Paint;)V

    iget-object p2, p0, Lw8/c;->j:Landroid/graphics/Paint;
    ...
    iget-object p2, p0, Lw8/c;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lw8/c;->k:Ljava/lang/String;

    iget-object p0, p0, Lw8/c;->l:Landroid/graphics/Paint;
    ...
    iget-object v6, p0, Lw8/c;->d:Landroid/graphics/Paint;

    iget-object v8, p0, Lw8/c;->c:Ljava/lang/String;

    invoke-virtual {v6, v8}, Landroid/graphics/Paint;->measureText(Ljava/lang/String;)F

    move-result v6

    iget-object v8, p0, Lw8/c;->j:Landroid/graphics/Paint;

    iget-object v9, p0, Lw8/c;->i:Ljava/lang/String;
    ...
    iget v8, p0, Lw8/c;->e:I

    int-to-float v8, v8

    add-float/2addr v6, v8

    iget v8, p0, Lw8/c;->g:I
    ...
    iget-object v6, p0, Lw8/c;->c:Ljava/lang/String;
    ...
    iget-object v3, p0, Lw8/c;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lw8/c;->l:Landroid/graphics/Paint;

    iget-object v1, p0, Lw8/c;->k:Ljava/lang/String;
    ...
    iget v2, p0, Lw8/c;->m:F

    mul-float/2addr v1, v2

    add-float/2addr v0, v1

    iget-object v1, p0, Lw8/c;->j:Landroid/graphics/Paint;
