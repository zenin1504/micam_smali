...
.method public constructor <init>(Ljava/lang/String;Landroid/text/TextPaint;Landroid/graphics/Paint$FontMetricsInt;II)V
    ...
    iput-object p2, p0, Lv8/d;->b:Landroid/text/TextPaint;

    iput-object p3, p0, Lv8/d;->c:Landroid/graphics/Paint$FontMetricsInt;
...
.method public static b(Ljava/lang/String;FII)Lv8/d;
    .locals 1
    ...
    invoke-static {p1}, Lv8/a;->g(F)Landroid/text/TextPaint;
    ...
    :cond_0
    invoke-static {p1, p2, p3}, Lv8/d;->a(FII)Landroid/text/TextPaint;

    move-result-object p1

    :goto_0
    invoke-static {p0, p1, p3}, Lv8/d;->c(Ljava/lang/String;Landroid/text/TextPaint;I)Lv8/d;
...
.method public static c(Ljava/lang/String;Landroid/text/TextPaint;I)Lv8/d;
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lv8/d;-><init>(Ljava/lang/String;Landroid/text/TextPaint;Landroid/graphics/Paint$FontMetricsInt;II)V
...
.method public onDraw(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
    ...
    iget-object p2, p0, Lv8/d;->c:Landroid/graphics/Paint$FontMetricsInt;
    ...
    iget-object p2, p0, Lv8/d;->a:Ljava/lang/String;

    iget-object p0, p0, Lv8/d;->b:Landroid/text/TextPaint;
