...
.field public a0:Ln9/b;

.field public final b:Ln9/c$c;

.field public b0:Ln9/a;
...
.field public x:Ln9/c$e;

.field public y:Landroid/graphics/SurfaceTexture;


# direct methods
.method public constructor <init>(IIZIIIILandroid/os/Handler;Ln9/c$c;)V
    .locals 20
    ...
    iput-object v9, v0, Ln9/c;->t:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, Ln9/c;->u:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, Ln9/c;->w:Ljava/util/ArrayList;

    const/16 v9, 0x10

    new-array v9, v9, [F

    iput-object v9, v0, Ln9/c;->d0:[F
    ...
    iput-object v14, v0, Ln9/c;->a:Landroid/media/MediaCodec;
    ...
    :cond_2
    iget-object v14, v0, Ln9/c;->a:Landroid/media/MediaCodec;

    invoke-virtual {v14}, Landroid/media/MediaCodec;->release()V

    iput-object v13, v0, Ln9/c;->a:Landroid/media/MediaCodec;
    ...
    :goto_2
    iput v4, v0, Ln9/c;->e:I

    move-object/from16 v10, p9

    iput-object v10, v0, Ln9/c;->b:Ln9/c$c;
    ...
    iput-object v10, v0, Ln9/c;->c:Landroid/os/HandlerThread;
    ...
    :cond_4
    iput-object v13, v0, Ln9/c;->c:Landroid/os/HandlerThread;
    ...
    iput-object v9, v0, Ln9/c;->d:Landroid/os/Handler;
    ...
    iput v1, v0, Ln9/c;->f:I

    iput v2, v0, Ln9/c;->g:I

    iput-boolean v12, v0, Ln9/c;->m:Z
    ...
    iput v1, v0, Ln9/c;->h:I

    iput v2, v0, Ln9/c;->i:I

    const/4 v4, 0x1

    iput v4, v0, Ln9/c;->j:I

    iput v4, v0, Ln9/c;->k:I

    goto :goto_b

    :cond_d
    iput v4, v0, Ln9/c;->h:I

    iput v10, v0, Ln9/c;->i:I

    iput v9, v0, Ln9/c;->j:I

    iput v11, v0, Ln9/c;->k:I

    :goto_b
    iget v4, v0, Ln9/c;->j:I

    iget v5, v0, Ln9/c;->k:I

    mul-int/2addr v4, v5

    iput v4, v0, Ln9/c;->l:I
    ...
    :goto_d
    iget-object v3, v0, Ln9/c;->a:Landroid/media/MediaCodec;

    new-instance v4, Ln9/c$d;

    invoke-direct {v4, v0}, Ln9/c$d;-><init>(Ln9/c;)V
    ...
    iput-object v3, v0, Ln9/c;->Z:Landroid/view/Surface;
    ...
    :goto_10
    new-instance v4, Ln9/c$e;

    invoke-direct {v4, v0, v11}, Ln9/c$e;-><init>(Ln9/c;Z)V

    iput-object v4, v0, Ln9/c;->x:Ln9/c$e;

    if-eqz v11, :cond_15

    new-instance v4, Ln9/b;

    iget-object v5, v0, Ln9/c;->Z:Landroid/view/Surface;

    invoke-direct {v4, v5}, Ln9/b;-><init>(Landroid/view/Surface;)V

    iput-object v4, v0, Ln9/c;->a0:Ln9/b;

    invoke-virtual {v4}, Ln9/b;->f()V
    ...
    :goto_11
    invoke-direct {v5, v11}, Ln9/e;-><init>(I)V

    invoke-direct {v4, v5, v1, v2}, Ln9/a;-><init>(Ln9/e;II)V

    iput-object v4, v0, Ln9/c;->b0:Ln9/a;

    invoke-virtual {v4}, Ln9/a;->c()I

    move-result v4

    iput v4, v0, Ln9/c;->c0:I
    ...
    iget v5, v0, Ln9/c;->c0:I

    invoke-direct {v3, v5, v4}, Landroid/graphics/SurfaceTexture;-><init>(IZ)V

    iput-object v3, v0, Ln9/c;->y:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v3, v0, Ln9/c;->y:Landroid/graphics/SurfaceTexture;

    invoke-virtual {v3, v1, v2}, Landroid/graphics/SurfaceTexture;->setDefaultBufferSize(II)V

    new-instance v1, Landroid/view/Surface;

    iget-object v2, v0, Ln9/c;->y:Landroid/graphics/SurfaceTexture;

    invoke-direct {v1, v2}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object v1, v0, Ln9/c;->Y:Landroid/view/Surface;

    :cond_14
    iget-object v1, v0, Ln9/c;->a0:Ln9/b;

    invoke-virtual {v1}, Ln9/b;->g()V

    goto :goto_13

    :cond_15
    iget-object v1, v0, Ln9/c;->Z:Landroid/view/Surface;
    ...
    iget-object v2, v0, Ln9/c;->t:Ljava/util/ArrayList;

    iget v3, v0, Ln9/c;->f:I

    iget v4, v0, Ln9/c;->g:I
    ...
    iget v2, v0, Ln9/c;->h:I

    iget v3, v0, Ln9/c;->i:I

    const/4 v4, 0x0

    invoke-direct {v1, v4, v4, v2, v3}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v1, v0, Ln9/c;->q:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, v0, Ln9/c;->p:Landroid/graphics/Rect;
...
.method public static e(Ljava/nio/ByteBuffer;Landroid/media/Image;IILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    .locals 17
...
.method public final a()Ljava/nio/ByteBuffer;
    ...
    iget-object v0, p0, Ln9/c;->t:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-boolean v1, p0, Ln9/c;->o:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Ln9/c;->t:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p0, p0, Ln9/c;->t:Ljava/util/ArrayList;
...
.method public b(I[B)V
    ...
    iget v0, p0, Ln9/c;->f:I

    iget v1, p0, Ln9/c;->g:I
    ...
    invoke-virtual {p0, p2}, Ln9/c;->c([B)V
...
.method public final c([B)V
    ...
    invoke-virtual {p0}, Ln9/c;->a()Ljava/nio/ByteBuffer;
    ...
    iget-object p1, p0, Ln9/c;->u:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object v1, p0, Ln9/c;->u:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Ln9/c;->d:Landroid/os/Handler;

    new-instance v0, Ln9/c$a;

    invoke-direct {v0, p0}, Ln9/c$a;-><init>(Ln9/c;)V
...
.method public close()V
    ...
    iget-object v0, p0, Ln9/c;->d:Landroid/os/Handler;

    new-instance v1, Ln9/c$b;

    invoke-direct {v1, p0}, Ln9/c$b;-><init>(Ln9/c;)V
...
.method public final f()V
    ...
    iget v0, p0, Ln9/c;->h:I

    iget v1, p0, Ln9/c;->i:I
    ...
    iget v5, p0, Ln9/c;->i:I

    mul-int v6, v0, v5

    iget-object v7, p0, Ln9/c;->p:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Ln9/c;->b0:Ln9/a;

    iget v4, p0, Ln9/c;->c0:I

    sget-object v5, Ln9/e;->i:[F

    iget-object v6, p0, Ln9/c;->p:Landroid/graphics/Rect;

    invoke-virtual {v3, v4, v5, v6}, Ln9/a;->a(I[FLandroid/graphics/Rect;)V

    iget-object v3, p0, Ln9/c;->a0:Ln9/b;

    iget v4, p0, Ln9/c;->n:I

    add-int/lit8 v5, v4, 0x1

    iput v5, p0, Ln9/c;->n:I

    invoke-virtual {p0, v4}, Ln9/c;->d(I)J
    ...
    invoke-virtual {v3, v4, v5}, Ln9/b;->i(J)V

    iget-object v3, p0, Ln9/c;->a0:Ln9/b;

    invoke-virtual {v3}, Ln9/b;->j()Z
...
.method public final g()Ljava/nio/ByteBuffer;
    ...
    iget-boolean v0, p0, Ln9/c;->o:Z

    const/4 v1, 0x0

    if-nez v0, :cond_1

    iget-object v0, p0, Ln9/c;->r:Ljava/nio/ByteBuffer;

    if-nez v0, :cond_1

    iget-object v0, p0, Ln9/c;->u:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v2, p0, Ln9/c;->u:Ljava/util/ArrayList;
    ...
    :goto_0
    iput-object v2, p0, Ln9/c;->r:Ljava/nio/ByteBuffer;
    ...
    :cond_2
    iget-object v1, p0, Ln9/c;->r:Ljava/nio/ByteBuffer;
...
.method public h()Landroid/view/Surface;
    ...
    iget-object p0, p0, Ln9/c;->Y:Landroid/view/Surface;
...
.method public j()V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Ln9/c;->g()Ljava/nio/ByteBuffer;

    move-result-object v0

    if-eqz v0, :cond_6

    iget-object v1, p0, Ln9/c;->w:Ljava/util/ArrayList;
    ...
    iget v1, p0, Ln9/c;->n:I

    iget v2, p0, Ln9/c;->l:I
    ...
    iget-object v1, p0, Ln9/c;->a:Landroid/media/MediaCodec;

    invoke-virtual {v1, v8}, Landroid/media/MediaCodec;->getInputImage(I)Landroid/media/Image;

    move-result-object v1

    iget v2, p0, Ln9/c;->h:I

    iget v3, p0, Ln9/c;->n:I
    ...
    iget v7, p0, Ln9/c;->i:I

    div-int/2addr v3, v4

    iget v4, p0, Ln9/c;->j:I

    rem-int/2addr v3, v4

    mul-int/2addr v3, v7

    iget-object v4, p0, Ln9/c;->p:Landroid/graphics/Rect;
    ...
    iget v2, p0, Ln9/c;->f:I

    iget v3, p0, Ln9/c;->g:I

    iget-object v4, p0, Ln9/c;->p:Landroid/graphics/Rect;

    iget-object v5, p0, Ln9/c;->q:Landroid/graphics/Rect;

    invoke-static/range {v0 .. v5}, Ln9/c;->e(Ljava/nio/ByteBuffer;Landroid/media/Image;IILandroid/graphics/Rect;Landroid/graphics/Rect;)V

    :cond_2
    iget-object v7, p0, Ln9/c;->a:Landroid/media/MediaCodec;
    ...
    :goto_2
    iget v0, p0, Ln9/c;->n:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Ln9/c;->n:I

    invoke-virtual {p0, v0}, Ln9/c;->d(I)J
    ...
    :cond_5
    invoke-virtual {p0, v14}, Ln9/c;->k(Z)V
...
.method public final k(Z)V
    ...
    iput-boolean p1, p0, Ln9/c;->o:Z

    iget-object p1, p0, Ln9/c;->t:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Ln9/c;->r:Ljava/nio/ByteBuffer;
...
.method public m()V
    ...
    iget-object p0, p0, Ln9/c;->x:Ln9/c$e;

    const-wide/16 v0, 0x0

    invoke-virtual {p0, v0, v1}, Ln9/c$e;->c(J)V
    ...
    invoke-virtual {p0, v0}, Ln9/c;->c([B)V
...
.method public n()V
    ...
    iget-object v0, p0, Ln9/c;->a:Landroid/media/MediaCodec;
    ...
    :goto_0
    iput-object v2, p0, Ln9/c;->a:Landroid/media/MediaCodec;
    ...
    :try_start_2
    iput-boolean v3, p0, Ln9/c;->o:Z

    iget-object v3, p0, Ln9/c;->t:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v0, p0, Ln9/c;->b0:Ln9/a;

    if-eqz v0, :cond_1

    invoke-virtual {v0, v1}, Ln9/a;->d(Z)V

    iput-object v2, p0, Ln9/c;->b0:Ln9/a;

    :cond_1
    iget-object v0, p0, Ln9/c;->a0:Ln9/b;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Ln9/b;->h()V

    iput-object v2, p0, Ln9/c;->a0:Ln9/b;

    :cond_2
    iget-object v0, p0, Ln9/c;->y:Landroid/graphics/SurfaceTexture;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Landroid/graphics/SurfaceTexture;->release()V

    iput-object v2, p0, Ln9/c;->y:Landroid/graphics/SurfaceTexture;
...
.method public onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    :cond_0
    invoke-virtual {v0}, Ln9/b;->f()V

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->updateTexImage()V

    iget-object v0, p0, Ln9/c;->d0:[F
    ...
    iget-object v2, p0, Ln9/c;->x:Ln9/c$e;

    iget v3, p0, Ln9/c;->n:I

    iget v4, p0, Ln9/c;->l:I

    add-int/2addr v3, v4

    add-int/lit8 v3, v3, -0x1

    invoke-virtual {p0, v3}, Ln9/c;->d(I)J

    move-result-wide v3

    invoke-virtual {v2, v0, v1, v3, v4}, Ln9/c$e;->d(JJ)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Ln9/c;->f()V

    :cond_1
    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->releaseTexImage()V

    iget-object p1, p0, Ln9/c;->a0:Ln9/b;

    invoke-virtual {p1}, Ln9/b;->g()V
