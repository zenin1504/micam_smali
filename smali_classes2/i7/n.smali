...
.method public bridge synthetic l(Li7/l;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Li7/n;->u(Li7/l;Li7/f;)V
...
.method public q(Ljava/lang/String;Landroid/content/Context;)Ljava/io/File;
    .locals 0
...
.method public r(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    .locals 2

    const-string v0, "SimpleLocalJsonCacheRequest"

    invoke-virtual {p0, p1, p2}, Li7/n;->q(Ljava/lang/String;Landroid/content/Context;)Ljava/io/File;
    ...
    :try_start_1
    invoke-virtual {p0, p2}, Li7/n;->p(Ljava/io/InputStream;)Ljava/lang/String;
...
.method public abstract s(Li7/f;)Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)Z"
        }
...
.method public abstract t(Li7/f;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)V"
        }
...
.method public u(Li7/l;Li7/f;)V
    ...
    invoke-virtual {p0, p2}, Li7/n;->s(Li7/f;)Z
    ...
    invoke-interface {p1, v2, v1}, Li7/l;->a(Ljava/lang/Object;Z)V
    ...
    :cond_1
    :try_start_0
    invoke-virtual {p0, p2}, Li7/n;->t(Li7/f;)V
    :try_end_0
