...
.method private final readRstStream(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p2, p0}, Lkotlin/jvm/internal/k;->m(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lvk/f;->i(II)Lvk/d;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lvk/f;->h(Lvk/b;I)Lvk/b;

    move-result-object p2

    invoke-virtual {p2}, Lvk/b;->a()I

    move-result v1

    invoke-virtual {p2}, Lvk/b;->b()I

    move-result v2

    invoke-virtual {p2}, Lvk/b;->c()I
