...
.method public constructor <init>(Ljava/io/File;Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Lzo/d;->c:Ljava/io/File;

    iput-object p2, p0, Lzo/d;->a:Ljava/util/Map;

    iput-object p3, p0, Lzo/d;->b:Ljava/util/Map;

    return-void
.end method

.method public static synthetic a(Lzo/d;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Lzo/d;->a:Ljava/util/Map;

    return-object p0
.end method

.method public static synthetic b(Lzo/d;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Lzo/d;->b:Ljava/util/Map;

    return-object p0
.end method

.method public static c(Ljava/io/File;)Lzo/d;
    .locals 6
    ...
    invoke-static {p0}, Lto/e;->a(Ljava/io/File;)Lto/b;
    ...
    invoke-static {p0}, Lwo/k;->h(Ljava/io/File;)Lwo/k$b;

    move-result-object v0

    invoke-virtual {v0}, Lwo/k$b;->c()Lorg/jcodec/containers/mp4/boxes/MovieBox;
    ...
    :goto_1
    invoke-direct {v2, p0, v1, v0}, Lzo/d;-><init>(Ljava/io/File;Ljava/util/Map;Ljava/util/Map;)V
...
.method public e(Z)V
    ...
    invoke-direct {v0, p0, p0}, Lzo/d$a;-><init>(Lzo/d;Lzo/d;)V
    ...
    iget-object p0, p0, Lzo/d;->c:Ljava/io/File;

    invoke-virtual {p1, p0, v0}, Lzo/e;->c(Ljava/io/File;Lzo/c;)V
    ...
    invoke-direct {p1}, Lzo/f;-><init>()V

    iget-object p0, p0, Lzo/d;->c:Ljava/io/File;

    invoke-virtual {p1, p0, v0}, Lzo/f;->b(Ljava/io/File;Lzo/c;)V
