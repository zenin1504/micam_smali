...
.method private newDrawing()V
    ...
    invoke-static {}, Ljp/b$a;->a()Ljp/b;

    move-result-object p0

    sget-object v0, Lkp/f;->O:Lkp/f$a;

    invoke-interface {p0, v0}, Ljp/b;->a(Lkp/f$a;)V

    invoke-interface {p0}, Ljp/b;->m()Ljp/a;
...
.method public findCommentShape(II)Lkp/d;
    .locals 1
    ...
    invoke-interface {p1, p0}, Lkp/d;->k(I)Lip/a;
...
.method public newCommentShape()Lkp/d;
    .locals 3

    invoke-static {}, Lkp/d$a;->a()Lkp/d;
    ...
    invoke-interface {v0, v1}, Lkp/d;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0}, Lkp/d;->setType(Ljava/lang/String;)V

    const-string p0, "position:absolute; visibility:hidden"

    invoke-interface {v0, p0}, Lkp/d;->f(Ljava/lang/String;)V

    const-string p0, "#ffffe1"

    invoke-interface {v0, p0}, Lkp/d;->l(Ljava/lang/String;)V

    sget-object p0, Ljp/c;->F:Ljp/c$a;

    invoke-interface {v0, p0}, Lkp/d;->c(Ljp/c$a;)V

    invoke-interface {v0}, Lkp/d;->addNewFill()Lkp/a;
...
.method public read(Ljava/io/InputStream;)V
    ...
    invoke-static {v2}, Ljp/b$a;->b(Ljava/lang/String;)Ljp/b;
    ...
    invoke-static {v2}, Lkp/e$a;->a(Ljava/lang/String;)Lkp/e;
    ...
    invoke-interface {v2}, Lkp/e;->getId()Ljava/lang/String;
    ...
    invoke-static {v2}, Lkp/d$a;->b(Ljava/lang/String;)Lkp/d;

    move-result-object v2

    invoke-interface {v2}, Lkp/d;->getId()Ljava/lang/String;
...
.method public removeCommentShape(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;->findCommentShape(II)Lkp/d;
