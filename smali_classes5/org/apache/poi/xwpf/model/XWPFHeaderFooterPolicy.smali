...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    invoke-static {}, Lkp/c$a;->a()Lkp/c;

    move-result-object p0

    invoke-interface {p0}, Lkp/c;->i()Lkp/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, Lkp/e;->setId(Ljava/lang/String;)V

    const-string p1, "1600,21600"

    invoke-interface {p0, p1}, Lkp/e;->j(Ljava/lang/String;)V

    const/high16 p1, 0x43080000    # 136.0f

    invoke-interface {p0, p1}, Lkp/e;->b(F)V

    const-string p1, "10800"

    invoke-interface {p0, p1}, Lkp/e;->e(Ljava/lang/String;)V

    const-string p1, "m@7,0l@8,0m@5,21600l@6,21600e"

    invoke-interface {p0, p1}, Lkp/e;->h(Ljava/lang/String;)V

    invoke-interface {p0}, Lkp/e;->g()Lkp/b;
